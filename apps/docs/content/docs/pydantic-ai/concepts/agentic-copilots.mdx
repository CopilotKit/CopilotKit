...
<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption 
        id="new"
        title="I'm new to Pydantic AI"
description="Help me understand what agentic copilots are, where Pydantic AI fits in, and how to get started." 
...
Pydantic AI is a framework that gives you precise control over AI agents. Pydantic AI agents allow developers to combine and coordinate coding tasks efficiently,
        ...
        <Cards>
            <Card
                ...
                href="/pydantic-ai/quickstart/pydantic-ai"
                icon={<RocketIcon />}
            />
            <Card
                ...
                href="/pydantic-ai/concepts/terminology"
...
description="Help me understand what agentic copilots are, what Copilotkit does to integrate with Pydantic AI, and how to get started."
    ...
    >
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your Pydantic AI agent with CopilotKit in a few minutes."
href="/pydantic-ai/quickstart/pydantic-ai"
                icon={<RocketIcon />}
            />
            <Card
                ...
                description="Follow a step-by-step tutorial to build a travel app supercharged with CoAgents."
                href="/pydantic-ai/tutorials/ai-travel-app/overview"
                icon={<GraduationCapIcon />}
            />
            <Card
                title="Reference"
