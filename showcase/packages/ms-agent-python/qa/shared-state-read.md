# QA: Shared State (Reading) — Microsoft Agent Framework (Python)
...
- [ ] Verify the default ingredients are displayed (`data-testid="ingredients-container"`):
  - [ ] Carrots (3 large, grated) with carrot emoji
  - [ ] All-Purpose Flour (2 cups) with wheat emoji
- [ ] Verify the default instruction is displayed (`data-testid="instructions-container"`): "Preheat oven to 350°F (175°C)"
...
- [ ] Click "+ Add Ingredient" (`data-testid="add-ingredient-button"`) and verify a new empty ingredient card appears (`data-testid="ingredient-card"`)
...
- [ ] Verify the ping indicator appears on changed sections (dietary preferences, ingredients, instructions)
