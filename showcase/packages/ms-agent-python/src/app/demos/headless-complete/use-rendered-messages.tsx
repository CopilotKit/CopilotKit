...
function renderMessageContent(args: {
  ...
  // Note: the MS Agent Framework version of @ag-ui/core does not yet expose
  // a `reasoning` message role; if/when it does, dispatch on it here the
  // same way the LangGraph showcase does.
  ...
  return (
    <>
      ...
      {toolCalls.map((toolCall) => {
        // Tool result lives on a sibling `tool`-role message keyed by
        // toolCallId. Mirrors CopilotChatToolCallsView.
