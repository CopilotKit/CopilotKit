# QA: Agentic Generative UI — Mastra
...
- [ ] Verify the message list container is present (`data-testid="copilot-message-list"`)
...
- [ ] Verify the progress bar appears with a blue/purple gradient fill
...
- [ ] Verify completed steps show:
  ...
  - Check icon (white) in a green/emerald circle
  - Green text color
...
- [ ] Click "Complex plan" or type "Please build a plan to make pizza in 10 steps."
