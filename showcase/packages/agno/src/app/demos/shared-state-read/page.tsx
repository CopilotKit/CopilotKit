    ...
    >
      ...
      <div className="mb-6 relative">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <button type="button" className="text-sm text-blue-600 hover:text-blue-800" onClick={addInstruction}>
            + Add Step
          </button>
        </div>
        <div data-testid="instructions-container" className="space-y-3">
          {recipe.instructions.map((instruction, index) => (
            <div key={index} className="flex items-start gap-3">
              ...
              <div className="flex-1 relative" onClick={() => setEditingInstructionIndex(index)}>
                <textarea
