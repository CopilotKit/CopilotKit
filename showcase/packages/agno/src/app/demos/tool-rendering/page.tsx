...
import { CopilotChat, useRenderTool, useConfigureSuggestions } from "@copilotkit/react-core/v2";
import { z } from "zod";
...
function Chat() {
  useRenderTool({
    ...
    render: ({ args, result, status }: any) => {
      ...
      return <WeatherCard location={args.location} themeColor={themeColor} result={weatherResult} />;
    },
  });
