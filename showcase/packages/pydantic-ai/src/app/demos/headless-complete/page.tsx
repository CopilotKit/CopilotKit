...
// Routed through the standard /api/copilotkit endpoint (the PydanticAI
// package does not wire MCP Apps on the backend; see PARITY_NOTES.md).
// The hand-rolled `useRenderActivityMessage` in `use-rendered-messages.tsx`
