...
// Note: @ag-ui/core 0.0.43 (the version pinned in this package) does not
// export `ReasoningMessage` and PydanticAI's AG-UI adapter does not emit
// reasoning content today, so the upstream langgraph-python cell's
// `role === "reasoning"` branch is omitted here. When the adapter gains
