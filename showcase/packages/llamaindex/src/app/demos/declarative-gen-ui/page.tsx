...
/**
 * Declarative Generative UI (A2UI — Dynamic Schema) demo — LlamaIndex.
 *
 * Pattern:
 *   1. Define a small set of branded React components + Zod schemas in
 *      `./a2ui/definitions.ts` and `./a2ui/renderers.tsx`.
 ...
 *      explicitly, so double-binding from the runtime would duplicate the
 *      tool slot.
 */
