...
export const useExampleSuggestions = () => {
  useConfigureSuggestions({
    suggestions: [
      ...
      // MCP Apps suggestion omitted on CrewAI: ag-ui-crewai has no MCP
      // SSE client wiring and CrewAI crews use Pydantic BaseTool lists rather
      // than an MCP multiplexer. The LangGraph-Python reference includes an
      // Excalidraw MCP suggestion here; tracked as a future-work item.
      {
