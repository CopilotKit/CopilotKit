...
function Chat() {
    ...
    useRenderTool({
        ...
        render: ({ args, result, status }: any) => {
            ...
            return (
                <div style={{ borderRadius: "16px", overflow: "hidden", boxShadow: "0 10px 25px rgba(0,0,0,0.15)", margin: "12px 0", background: getGradient(cond), width: "320px" }}>
                    <div style={{ padding: "16px 20px 12px" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                            <div>
                                <h3 style={{ fontSize: "16px", fontWeight: 700, color: "white", textTransform: "capitalize", letterSpacing: "-0.02em", margin: 0 }}>
                                    {result?.city || args.location}
                                </h3>
                                <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "10px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>
                                    Current Weather
                                </p>
                            </div>
                            <span style={{ fontSize: "36px", lineHeight: 1 }}>{getIcon(cond)}</span>
                        </div>
                        <div style={{ marginTop: "12px", display: "flex", alignItems: "baseline", gap: "6px" }}>
                            <span style={{ fontSize: "36px", fontWeight: 200, color: "white", letterSpacing: "-0.04em" }}>
                                {temp}°
                            </span>
                        ...
                        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "12px", fontWeight: 500, textTransform: "capitalize", marginTop: "2px" }}>
                            {cond}
                        </p>
                    </div>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", textAlign: "center", padding: "10px 20px", background: "rgba(0,0,0,0.15)" }}>
                        <div>
                            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "9px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>Humidity</p>
                            <p style={{ color: "white", fontSize: "12px", fontWeight: 600, marginTop: "2px" }}>{hum}%</p>
                        </div>
                        <div style={{ borderLeft: "1px solid rgba(255,255,255,0.1)", borderRight: "1px solid rgba(255,255,255,0.1)" }}>
                            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "9px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>Wind</p>
                            <p style={{ color: "white", fontSize: "12px", fontWeight: 600, marginTop: "2px" }}>{wind} mph</p>
                        </div>
                        <div>
                            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "9px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>Feels Like</p>
                            <p style={{ color: "white", fontSize: "12px", fontWeight: 600, marginTop: "2px" }}>{feels}°</p>
                        </div>
                    </div>
                </div>
            );
