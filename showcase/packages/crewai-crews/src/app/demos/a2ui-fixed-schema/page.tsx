 ...
 * the backend and the agent only streams *data* into the data model. The
 ...
 * - Backend: `src/agents/a2ui_fixed.py` (dedicated CrewAI crew that
 *   emits an `a2ui_operations` container via a DisplayFlightTool)
 */
...
export default function A2UIFixedSchemaDemo() {
  return (
    ...
    >
      <div
        data-testid="a2ui-fixed-schema-root"
