...
function SidebarWithSuggestions() {
    useConfigureSuggestions({
        suggestions: [
            { title: "AI Agents Report", message: "Generate a research report about AI agents." },
            { title: "LLM Trends", message: "Create a report on the latest LLM trends." },
            { title: "AI in Healthcare", message: "Research AI applications in healthcare." },
        ],
        available: "always",
    });
    ...
    const [reports, setReports] = useState<ResearchReport[]>([
        {
            ...
            sections: [
                { heading: "Overview", content: "Ask the AI crew to research any topic and generate a detailed report." },
            ],
    ...
    useFrontendTool(
        {
            ...
            parameters: z.object({
                title: z
                    .string()
                    .describe("Title of the research report"),
                sections: z
                    .array(z.object({
            ...
            handler: async ({
                ...
                setReports((prev) => [
                    newReport,
                    ...prev.filter(
                        (r) => r.sections[0]?.content !== "Ask the AI crew to research any topic and generate a detailed report."
                    ),
                ]);
    ...
    return (
        <div
            ...
            style={{
                ...
                overflow: "hidden",
                background: report.gradient || "linear-gradient(to bottom right, #f8fafc, #eff6ff)",
            }}
        >
            <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", gap: "24px" }}>
                <h2 data-testid="report-title" style={{ fontSize: "28px", fontWeight: 700, background: "linear-gradient(to right, #1e293b, #475569)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "-0.02em", margin: 0 }}>
                    {report.title}
                </h2>
