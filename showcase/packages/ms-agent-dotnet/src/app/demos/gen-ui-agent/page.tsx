...
import { CopilotChat, useAgent, UseAgentUpdate, useConfigureSuggestions } from "@copilotkit/react-core/v2";
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {isCompleted ? <CheckIcon /> : isCurrentPending ? <SpinnerIcon /> : <ClockIcon />}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div
                    ...
                    className={`font-semibold transition-all duration-300 text-sm ${
                      isCompleted ? "text-green-700" : isCurrentPending ? "text-blue-700 text-base" : "text-gray-500"
                    }`}
                  >
                    {step.description}
                  </div>
