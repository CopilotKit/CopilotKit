        ...
        >
            {decision === "launched" ? (
                <div style={{ textAlign: "center" }}>
                    ...
                    <h2 style={{ color: "white", fontWeight: "bold", fontSize: "1.5rem", marginBottom: "0.5rem" }}>
                        Mission Launched
                    </h2>
                    <p style={{ color: "rgba(255,255,255,0.7)" }}>We made it to the moon!</p>
                </div>
            ) : decision === "aborted" ? (
                <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: "4rem", marginBottom: "1rem" }}>✋</div>
                ...
                <>
                    <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
                        ...
                        <p style={{ color: "rgba(255,255,255,0.7)" }}>Mission to the Moon 🌕</p>
                    </div>
                    {status === "executing" && (
