...
function WeatherCard({
    ...
    return (
        ...
        >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                    <h3
                        ...
                        style={{ color: "white", fontWeight: "bold", fontSize: "1.25rem", textTransform: "capitalize" }}
                    >
                        {data.location}
                    </h3>
                    <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                        Current Weather
                    </p>
                </div>
            ...
            <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "0.875rem", textTransform: "capitalize", marginTop: "4px" }}>
                {data.conditions}
            </p>
            ...
            >
                <div data-testid="weather-humidity">
                    <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>Humidity</p>
                    <p style={{ color: "white", fontWeight: 600, fontSize: "0.875rem", marginTop: "2px" }}>{data.humidity}%</p>
                </div>
                <div data-testid="weather-wind" style={{ borderLeft: "1px solid rgba(255,255,255,0.1)", borderRight: "1px solid rgba(255,255,255,0.1)" }}>
                    <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>Wind</p>
                    <p style={{ color: "white", fontWeight: 600, fontSize: "0.875rem", marginTop: "2px" }}>{data.wind_speed} mph</p>
                </div>
                <div data-testid="weather-feels-like">
                    <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>Feels Like</p>
                    <p style={{ color: "white", fontWeight: 600, fontSize: "0.875rem", marginTop: "2px" }}>{data.feelsLike}°</p>
                </div>
            </div>
        </div>
    );
