 ...
 * `Record<string, any>` at the renderer boundary.
 */
 ...
 * transitions to "Booked ✓" and disables further clicks. The basic
 * catalog's Button is stateless, so overriding the `Button` entry in this
 * custom catalog is what gives the fixed-schema demo a visible post-click
 * confirmation.
 */
