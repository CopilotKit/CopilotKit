...
function RecipeEditor() {
    ...
    useConfigureSuggestions({
        suggestions: [
            ...
            },
            {
                ...
                message: "Make the recipe spicier with chili and pepper.",
            },
            {
                title: "Make it vegan",
                message: "Convert this recipe to be fully vegan.",
            },
        ],
        available: "always",
    });
    ...
    // Sync agent state into local state
                ...
                <div className="flex gap-4 mt-3">
                    <div className="flex items-center gap-1">
                        ...
                        <select
                            ...
                            value={
                                cookingTimeValues.find(
                                    (t) => t.label === recipe.cooking_time
                                )?.value || 3
                            }
                ...
                <div className="flex flex-wrap gap-2">
                    {Object.values(SpecialPreferences).map((option) => (
                        ...
                        >
                            <input
                                type="checkbox"
                                checked={recipe.special_preferences.includes(
                                    option
                                )}
                                onChange={(e) =>
                                    handleDietaryChange(
