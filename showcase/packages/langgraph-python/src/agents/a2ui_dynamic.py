...
SYSTEM_PROMPT = (
    ...
    "dashboard, status report, KPI summary, card layout, info grid, or "
    "anything more structured than plain text — call `generate_a2ui` to draw "
    "it. It takes no arguments and handles the rendering automatically. Keep "
