...
//
// The backend emits one reasoning message before each tool-calling step,
// so in the chat transcript you will see:
//   reasoning (plan) → tool call card → reasoning (follow-up) →
//   tool call card → final assistant text.
  ...
  useConfigureSuggestions({
    suggestions: [
      ...
      },
      {
        ...
        message: "Roll a 20-sided die for me.",
      },
      {
