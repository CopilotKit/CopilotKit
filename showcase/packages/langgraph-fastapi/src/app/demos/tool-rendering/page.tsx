    ...
    >
      <div className="px-6 pt-5 pb-4">
        <div className="flex items-start justify-between">
          ...
          <span className="text-5xl leading-none mt-[-4px]">☀️</span>
        </div>
      ...
      >
        <div data-testid="weather-humidity">
          ...
          <p className="text-white text-sm font-semibold mt-0.5">45%</p>
        </div>
        <div data-testid="weather-wind" className="border-x border-white/10">
          <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">
            Wind
          </p>
          <p className="text-white text-sm font-semibold mt-0.5">5 mph</p>
        </div>
        <div data-testid="weather-feels-like">
          <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">
            Feels Like
          </p>
          <p className="text-white text-sm font-semibold mt-0.5">72°</p>
        </div>
      </div>
    </div>
  );
