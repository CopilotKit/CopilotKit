        ...
        >
            ...
            <div className="grid grid-cols-3 text-center py-3 px-6"
                ...
                <div data-testid="weather-humidity">
                    <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">Humidity</p>
                ...
                <div data-testid="weather-wind" className="border-x border-white/10">
                    <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">Wind</p>
                    <p className="text-white text-sm font-semibold mt-0.5">{windSpeed} mph</p>
                </div>
                <div data-testid="weather-feels-like">
                    <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">Feels Like</p>
                    <p className="text-white text-sm font-semibold mt-0.5">{feelsLike}°</p>
                </div>
            </div>
        </div>
    );
