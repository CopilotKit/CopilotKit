...
restore_symlinks() {
  ...
  (cd "$SHOWCASE_ROOT" && git checkout -- integrations/*/tools integrations/*/shared-tools integrations/*/data integrations/*/_shared integrations/*/public/angular integrations/*/public/vue 2>/dev/null || true)
}
