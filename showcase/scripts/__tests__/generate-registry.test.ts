...
describe("Registry Generator", () => {
  it("generates registry.json from existing packages", async () => {
    ...
    // Count matches current manifest after Wave 4b added byoc-json-render
    // to the langgraph-python column (32→33, on top of Wave 1's open-gen-ui
    // + open-gen-ui-advanced re-wire that brought the count from 30→32).
