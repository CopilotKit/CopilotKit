...
describe("Catalog Generator", () => {
  ...
  it("LGP has status=wired for its 32 features (31 wired + 1 stub), unshipped for the other 6", () => {
    ...
    // (Wave 2b added `multimodal`, bumping wired 31→32 and unshipped 6→5.)
  ...
  it("metadata counts are correct", () => {
    ...
    // Wave 2b added `multimodal` (LGP-only), shifting one cell from unshipped to
    // wired: LGP wired 31→32, LGP unshipped 6→5; totals: 176→177, 486→485.
