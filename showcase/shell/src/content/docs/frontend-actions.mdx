...
For a deeper walkthrough — including handler patterns, parameter
typing, and how the agent calls these tools at runtime — see
[Frontend Tools](/langgraph-python/frontend-tools), which covers the
same primitive in more detail.
