...
- [Custom Sub-Components](/custom-look-and-feel/slots)
...
For a full list of styles and classes used in CopilotKit, click [here](https://github.com/CopilotKit/CopilotKit/blob/main/packages/react-ui/src/css/).
