 ...
 * `data`, `_shared`, `public/angular`, and `public/vue` symlinks with real
 * directory copies so
...
export function restoreSymlinks(): void {
  ...
  try {
    ...
    execSync(
      "git checkout -- integrations/*/tools integrations/*/shared-tools integrations/*/data integrations/*/_shared integrations/*/public/angular integrations/*/public/vue",
      {
        cwd: SHOWCASE_DIR,
        stdio: "pipe",
        encoding: "utf-8",
