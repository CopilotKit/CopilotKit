...
import { buildTurns, preNavigateRoute } from "./d5-gen-ui-open.js";
import { RENDERING_PILLS } from "./_pill-contracts-rendering.js";

describe("gen-ui-open canonical functional contract", () => {
  const canonical = RENDERING_PILLS["open-gen-ui"];
  const context = {
  ...
  it("retains the actual demo route", () => {
    expect(preNavigateRoute()).toBe("/demos/open-gen-ui");
  });
});
