...
import { buildTurns, preNavigateRoute } from "./d5-a2ui-recovery.js";
import { RENDERING_PILLS } from "./_pill-contracts-rendering.js";

describe("a2ui-recovery canonical functional contract", () => {
  const canonical = RENDERING_PILLS["a2ui-recovery"];
  const context = {
    integrationSlug: "langgraph-python",
    featureType: "a2ui-recovery",
  ...
  it("retains the actual demo route", () => {
    expect(preNavigateRoute()).toBe("/demos/a2ui-recovery");
  });
});
