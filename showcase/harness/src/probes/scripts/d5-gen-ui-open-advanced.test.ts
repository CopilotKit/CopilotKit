...
import { buildTurns, preNavigateRoute } from "./d5-gen-ui-open-advanced.js";
import { RENDERING_PILLS } from "./_pill-contracts-rendering.js";

describe("gen-ui-open-advanced canonical functional contract", () => {
  const canonical = RENDERING_PILLS["open-gen-ui-advanced"];
  const context = {
  ...
  it("retains the actual demo route", () => {
    expect(preNavigateRoute()).toBe("/demos/open-gen-ui-advanced");
  });
});
