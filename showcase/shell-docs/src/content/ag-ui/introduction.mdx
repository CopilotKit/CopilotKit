...
| :------------ | --------- | ------------------------------------------------ |
| Direct to LLM | Supported | [Docs](/integrations/built-in-agent) |

### Agent Framework - Partnerships

| Framework                                        | Status    | AG-UI Resources                                                                                                       |
| :----------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------- |
| [LangGraph](https://www.langchain.com/langgraph) | Supported | [Docs](/integrations/langgraph), [Demos](https://dojo.ag-ui.com/langgraph-fastapi/feature/shared_state) |
| [CrewAI](https://crewai.com/)                    | Supported | [Docs](/integrations/crewai-flows), [Demos](https://dojo.ag-ui.com/crewai/feature/shared_state)          |

### Agent Framework - 1st Party

| Framework                                                                                                                  | Status      | AG-UI Resources                                                                                                                                     |
| :------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Microsoft Agent Framework](https://azure.microsoft.com/en-us/blog/introducing-microsoft-agent-framework/)                 | Supported   | [Docs](/integrations/microsoft-agent-framework), [Demos](https://dojo.ag-ui.com/microsoft-agent-framework-dotnet/feature/shared_state) |
| [Google ADK](https://google.github.io/adk-docs/get-started/)                                                               | Supported   | [Docs](/integrations/adk), [Demos](https://dojo.ag-ui.com/adk-middleware/feature/shared_state?openCopilot=true)                        |
| [AWS Strands Agents](https://github.com/strands-agents/sdk-python)                                                         | Supported   | [Docs](/integrations/aws-strands), [Demos](https://dojo.ag-ui.com/aws-strands/feature/shared_state)                                    |
...
| [Mastra](https://mastra.ai/)                                                                                               | Supported   | [Docs](/integrations/mastra), [Demos](https://dojo.ag-ui.com/mastra/feature/tool_based_generative_ui)                                 |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai)                                                                     | Supported   | [Docs](/integrations/pydantic-ai), [Demos](https://dojo.ag-ui.com/pydantic-ai/feature/shared_state)                                   |
| [Agno](https://github.com/agno-agi/agno)                                                                                   | Supported   | [Docs](/integrations/agno), [Demos](https://dojo.ag-ui.com/agno/feature/tool_based_generative_ui)                                     |
| [LlamaIndex](https://github.com/run-llama/llama_index)                                                                     | Supported   | [Docs](/integrations/llamaindex), [Demos](https://dojo.ag-ui.com/llamaindex/feature/shared_state)                                     |
| [AG2](https://ag2.ai/)                                                                                                     | Supported   | [Docs](/integrations/ag2) [Demos](https://dojo.ag-ui.com/ag2/feature/shared_state)                                                    |
...
| :------------------------------------------ | --------- | ----------------------------------------------- | ------------ |
| [A2A Middleware](https://a2a-protocol.org/) | Supported | [Docs](/integrations/a2a) | Partnership  |
...
| :----------------------------------------------------- | ----------- | ----------------------------------------------------------------------------- | ------------ |
| [CopilotKit](https://github.com/CopilotKit/CopilotKit) | Supported   | [Getting Started](/integrations/built-in-agent/quickstart) | 1st Party    |
