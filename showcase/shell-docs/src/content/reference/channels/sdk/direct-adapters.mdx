...
| -------------------- | ------------------------------------------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| Managed Intelligence | `createChannel({ name, agent })`           | CopilotKit Intelligence stores provider credentials and owns ingress and egress           | Slack and Microsoft Teams                               |
...
direct adapters already ship in `@copilotkit/channels@0.5.0`.
