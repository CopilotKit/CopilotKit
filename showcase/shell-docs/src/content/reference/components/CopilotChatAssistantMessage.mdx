...
<Callout type="info">
  Upgrading from a version that bundled Streamdown? See [Migrate the Markdown Renderer](/migrate/markdown-renderer) to restore rich rendering.
</Callout>
