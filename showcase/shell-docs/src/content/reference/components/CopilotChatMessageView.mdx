...
<PropertyReference name="subagent" type="SlotProp<typeof CopilotChatSubagent>">
  Slot for the group that shows the work of one subagent. Defaults to `CopilotChatSubagent`, which shows the name and status of the subagent and collapses when the subagent is done.
