...
<PropertyReference name="enableInspector" type="boolean">
  ...
  SSR, even when explicitly set to `true`.
</PropertyReference>
...
<Cards>
  ...
  <Card
    title="Packages"
    description="Standalone packages: @copilotkit/markdown-renderer, the built-in streaming markdown renderer."
    href="/reference/packages/markdown-renderer"
    icon={<LinkIcon />}
  />
</Cards>
