...
Custom properties to be sent with the request.
  ...
  Note: The `authorization` property is automatically forwarded to LangGraph agents. See the [LangGraph Agent Authentication Guide](/langgraph-python/auth) for details.
</PropertyReference>
