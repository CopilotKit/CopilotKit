...
icon: "lucide/Monitor"
description: Preview supported CopilotKit UI sources, A2UI catalog components, and the AG-UI event stream without leaving VS Code.
frontend: universal
---
...
href="/angular/features">Angular feature examples</a> instead: each supported
