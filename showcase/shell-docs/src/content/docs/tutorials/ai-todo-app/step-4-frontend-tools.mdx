...
You can check out the full reference for the `useFrontendTool` hook [here](/reference/hooks/useFrontendTool).
...
<Card
  ...
  description="Use useAgentContext so the copilot can answer questions about your todos."
/>
<Card
  title="Next: Wrap up →"
