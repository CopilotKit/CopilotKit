...
- Node.js 20+
- A CopilotKit project with CopilotKit Intelligence configured (via [Cloud-hosted CopilotKit Intelligence](/premium/managed-intelligence-platform) or [self-hosted](/premium/self-hosting))
