...
- Node.js 20+
- A CopilotKit project with the Intelligence Platform configured (via [Copilot Cloud](https://dashboard.operations.copilotkit.ai) or [self-hosted](/premium/self-hosting))
