...
<OpsPlatformCTA
  ...
  body="The free Developer tier on Cloud-Hosted Enterprise Intelligence has everything this tutorial uses — threads, realtime sync, and a license key."
...
- Node.js 20+
- A CopilotKit project with the Enterprise Intelligence Platform configured (via [Cloud-Hosted Enterprise Intelligence](/premium/managed-intelligence-platform) or [self-hosted](/premium/self-hosting))
