...
- An OpenAI API key (or Anthropic/Google — see [Model Selection](/unselected/model-selection))
- Node.js 20+
...
<Steps>
    ...
    <Step>
        ...
        <Callout type="info" title="What about other models?">
          This example uses OpenAI's GPT-4o. See [Model Selection](/unselected/model-selection) for Anthropic, Google, or custom model setup.
        </Callout>
    </Step>
    <Step>
