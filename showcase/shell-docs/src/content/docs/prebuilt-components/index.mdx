...
If your chat surface needs saved conversations, history, or thread switching, drop in [**CopilotThreadsDrawer**](/prebuilt-components/copilot-threads-drawer) next to any of them — or build your own switcher with [Headless Threads](/threads).
...
[`<CopilotThreadsDrawer>`](/prebuilt-components/copilot-threads-drawer) — a
