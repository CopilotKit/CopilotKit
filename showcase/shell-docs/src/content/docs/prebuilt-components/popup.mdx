...
<Snippet region="popup-imports" title="frontend/src/app/page.tsx — Imports Needed" />

You can define custom suggestions as elaborated in CopilotChat Section, or it can be removed
