...
<Callout type="warn">
  ...
  is the [deprecated v1 chat](/migrate/v2), and it cannot drive the
  [Threads Drawer](/prebuilt-components/copilot-threads-drawer). This page
  documents the v2 chat, which you import from `@copilotkit/react-core/v2`.
</Callout>
