...
For saved conversations and switching between prior conversations, drop in the [Threads Drawer](/prebuilt-components/copilot-threads-drawer) (or go headless with [Headless Threads](/threads)).
