...
Here are the basic imports you'll need

<Snippet region="sidebar-imports" title="frontend/src/app/page.tsx — Needed imports" />

Here is an example component which uses `useConfigureSuggestions` to give suggestions to users

<Snippet region="suggestions-component-example" title="frontend/src/app/page.tsx — Suggestions" />

Lastly, you can wrap your components like this.
