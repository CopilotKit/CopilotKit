...
- Open-source telemetry is anonymous by default. Managed projects can add the
...
The Inspector sends telemetry directly with its browser identity. Its delivery
does not depend on `CPK_TELEMETRY_ID`.
