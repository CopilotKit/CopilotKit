...
Published packages type-check and emit declarations with TypeScript 7 (`tsc` is the Go compiler). Angular stays on TypeScript 5.9.3. Vue stays on TypeScript 5.8.2 and `vue-tsc`.
