...
- [Generative UI](/generative-ui/tool-based): render a tool result as a card or another interactive surface instead of plain text.
- [Threads](/threads): persist conversations and work with the thread API directly.
- [Threads Drawer](/prebuilt-components/copilot-threads-drawer): add a ready-made thread switcher beside the chat.
