...
- [Threads and the threads drawer](/vue/guides/threads-and-drawer): persist conversations and add a ready-made thread switcher beside the chat.
- [Vue API reference](/reference/vue): find the current `@copilotkit/vue/v2` component and composable APIs.

The Vue reference also covers slot-based customization, thread management, interrupts, and SSR-safe behavior.
