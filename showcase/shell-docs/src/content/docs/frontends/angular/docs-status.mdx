...
3. Use the shared [Runtime](/angular/backend/copilot-runtime) and [CopilotKit Intelligence](/angular/premium/overview) docs for server architecture, persistence, hosting, and operations. These concepts do not change with the frontend; only frontend-specific code does.
