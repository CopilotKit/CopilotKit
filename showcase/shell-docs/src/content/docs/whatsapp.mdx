...
See the [full example README](https://github.com/CopilotKit/CopilotKit/tree/main/examples/whatsapp) for the complete two-process setup with Linear and Notion MCP integrations.
...
- **API reference:** the [Bots reference](/reference/bot) — [createBot](/reference/bot/functions/createBot), the [Thread API](/reference/bot/classes/Thread), [tools](/reference/bot/functions/defineBotTool) & [commands](/reference/bot/functions/defineBotCommand), and the [component vocabulary](/reference/bot/components/Message)
- **Full example:** [on-call triage bot over Linear + Notion MCP](https://github.com/CopilotKit/CopilotKit/tree/main/examples/whatsapp) — tools, human-in-the-loop, commands, file uploads, persistent history
