...
<InlineDemo demo="reasoning-custom" />
...
<InlineDemo demo="reasoning-default" />
...
<Tabs items={['page.tsx', 'reasoning-block.tsx']}>
  ...
  <Tab value="reasoning-block.tsx">
    <Snippet file="src/app/demos/reasoning-custom/reasoning-block.tsx" noCaption />
  </Tab>
</Tabs>
