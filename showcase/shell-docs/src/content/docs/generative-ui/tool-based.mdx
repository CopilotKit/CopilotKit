...
Unlike [tool rendering](/generative-ui/tool-rendering/custom), which wraps a
...
around a real backend tool, see [Tool rendering](/generative-ui/tool-rendering/custom).
