...
<Steps>
    <Step>
        ...
        <SignupLink surface="docs_pydantic_ai_quickstart_step1">Sign up for a free developer account</SignupLink> on our Intelligence Platform to get a license key. You'll use it later to enable persistent threads, observability, and the inspector.
    </Step>
