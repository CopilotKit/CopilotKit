    ...
    >
        ...
        >
            <Step>
                ...
                ```sh
                pip install 'pydantic-ai-slim[ag-ui,openai]==2.22.0' 'ag-ui-protocol==0.1.19' 'starlette>=0.46.2' uvicorn
                ```
            </Step>
            <Step>
            ...
            <Step>
                ...
                Create an API route that connects CopilotKit to the AG-UI endpoint you just exposed.
