...
Use frontend tools to let [your agent control the UI](/langgraph/frontend-tools), create [generative UI](/langgraph/frontend-tools), or run human-in-the-loop interactions.
