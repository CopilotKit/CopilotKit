...
description: "Import historical LangGraph Server, LangGraph Platform, or LangSmith Deployment threads into CopilotKit Intelligence, then add Rich Threads while continuing to use LangGraph persistence."
icon: "lucide/Repeat"
doc_type: how-to
---
...
<Callout type="info" title="Keep your LangGraph persistence and add Rich Threads">
