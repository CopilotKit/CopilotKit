---
title: Synchronize LangGraph Threads
nav_title: Synchronize Thread History
description: "Import historical LangGraph Server, LangGraph Platform, or LangSmith Deployment threads into CopilotKit Intelligence, then add Threads while continuing to use LangGraph persistence."
icon: "lucide/Repeat"
doc_type: how-to
---
...
The LangGraph importer reads already-persisted LangGraph Server, LangGraph Platform, or LangSmith Deployment threads and writes them into CopilotKit Intelligence as Threads.
...
<Callout type="info" title="Keep your LangGraph persistence and add Threads">
