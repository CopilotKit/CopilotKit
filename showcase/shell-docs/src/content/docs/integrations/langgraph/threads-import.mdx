...
description: "Import historical LangGraph Server, LangGraph Platform, or LangSmith Deployment threads into CopilotKit Intelligence, then keep future CopilotKit runs synchronized as Rich Threads."
icon: "lucide/Repeat"
doc_type: how-to
---
