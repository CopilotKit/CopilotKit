  ...
  variants={[
    {
      label: "LangGraph",
      exampleUrl:
        "https://feature-viewer.copilotkit.ai/agent-spec-langgraph/feature/backend_tool_rendering?sidebar=false&chatDefaultOpen=false",
      codeUrl:
        "https://feature-viewer.copilotkit.ai/agent-spec-langgraph/feature/backend_tool_rendering?view=code&sidebar=false&codeLayout=tabs",
    },
    {
      label: "WayFlow",
      exampleUrl:
        "https://feature-viewer.copilotkit.ai/agent-spec-wayflow/feature/backend_tool_rendering?sidebar=false&chatDefaultOpen=false",
      codeUrl:
        "https://feature-viewer.copilotkit.ai/agent-spec-wayflow/feature/backend_tool_rendering?view=code&sidebar=false&codeLayout=tabs",
    },
  ]}
  exampleLabel="Demo"
  codeLabel="Code"
...
<Callout>
  ...
  applied in the{" "}
  <a
    href="https://feature-viewer.copilotkit.ai/agent-spec-wayflow/feature/agentic_chat"
    target="_blank"
  >
