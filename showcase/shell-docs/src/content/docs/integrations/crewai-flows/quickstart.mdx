...
<Step>
    ...
    <SignupLink surface="docs_crewai_flows_quickstart_step1">Sign up for a free developer account</SignupLink> on our Enterprise Intelligence Platform to get a license key. You'll use it later to enable persistent threads and the inspector.
</Step>
...
<Cards>
  ...
  <Card
    ...
    href="/crewai-flows/generative-ui/tool-rendering/custom"
    icon={<PaintbrushIcon />}
  />
  <Card
