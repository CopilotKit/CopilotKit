...
<Steps>
    <Step>
        ...
        <SignupLink surface="docs_built_in_agent_quickstart_step1">Sign up for a free developer account</SignupLink> on our Enterprise Intelligence Platform. With that account, you can later create or select a hosted project for persistent Threads and the Inspector.
    </Step>
    ...
    <Step>
        ...
        <Callout type="info" title="Already have an app?">
          Skip this step and install CopilotKit into your existing React or Next.js project. The CopilotKit CLI (`npx copilotkit@latest create`, aliased as `init`) scaffolds a brand-new project in its own directory — it does not add CopilotKit to an app you already have. Once your Runtime v2 endpoint works, follow [Connect an Existing App to Hosted Intelligence](/premium/existing-app-hosted-intelligence) to add managed Threads.
        </Callout>
    </Step>
    <Step>
