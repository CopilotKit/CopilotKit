...
<Cards>
  <Card title="Generative UI" href="/built-in-agent/generative-ui/tool-rendering/custom" description="Render rich React components in the chat." icon={<Sparkles className="text-primary" />} />
