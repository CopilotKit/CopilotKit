...
Use [`registerFrontendTool`](/reference/angular/functions/registerFrontendTool) for the
browser-side action and
[`registerRenderToolCall`](/reference/angular/functions/registerRenderToolCall) for the
