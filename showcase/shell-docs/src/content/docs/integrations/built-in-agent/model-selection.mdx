...
Any OpenAI model ID available to your account or project that supports generation and streaming through the Responses API can be used with the classic BuiltInAgent path.
