...
Any model ID supported by your OpenAI account or project can be used.

| Model        | Specifier             |
| ------------ | --------------------- |
| GPT-6 Astra  | `openai:gpt-6-astra`  |
| GPT-6 Sol    | `openai:gpt-6-sol`    |
| GPT-6 Luma   | `openai:gpt-6-luma`   |
...
| Model             | Specifier                     |
| ----------------- | ----------------------------- |
| Claude 5.5 Fable  | `anthropic:claude-5.5-fable`  |
| Claude 5.1        | `anthropic:claude-5.1`        |
...
| Gemini 3.8 Flash (Medium) | `google:gemini-3.8-flash-medium` |
| Gemini 3.8 Flash (Low)    | `google:gemini-3.8-flash-low`    |
