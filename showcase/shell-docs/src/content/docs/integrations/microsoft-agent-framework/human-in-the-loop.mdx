...
<Tabs groupId="language_microsoft-agent-framework_agent" items={['.NET', 'Python']} persist>
  ...
  <Tab value="Python">
    <IframeSwitcher
      id="frontend-tools-based-hitl-example-python"
      exampleUrl="https://feature-viewer.copilotkit.ai/microsoft-agent-framework-python/feature/human_in_the_loop?sidebar=false&chatDefaultOpen=false"
      codeUrl="https://feature-viewer.copilotkit.ai/microsoft-agent-framework-python/feature/human_in_the_loop?view=code&sidebar=false&codeLayout=tabs"
      exampleLabel="Demo"
      codeLabel="Code"
      height="700px"
    />
