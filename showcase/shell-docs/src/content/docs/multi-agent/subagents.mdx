...
<InlineDemo demo="subagents" llmRegion="subagent-state-from-result" />
...
This page builds a delegation log from shared state. If your agent sends
AG-UI subagent events, the chat can group the work of each subagent for you:
...
<AngularSnippet
  ...
  title="showcase/angular/src/app/features/agent-state/agent-state-feature.component.ts"
/>
</FrontendOnly>
