...
- `@copilotkit/react-core` or `@copilotkit/react-core` imported somewhere in your workspace.
...
| `useRenderTool` | `@copilotkit/react-core` | render-tool (`parameters`, `status`, `toolCallId`) |
| `useRenderToolCall` | `@copilotkit/react-core` | render-tool |
| `useDefaultRenderTool` | `@copilotkit/react-core` | render-tool |
| `useLazyToolRenderer` | `@copilotkit/react-core` | render-tool |
| `useFrontendTool` | `@copilotkit/react-core` | render-tool |
| `useComponent` | `@copilotkit/react-core` | render-tool |
| `useDefaultTool` | `@copilotkit/react-core` | action |
| `useHumanInTheLoop` | `@copilotkit/react-core` | action |
| `useInterrupt` | `@copilotkit/react-core` | interrupt |
| `useRenderCustomMessages` | `@copilotkit/react-core` | custom-messages (`message`) |
| `useRenderActivityMessage` | `@copilotkit/react-core` | activity-message (`message`) |
...
- **Barrel-file re-exports aren't resolved** — import hooks directly from `@copilotkit/react-core` or `@copilotkit/react-core`. If you re-export through your own index file, the scanner won't pick up the call sites.
