...
[Observability](/premium/observability), the [inspector](/inspector), and other Intelligence Platform capabilities are provided through the runtime. These give you conversation persistence, monitoring, and debugging without extra setup.
