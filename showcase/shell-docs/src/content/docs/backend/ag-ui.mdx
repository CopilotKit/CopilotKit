...
This indirection is what enables the runtime to provide authentication, middleware, agent routing, and Intelligence Platform features — without changing how you interact with agents on the frontend.
