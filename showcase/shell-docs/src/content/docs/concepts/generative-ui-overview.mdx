...
| **[Tool Call Rendering](/generative-ui/tool-rendering/custom)** | Wrap your agent's existing backend tool calls in custom UI cards with `useRenderTool` (live status, arguments, results). |
...
| Brand the cards CopilotKit draws for your agent's existing backend tools | **[Tool Call Rendering](/generative-ui/tool-rendering/custom)** |
...
<Cards>
  ...
  <Card
    ...
    href="/generative-ui/tool-rendering/custom"
