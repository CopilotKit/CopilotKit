...
- **CopilotKit Intelligence overview** — [CopilotKit Intelligence](/intelligence/overview) covers Threads, Persistence, hosted inspection, and the cloud-hosted-vs-self-hosted decision.
