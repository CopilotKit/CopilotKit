...
#### Thread storage
    ...
    - **For production**
        - Use **CopilotKit Intelligence**, managed via **Copilot Cloud** or self-hosted via **Copilot Enterprise**, to persist threads, get automatic stream reconnection, and in-built product analytics. See the [Threads guide](/threads) to get started on the free Developer tier.
