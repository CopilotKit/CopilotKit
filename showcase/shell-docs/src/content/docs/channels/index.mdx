...
<Cards>
  ...
  <Card title="Posting arbitrary JSX as images" href="/channels/posting-jsx-as-images" description="Post any app component to a thread and have it render to an image via Takumi, no browser required." />
