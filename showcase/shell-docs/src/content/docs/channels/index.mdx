...
The retired symbol pages documented the pre-0.3 direct-adapter API. For the
current managed Channels journey, start with [Slack](/slack) or
[Microsoft Teams](/teams); each provider section includes the maintained
Channel, Thread, and callback contracts.
