...
description: Run one AG-UI agent in Slack, Microsoft Teams, and more through cloud-hosted Intelligence connections.
...
also get the rest of CopilotKit Intelligence, including Analytics,
Learning, and governance. You can absolutely build and operate your
...
<OpsPlatformCTA
  ...
  body="Slack is available now on cloud-hosted Intelligence. Teams is in controlled availability. Direct SDK adapters also support Teams, Discord, WhatsApp, and Telegram."
