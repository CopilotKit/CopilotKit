...
<Cards>
  ...
  <Card title="Posting JSX as images" href="/channels/posting-jsx-as-images" description="Post any app component to a thread and have it render to an image via Takumi, no browser required." />
  <Card title="Charts" href="/channels/charts" description="Bar, line, pie, and more, posted as images with no chart library, or let the agent chart data on its own." />
