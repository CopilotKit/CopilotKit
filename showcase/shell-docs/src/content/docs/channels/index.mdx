...
channel connection (Slack or Microsoft Teams), delivers each turn to your
...
<OpsPlatformCTA
  ...
  body="Managed Slack and Microsoft Teams are available through the setup wizard. Direct SDK adapters also support Teams, Discord, WhatsApp, and Telegram."
