...
<Steps>
  ...
  <Step>
    ...
    The two URLs above are the hosted Intelligence endpoints; use your
    deployment's app API and realtime gateway URLs when self-hosting. Open
    **API Keys** in the project sidebar to create and copy the project-scoped
    runtime key.
  ...
  <Step>
    ...
    After you start the SDK listener, the Channel should become **Online**.
    ...
    | **Waiting for runtime** | Start the listener and match its Code and provider to this Channel. |
    ...
    Continue with the [Slack quickstart](/slack) to start the listener and
    ...
    Continue with the [Teams quickstart](/teams) to start the listener and
    verify a real message.
