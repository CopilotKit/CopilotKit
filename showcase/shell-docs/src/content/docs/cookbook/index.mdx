...
<Cards>
  <Card
    title="Ship an MCP App with Manufact"
    href="/cookbook/manufact"
    logo="/logos/manufact.svg"
    logoClassName="dark:invert"
    description="Build an MCP App with the open-source mcp-use SDK, render it inline in CopilotKit's chat, and deploy it to Manufact Cloud."
  />
  <Card
    title="Choose fast generative UI with Jev"
    href="/cookbook/jev-generative-ui"
    logo="/logos/typesafe.svg"
