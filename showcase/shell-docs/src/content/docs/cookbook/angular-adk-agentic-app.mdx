...
- [ADK quickstart](/adk/quickstart) serves an ADK agent over AG-UI.
...
ADK uses Google's Gemini by default and also supports other models. See the [ADK quickstart](/adk/quickstart) for configuration.
