...
This context can then be shared with your LangChain agent.

## Implementation
<Callout>
    Check out the [Frontend Data documentation](/unselected/agent-app-context) to understand what this is and how to use it.
</Callout>
    ...
    >
        <Steps>
            <Step>
                ...
                <Snippet region="context-provider-sketch" title="YourComponent.tsx — owning the values" />
                <Snippet region="use-agent-context-call" title="YourComponent.tsx — useAgentContext" />
            </Step>
            ...
            <Step>
                ### Consume the data in your LangChain agent
                The state of a LangChain agent is the "hub" for applicative information used by the agent.
