...
<Steps>
  ...
  <Step>
    ...
    <FrontendOnly frontend="react">
      ...
      1. Open **Home**. Check the **Intelligence** card for **Connected** and the expected project.
      ...
      If the Intelligence card does not show **Connected**, or Threads is locked, the setup is incomplete. Follow the action shown in Inspector or review the [Inspector setup states](/inspector#enable-or-repair-intelligence).
    </FrontendOnly>
