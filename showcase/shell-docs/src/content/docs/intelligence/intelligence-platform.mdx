...
The platform also gives teams operational visibility into agent behavior. The web app exposes project history and embedded Inspector views, [Analytics](/intelligence/analytics), [Memories](/intelligence/memories), [Learning](/learning), managed [Channels](/slack), API key management, and plan management. Analytics charts are project-scoped; organization usage cards aggregate usage across projects.
