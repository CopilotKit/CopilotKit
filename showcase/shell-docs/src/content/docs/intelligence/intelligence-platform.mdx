...
Open a stored thread in the [cloud-hosted project](/intelligence/managed-intelligence-platform#sign-in-and-create-a-project). API keys and plans live on [Cloud-hosted](/intelligence/managed-intelligence-platform) and [Plans](/intelligence/plans).
