---
title: "User Memories"
description: "Give your agents long-term memory across conversations."
icon: "lucide/Brain"
...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/intelligence/quickstart#set-it-up-manually) to connect your existing app and configure server-side user identity.
  </Step>
