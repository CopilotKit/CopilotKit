...
<OpsPlatformCTA
  variant="inline"
  title="Try the Intelligence Platform"
...
- **Intelligence Platform overview:** [Intelligence Platform](/premium/overview) — hosted and self-hosted capabilities
