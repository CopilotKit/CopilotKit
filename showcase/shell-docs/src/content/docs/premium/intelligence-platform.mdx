...
CopilotKit Intelligence is the platform backend behind production CopilotKit capabilities such as durable threads, realtime sync, project-scoped history, the hosted web app, and operational visibility. This page explains the mental model that applies to both [Cloud-hosted CopilotKit Intelligence](/premium/managed-intelligence-platform) and [Self-host CopilotKit Intelligence](/premium/self-hosting).

For a product-level map of features and hosting options, start with the [CopilotKit Intelligence overview](/premium/overview). To wire an existing runtime to the platform, see [Connect your runtime to Intelligence](/premium/connect-your-runtime). For Kubernetes installation, go straight to [Self-host CopilotKit Intelligence](/premium/self-hosting).
...
For the cloud-hosted dashboard flow, see [Cloud-hosted CopilotKit Intelligence](/premium/managed-intelligence-platform).
...
- **Platform overview:** [CopilotKit Intelligence](/premium/overview) — features, hosting options, and where to go next
- **Cloud-hosted guide:** [Cloud-hosted CopilotKit Intelligence](/premium/managed-intelligence-platform) — login, projects, API keys, threads, and plan management
- **Self-hosted guide:** [Self-host CopilotKit Intelligence](/premium/self-hosting) — install and operate the platform in Kubernetes
