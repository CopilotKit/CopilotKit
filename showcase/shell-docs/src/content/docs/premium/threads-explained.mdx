...
Start with the [Threads overview](/threads) to understand the product benefits
and choose between the prebuilt Drawer and a custom headless UI. This page
explains the persistence and replay architecture beneath both paths.
...
- **Product overview:** [Threads](/threads) — understand the feature and choose an implementation path
