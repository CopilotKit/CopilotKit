...
- **Angular guide:** [Threads, memory, attachments, and headless UI](/angular/guides/threads-memory-attachments-headless)
- **API reference:** [injectThreads](/reference/angular/functions/injectThreads) — options, signals, and mutations
</FrontendOnly>
