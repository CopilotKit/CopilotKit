...
- **Start with Rich Threads:** [Rich Threads overview](/threads) — create a cloud-hosted starter and verify the included Threads Drawer
...
- **Production self-hosting:** [Self-Hosting Enterprise Intelligence](/premium/self-hosting) — review the Kubernetes architecture and engage CopilotKit Engineering
