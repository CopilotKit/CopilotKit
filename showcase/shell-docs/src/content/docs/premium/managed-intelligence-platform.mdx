...
<OpsPlatformCTA
  variant="inline"
  title="Create a connected app with the CLI"
  body="Create a free Enterprise Intelligence account, then run npx copilotkit@latest init to scaffold and connect a new app. Use the dashboard to administer projects, API keys, thread history, and plans."
