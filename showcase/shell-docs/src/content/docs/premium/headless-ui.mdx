...
<Callout type="info">
Fully Headless UI is available through the Enterprise Intelligence Platform. Use Cloud-Hosted Enterprise Intelligence or a self-hosted license to unlock it.
</Callout>
