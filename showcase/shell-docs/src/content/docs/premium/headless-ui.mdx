...
<Callout type="info">
Fully Headless UI is available through the Enterprise Intelligence Platform. Grab a free `publicLicenseKey` at [Copilot Cloud](https://dashboard.operations.copilotkit.ai) to unlock it.
</Callout>
