...
Use **Open Intelligence** to open the Intelligence app in a new tab. Select your
project and Learning container in Intelligence. You can then run an analysis or
review pending Skill candidates.
