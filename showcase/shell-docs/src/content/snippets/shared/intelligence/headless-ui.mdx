...
<Steps>
  ...
  <Step>
    ...
    You will need to provide your public license key to the `CopilotKit` provider component. Get yours on [Copilot Cloud](https://dashboard.operations.copilotkit.ai) or read more about [CopilotKit Intelligence](/intelligence/overview).

    A managed Intelligence project does not issue this key. Its project-scoped
    `CPK_INTELLIGENCE_API_KEY` is a server-side Runtime credential and does not
    unlock this hook.
