...
- **Cloud-hosted platform:** [Cloud-hosted CopilotKit Intelligence](/intelligence/managed-intelligence-platform) — login, projects, API keys, threads, and plans in the hosted web app
