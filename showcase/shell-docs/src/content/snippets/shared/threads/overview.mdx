...
<div className="sm:hidden">
  <Image
    src="/images/threads/threads-architecture-mobile-light.svg"
    alt="A vertical view of a user resuming a thread, the app components that run it, and Enterprise Intelligence storing and replaying its history."
    width={720}
    height={1190}
    className="block dark:hidden my-6 w-full mx-auto"
  />
  <Image
    src="/images/threads/threads-architecture-mobile-dark.svg"
    alt="A vertical view of a user resuming a thread, the app components that run it, and Enterprise Intelligence storing and replaying its history."
    width={720}
    height={1190}
...
<div className="not-prose md:hidden divide-y divide-fd-border overflow-hidden rounded-lg border border-fd-border">
  <div className="p-5">
  ...
  [Set up the Threads Drawer →](/prebuilt-components/copilot-threads-drawer)
  ...
  [Build a custom thread UI →](/headless-threads)
