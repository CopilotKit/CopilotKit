...
<Image
  src="/images/threads/threads-diagram.png"
  alt="A user starts a conversation and returns to it from another device. The diagram also shows how the web app, Channels synchronization adapter, Enterprise Intelligence, AG-UI, and the agent connect."
  width={2000}
  height={1200}
