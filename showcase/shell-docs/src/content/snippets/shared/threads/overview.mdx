...
<OpsPlatformCTA
  variant="inline"
  title="Run Enterprise Intelligence in your own infrastructure"
  body="Production self-hosting keeps Rich Threads, event history, identity, storage, and operations inside your network. Book time with a CopilotKit engineer to get started."
