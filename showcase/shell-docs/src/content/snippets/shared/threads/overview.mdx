...
- **Use the hosted platform:** [Cloud-hosted CopilotKit Intelligence](/premium/managed-intelligence-platform) — create and manage the project where your app stores threads and runtime credentials
- **Plan production self-hosting:** [Self-host CopilotKit Intelligence](/premium/self-hosting) — work with CopilotKit Engineering to run the Threads platform in your Kubernetes environment
