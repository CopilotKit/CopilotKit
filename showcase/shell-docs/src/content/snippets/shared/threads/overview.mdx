...
Start free with Rich Threads in CopilotKit Intelligence. Usage and retention limits apply; see [current plans](https://www.copilotkit.ai/pricing). Managed Cloud stores thread data in the managed service. To use your own infrastructure and database, choose [self-hosted Intelligence](/intelligence/self-hosting).
...
- **Use the hosted platform:** [Cloud-hosted CopilotKit Intelligence](/intelligence/managed-intelligence-platform) — create and manage the project where your app stores threads and runtime credentials
