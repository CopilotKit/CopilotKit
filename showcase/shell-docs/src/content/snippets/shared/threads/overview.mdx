...
<Frame description="A support workspace using Threads Drawer to move between customer conversations while CopilotChat renders the selected case details.">
  <img
    ...
    className="block w-full rounded-lg !my-0"
  />
</Frame>
