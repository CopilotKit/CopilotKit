...
The frontend pattern is the same for every backend. This is the exact
`get_weather` registration used by the Showcase demo. Its imported card and
result helper live beside this page in that demo:

<Snippet
  region="render-weather-tool"
  title="frontend/src/app/demos/tool-rendering/page.tsx — weather renderer"
/>
...
<Snippet
  ...
  title="frontend/src/app/page.tsx — per-tool + catch-all"
/>
