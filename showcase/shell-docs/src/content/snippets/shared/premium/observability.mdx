...
<OpsPlatformCTA
  variant="card"
  title="Observability requires an Intelligence Platform license key"
...
## Getting Started with the Intelligence Platform

To use observability hooks (event hooks and error observability), you'll need Intelligence Platform access:
...
<Callout type="info">
  The Intelligence Platform is free to get started and provides production-ready
