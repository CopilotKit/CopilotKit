...
To use observability hooks (event hooks and error observability), you'll need Enterprise Intelligence Platform access:
...
<Callout type="info">
  The Enterprise Intelligence Platform is free to get started and provides production-ready
