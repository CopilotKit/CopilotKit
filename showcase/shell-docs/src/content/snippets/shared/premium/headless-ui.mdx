...
<OpsPlatformCTA
  variant="card"
  title="Headless UI requires an Intelligence Platform license key"
...
<Steps>
  ...
  <Step>
    ...
    You will need to provide your public license key to the `CopilotKit` provider component. Get yours on [Copilot Cloud](https://dashboard.operations.copilotkit.ai) or read more about the [Intelligence Platform](/premium).
