...
Before starting, make sure the following are in place. [CopilotKit Intelligence architecture](/premium/intelligence-platform) explains the application/runtime/platform layers in more depth.
...
- **Platform architecture:** [CopilotKit Intelligence architecture](/premium/intelligence-platform) — runtime/platform architecture, project boundaries, threads, and realtime sync
- **CopilotKit Intelligence overview:** [CopilotKit Intelligence](/premium/overview) — features, hosting options, and where to go next
