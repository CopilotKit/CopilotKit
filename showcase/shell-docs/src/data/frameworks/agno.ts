...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Give your Agno agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications.",
  bannerVideo:
  ...
  featuresLink:
    "https://feature-viewer.copilotkit.ai/agno/feature/agentic_chat",
  supportedFeatures: [
    {
      title: "Generative UI",
      description:
