...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Give your AG2 agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications.",
  bannerVideo:
  ...
  architectureImage:
    "https://cdn.copilotkit.ai/docs/copilotkit/images/coagents/ag2/architecture.png",
  liveDemos: [
    {
      type: "saas",
      title: "SaaS Copilot",
