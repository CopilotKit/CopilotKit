...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Let your users collaborate with your CrewAI Flow-based agents using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications.",
  bannerVideo:
  ...
  architectureVideo:
    "https://cdn.copilotkit.ai/docs/copilotkit/images/coagents/crew-ai/flows/crews-interaction-layer.mp4",
  liveDemos: [
    {
      type: "saas",
      title: "SaaS Copilot",
