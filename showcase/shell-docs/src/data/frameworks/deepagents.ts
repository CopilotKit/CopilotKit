...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Give your Deep Agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications with LangChain's Deep Agents framework.",
  bannerVideo:
