...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Give your Pydantic AI agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications.",
  bannerVideo:
  ...
  featuresLink:
    "https://feature-viewer.copilotkit.ai/pydantic-ai/feature/agentic_chat",
  supportedFeatures: [
    {
      title: "Generative UI",
      description:
