...
const data: FrameworkOverviewData = {
  ...
  subheader:
    "Give your Mastra agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications.",
  bannerVideo:
  ...
  featuresLink:
    "https://feature-viewer.copilotkit.ai/mastra/feature/agentic_chat",
  supportedFeatures: [
    {
      title: "Generative UI",
      description:
  ...
  architectureImage:
    "https://cdn.copilotkit.ai/docs/copilotkit/images/mastra/overview.png",
  liveDemos: [
    {
      type: "saas",
      title: "SaaS Copilot",
