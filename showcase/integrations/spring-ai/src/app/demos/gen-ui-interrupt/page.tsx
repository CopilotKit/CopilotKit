...
// Gen UI Interrupt demo (Spring AI port).
//
...
// hook. Spring AI's ChatClient has no equivalent interrupt primitive, so we
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the Spring AI
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the Spring AI shim for LangGraph's
