...
2. Rep / team performance: a Column with a Card containing one DataTable and one BarChart of quota attainment percentages for all five reps. Use table columns rep and attainment; if pipeline is included, display "Unavailable" for every rep. Table attainment and chart values must agree. Do not use StatusBadge or InfoRow.
