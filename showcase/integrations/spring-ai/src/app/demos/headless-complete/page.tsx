...
// Spring AI port: routed through the shared /api/copilotkit endpoint. The
// ag-ui:spring-ai integration doesn't wire an MCP client, so the MCP-apps
// activity rendering path in use-rendered-messages.tsx is a no-op here;
// everything else — useRenderToolCall, useRenderCustomMessages,
