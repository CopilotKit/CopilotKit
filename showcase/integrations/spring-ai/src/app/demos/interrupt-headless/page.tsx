...
// Headless Interrupt demo (Spring AI port).
//
...
// Spring AI's ChatClient has no interrupt primitive, so we instead register
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the Spring AI shim for the LangGraph headless interrupt
    // `resume` flow.
    handler: async ({
      topic,
      attendee,
