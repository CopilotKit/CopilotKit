...
// route rejects any request without the header.
//
...
// `/info`) will 401, which we surface via the page-level error banner.

import { Component, use, useCallback, useMemo, useState } from "react";
