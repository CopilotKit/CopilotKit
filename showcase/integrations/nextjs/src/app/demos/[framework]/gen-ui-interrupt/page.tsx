...
// Gen UI Interrupt demo (unified nextjs port).
//
// The LangGraph version of this demo uses `useInterrupt` with LangGraph's
// native `interrupt()` primitive. For backends without an interrupt
// primitive (e.g. AWS Strands), we adapt via a frontend tool registered
...
const DEMO_ID = "gen-ui-interrupt";
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels.
