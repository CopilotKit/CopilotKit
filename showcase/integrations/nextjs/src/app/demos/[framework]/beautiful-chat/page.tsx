...
/**
 * Beautiful Chat (unified nextjs port).
 *
 * A polished landing-style chat surface with brand theming and seeded
 * suggestions over the shared backend agent.
 *
 * Reference (strands legacy):
 * showcase/integrations/strands/src/app/demos/beautiful-chat/page.tsx
 */
        ...
        <div className="relative flex h-full w-full max-w-3xl flex-col gap-4 px-4 py-8">
          <header className="space-y-1">
            ...
            <p className="text-sm text-[#3A3A46]">
              A polished conversational surface powered by your backend. Ask a
