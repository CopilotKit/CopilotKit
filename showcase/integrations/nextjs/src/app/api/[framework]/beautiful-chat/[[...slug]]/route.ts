// showcase/integrations/nextjs/src/app/api/[framework]/beautiful-chat/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "beautiful-chat": new HttpAgent({
        url: `${fw.backendUrl}/beautiful-chat/`,
      }),
    },
  });
  ...
  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/beautiful-chat`,
  })(req);
}
