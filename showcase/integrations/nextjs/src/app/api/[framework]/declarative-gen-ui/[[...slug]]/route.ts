// showcase/integrations/nextjs/src/app/api/[framework]/declarative-gen-ui/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "declarative-gen-ui": new HttpAgent({ url: `${fw.backendUrl}/declarative-gen-ui/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/declarative-gen-ui`,
  })(req);
}
