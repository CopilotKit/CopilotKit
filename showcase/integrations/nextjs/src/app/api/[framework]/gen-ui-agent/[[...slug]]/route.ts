// showcase/integrations/nextjs/src/app/api/[framework]/gen-ui-agent/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "gen-ui-agent": new HttpAgent({ url: `${fw.backendUrl}/gen-ui-agent/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/gen-ui-agent`,
  })(req);
}
