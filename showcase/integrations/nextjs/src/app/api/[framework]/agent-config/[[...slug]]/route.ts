// showcase/integrations/nextjs/src/app/api/[framework]/agent-config/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "agent-config": new HttpAgent({ url: `${fw.backendUrl}/agent-config/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/agent-config`,
  })(req);
}
