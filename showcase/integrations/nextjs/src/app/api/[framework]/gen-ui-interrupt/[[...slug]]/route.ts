// showcase/integrations/nextjs/src/app/api/[framework]/gen-ui-interrupt/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "gen-ui-interrupt": new HttpAgent({
        url: `${fw.backendUrl}/gen-ui-interrupt/`,
      }),
    },
  });
  ...
  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/gen-ui-interrupt`,
  })(req);
}
