// showcase/integrations/nextjs/src/app/api/[framework]/a2ui-fixed-schema/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "a2ui-fixed-schema": new HttpAgent({ url: `${fw.backendUrl}/a2ui-fixed-schema/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/a2ui-fixed-schema`,
  })(req);
}
