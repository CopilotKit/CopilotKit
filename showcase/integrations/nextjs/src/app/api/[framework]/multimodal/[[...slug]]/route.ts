// showcase/integrations/nextjs/src/app/api/[framework]/multimodal/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      multimodal: new HttpAgent({ url: `${fw.backendUrl}/multimodal/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/multimodal`,
  })(req);
}
