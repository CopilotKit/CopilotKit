// showcase/integrations/nextjs/src/app/api/[framework]/interrupt-headless/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "interrupt-headless": new HttpAgent({
        url: `${fw.backendUrl}/interrupt-headless/`,
      }),
    },
  });
  ...
  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/interrupt-headless`,
  })(req);
}
