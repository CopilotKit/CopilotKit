// showcase/integrations/nextjs/src/app/api/[framework]/gen-ui-tool-based/[[...slug]]/route.ts
...
async function handle(
  ...
  const runtime = new CopilotRuntime({
    agents: {
      ...
      "gen-ui-tool-based": new HttpAgent({ url: `${fw.backendUrl}/gen-ui-tool-based/` }),
    },
  });

  return createCopilotRuntimeHandler({
    runtime,
    basePath: `/api/${fwSlug}/gen-ui-tool-based`,
  })(req);
}
