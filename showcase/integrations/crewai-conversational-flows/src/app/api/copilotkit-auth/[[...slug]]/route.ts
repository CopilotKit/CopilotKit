...
// agent.
//
// Backend: reuses the shared CrewAI crew via HttpAgent — the auth gate is a
// runtime-layer concern, independent of the agent's internal behavior.
//
...
function createAgent() {
  return new HttpAgent({ url: `${AGENT_URL}/conversational_flows/chat` });
}
