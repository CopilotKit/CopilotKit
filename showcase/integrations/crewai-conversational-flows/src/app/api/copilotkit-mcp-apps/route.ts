// CopilotKit runtime for the MCP Apps cell (CrewAI Conversational Flows backend).
//
...
// `${AGENT_URL}/conversational_flows/mcp-apps` (see src/agent_server.py).
//
// Reference:
// https://docs.copilotkit.ai/integrations/crewai-conversational-flows/generative-ui/mcp-apps
...
const mcpAppsAgent = new HttpAgent({
  url: `${AGENT_URL}/conversational_flows/mcp-apps`,
});
