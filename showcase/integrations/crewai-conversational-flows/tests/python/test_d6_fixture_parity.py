...
CREWAI_ROOT = SHOWCASE_ROOT / "integrations" / "crewai-conversational-flows"
...
CREWAI_FIXTURES = AIMOCK_ROOT / "crewai-conversational-flows"
CREWAI_D4_FIXTURES = SHOWCASE_ROOT / "aimock" / "d4" / "crewai-conversational-flows"
...
def test_crewai_d6_behavioral_fixtures_match_langgraph_python():
    for filename in PARITY_FIXTURES:
        crewai = AIMOCK_ROOT / "crewai-conversational-flows" / filename
