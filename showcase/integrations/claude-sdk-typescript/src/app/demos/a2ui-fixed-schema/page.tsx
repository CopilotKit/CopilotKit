 ...
 * `src/agent/a2ui_schemas/flight_schema.json` (Card > Column > [Title, Row, …]).
 *
 ...
 * - Agent: `src/agent/a2ui-fixed-prompt.ts` + `/a2ui-fixed-schema` route in `src/agent_server.ts` (emits an `a2ui_operations` container)
 *
 * Reference:
