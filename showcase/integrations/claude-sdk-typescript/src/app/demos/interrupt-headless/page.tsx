...
// Headless Interrupt demo (Claude Agent SDK TypeScript port).
//
...
// The Claude Agent SDK has no interrupt primitive, so we instead register
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the Claude SDK shim for the LangGraph headless interrupt
    // `resume` flow.
    handler: async ({
      topic,
      attendee,
