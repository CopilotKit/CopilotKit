 ...
 * - Dedicated ag2 agent at `src/agents/multimodal_agent.py`, exposed to the
 *   runtime under the slug `multimodal-demo` and mounted by
 *   `src/agent_server.py` as its own FastAPI sub-app at `/multimodal/`.
 *   ag2 1.0 maps attachments natively: images go to the vision model, PDFs
 *   travel as OpenAI file parts — no server-side flattening needed.
