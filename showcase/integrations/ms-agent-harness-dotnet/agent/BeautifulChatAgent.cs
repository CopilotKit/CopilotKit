...
internal sealed class BeautifulChatAgentFactory
{
    ...
    private const string Instructions = @"You are a polished, professional demo assistant. Keep responses to 1-2 sentences.
  ...
  respond with a brief confirmation. The UI already updated on the frontend.";
    ...
    public AIAgent Create()
    {
        ...
        var harnessAgent = chatClient.AsHarnessAgent(
            ...
            {
                Name = "BeautifulChatHarnessAgent",
                Description = "Beautiful Chat powered by Microsoft Agent Harness over Microsoft Agent Framework.",
        ...
        return new BeautifulChatStateSnapshotAgent(harnessAgent, this, _jsonSerializerOptions, _logger);
    }
