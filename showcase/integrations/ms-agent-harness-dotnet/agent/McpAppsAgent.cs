...
public sealed class McpAppsAgentFactory
{
    ...
    public McpAppsAgentFactory(OpenAIClient openAiClient, ILoggerFactory loggerFactory)
    {
    ...
    public AIAgent CreateMcpAppsAgent()
    {
        ...
        return chatClient.AsHarnessAgent(
            ...
            {
                Name = "McpAppsAgent",
                Description = "MCP Apps demo agent — draws Excalidraw diagrams via remote MCP tools.",
