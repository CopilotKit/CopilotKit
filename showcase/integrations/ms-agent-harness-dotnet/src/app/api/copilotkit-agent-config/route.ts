...
//
// References:
// - showcase/integrations/ms-agent-harness-dotnet/agent/AgentConfigAgent.cs
// - showcase/integrations/ms-agent-harness-dotnet/src/app/demos/agent-config/page.tsx
