 ...
 * dedicated backend agent (`src/agent/agent.ts` buildA2uiRecoveryAgent); the
 * page's provider catalog auto-enables A2UI tool injection, so the Strands
 * adapter auto-injects `generate_a2ui`, drives the forced `render_a2ui`
 * sub-agent, and runs the recovery loop + recovery-exhausted hard-fail envelope
 * (OSS-158 / OSS-375).
 *
