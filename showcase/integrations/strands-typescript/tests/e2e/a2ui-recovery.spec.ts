...
//
// The aimock fixtures (showcase/aimock/d6/strands-typescript/a2ui-recovery.json)
...
// path (@ag-ui/aws-strands); the failure UI text ("Couldn't generate the UI")
...
test("@canonical rendering a2ui-recovery: all actual LGP pills and results", async ({
  ...
  const result = await run({
    cell: {
      id: "react/strands-typescript/a2ui-recovery",
      frontend: "react",
