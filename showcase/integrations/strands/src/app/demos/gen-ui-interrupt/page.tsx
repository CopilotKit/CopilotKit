...
// Gen UI Interrupt demo (Strands port).
//
// The LangGraph version of this demo uses `useInterrupt` with LangGraph's
// native `interrupt()` primitive. AWS Strands does NOT have an equivalent
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the Strands
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the Strands shim for LangGraph's
