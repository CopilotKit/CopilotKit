...
/**
 * Sidebar card that READS agent-authored notes from shared state.
 *
 * The Claude backend writes these via its `set_notes` tool. The UI
 * re-renders because the parent page subscribes via
 * `useAgent({ updates: [OnStateChanged] })`.
 *
 * The Clear button is a write-back from UI to agent state to demonstrate
