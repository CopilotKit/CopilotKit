...
The simplest CopilotKit surface: a plain agentic chat backed by a Claude Agent SDK (Python) agent.
...
- `agent="agentic_chat"` selects the shared Claude agent defined in `src/agents/agent.py`
