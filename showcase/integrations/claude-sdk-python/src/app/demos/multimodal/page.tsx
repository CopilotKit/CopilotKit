 ...
 *   path.
 * - Dedicated Claude backend at `src/agents/multimodal_agent.py` under the
 *   slug `multimodal-demo`. Images are forwarded to Claude natively; PDFs are
 *   flattened to text on the Python side via `pypdf` for provider-agnostic
 *   behavior.
