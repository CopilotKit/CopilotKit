...
// Headless Interrupt demo (PydanticAI port).
//
...
// PydanticAI has no interrupt primitive, so we instead register
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the PydanticAI shim for the LangGraph headless
