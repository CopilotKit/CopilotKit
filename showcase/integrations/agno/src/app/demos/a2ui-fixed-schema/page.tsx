...
/**
 * Declarative Generative UI — A2UI Fixed Schema demo (Agno).
 *
 * In the fixed-schema flavor of A2UI, the component tree (schema) lives on
 * the frontend AND the backend, and the agent only streams *data* into the
 * data model. The flight card is ASSEMBLED from small sub-components in
