...
// Gen UI Interrupt demo (Agno port).
//
...
// hook. Agno does NOT have an equivalent interrupt primitive, so we adapt
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the Agno
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the Agno shim for LangGraph's
