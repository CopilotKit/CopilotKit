...
function DemoContent() {
  // Subscribe to agent state. The agno supervisor pushes a STATE_SNAPSHOT
  // event after every run (via the custom AGUI router in agent_server.py),
  // which fires this hook and re-renders the delegation log.
