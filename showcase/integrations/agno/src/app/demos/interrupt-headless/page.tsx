...
// Headless Interrupt demo (Agno port).
//
...
// Agno has no interrupt primitive, so we instead register `schedule_meeting`
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the Agno shim for the LangGraph headless interrupt
    // `resume` flow.
    handler: async ({
      topic,
      attendee,
