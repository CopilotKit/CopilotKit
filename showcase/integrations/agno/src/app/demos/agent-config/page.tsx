      ...
      <div className="flex h-screen flex-col gap-3 p-6">
        <header>
          ...
          <p className="text-sm text-[var(--text-muted)]">
            ...
            <code> responseLength</code> through the provider; the Agno agent
            reads them from <code>RunAgentInput.forwarded_props</code> and
            builds its system prompt per turn.
          </p>
        </header>
        <ConfigCard
          config={config}
