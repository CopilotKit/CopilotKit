...
// Headless Interrupt demo (CrewAI Crews port).
//
...
// CrewAI Crews has no interrupt primitive, so we instead register
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the CrewAI Crews shim for the LangGraph headless
