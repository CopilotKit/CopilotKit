...
// Gen UI Interrupt demo (CrewAI Crews port).
//
...
// hook. CrewAI Crews does NOT have an equivalent interrupt primitive, so we
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the CrewAI
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the CrewAI Crews shim for
