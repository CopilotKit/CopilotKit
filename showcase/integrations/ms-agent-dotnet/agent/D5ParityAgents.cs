...
public sealed class D5ParityAgentFactory
{
    ...
    public AIAgent CreateToolRenderingAgent(bool reasoning)
    {
        ...
        // breaks the sequential tool loop (probe saw 1 get_stock_price card).
        // The unified runtime already injects REASONING_* via
        // synthetic_reasoning_demos for this demo id.
