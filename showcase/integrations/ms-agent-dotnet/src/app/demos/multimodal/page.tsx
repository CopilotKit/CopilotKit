...
/**
 * Multimodal Attachments demo — .NET port.
 *
 ...
 *   ../api/copilotkit-multimodal/route.ts) that proxies to the .NET backend's
 *   `/multimodal` mount via AG-UI over HTTP.
 * - .NET agent: `agent/MultimodalAgent.cs` — a ChatClientAgent using the
 *   vision-capable gpt-4o-mini chat model. The model consumes image content
 *   parts natively, and modern OpenAI models accept PDFs too. No tools.
