...
// Tool Rendering — CUSTOM CATCH-ALL variant (.NET / Microsoft Agent Framework).
//
// Same backend (SalesAgent) as `tool-rendering-default-catchall`, but this
// cell opts out of CopilotKit's built-in default tool-call UI by registering
