 ...
 * the frontend/backend as a pinned contract and the agent only streams
 * *data* into the data model. The flight card is ASSEMBLED from small
 * sub-components (Card > Column > [Title, Row, …]).
 *
 ...
 * - Agent: `agent/A2uiFixedSchemaAgent.cs` (emits an `a2ui_operations` container)
 *
 * Reference:
 * https://docs.copilotkit.ai/integrations/microsoft-agent-framework/generative-ui/a2ui/fixed-schema
 */
