...
// Branded catch-all renderer for tool calls. Registered via
// `useDefaultRenderTool` in page.tsx, this component handles EVERY tool call
// the OpenClaw agent makes (shell, read, etc.) — there are no per-tool
// renderers in this cell.
//
...
// JSON parsing rather than importing across cell boundaries.
