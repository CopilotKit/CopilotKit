...
export function ConfigCard({
  ...
  return (
    <div
      ...
      className="flex flex-col gap-2 rounded-md border border-gray-200 bg-white p-4 text-sm shadow-sm"
    >
      <h2 className="text-sm font-semibold text-gray-900">Agent Config</h2>
      <p className="text-xs text-gray-500">
        Change these and send a message to see the OpenClaw agent adapt.
      </p>
