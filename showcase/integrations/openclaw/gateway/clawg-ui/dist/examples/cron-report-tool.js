...
export function cronReportToolFactory(ctx) {
    ...
    return {
        name: "cron_report",
        label: "Cron Report",
        description: "Display cron job run results as rich visual cards. Call this tool with an array of " +
                ...
                runs: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            startedAt: { type: "string", description: "When the run started, e.g. 'Apr 5, 10:30 AM'" },
                            duration: { type: "string", description: "How long the run took, e.g. '2m 14s'" },
                            model: { type: "string", description: "LLM model used, e.g. 'claude-sonnet-4-6'" },
                            tokensUsed: { type: "string", description: "Total tokens consumed, e.g. '12,847'" },
                            summary: { type: "string", description: "Free-text summary of what the job did and its outcome" },
                        },
