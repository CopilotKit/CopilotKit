// Deterministic financial ledger for the beautiful-chat `query_data` tool.
// Verbatim from langgraph-python's beautiful_chat_data/db.csv (the canonical
// reference dataset); the model aggregates these rows into pie/bar charts.
