 ...
 *
 * Structurally mirrors the declarative-hashbrown demo so the two dashboard
 * rows are directly comparable -- the only substantive difference is the
