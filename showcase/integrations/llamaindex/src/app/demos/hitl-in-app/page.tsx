...
function Layout() {
  ...
  useFrontendTool({
    ...
    description:
      "Ask the operator to approve or reject an action before you take it. Returns { approved: boolean, reason?: string }.",
    parameters: z.object({
      message: z
        .string()
        .describe("Short summary of the action needing approval."),
  ...
  return (
    <div className="grid h-screen grid-cols-[1fr_420px] bg-gray-50">
      ...
      <div className="border-l border-gray-200 bg-white">
        <CopilotChat agentId="hitl_in_app" className="h-full" />
      </div>
      {dialog.open && (
