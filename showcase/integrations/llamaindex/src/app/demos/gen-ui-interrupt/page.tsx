...
// Gen UI Interrupt demo (LlamaIndex port).
//
...
// hook. LlamaIndex does NOT have an equivalent interrupt primitive, so we
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the LlamaIndex
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the LlamaIndex shim for LangGraph's
