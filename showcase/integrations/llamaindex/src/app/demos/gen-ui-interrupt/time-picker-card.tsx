 ...
 * `interrupt()` primitive and `useInterrupt`. LlamaIndex has no interrupt
 * primitive, so this port wires the same card up through `useFrontendTool`
 * with an async handler: when the agent calls `schedule_meeting`, the
