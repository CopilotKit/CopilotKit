...
// triggers the agent from a chat suggestion. When the backend emits a
// pause event, the hook renders a time-picker popup IN THE APP SURFACE
// (left pane), not inside the chat. Picking a slot resolves the paused
// run, the popup vanishes, and the agent confirms back in chat.
