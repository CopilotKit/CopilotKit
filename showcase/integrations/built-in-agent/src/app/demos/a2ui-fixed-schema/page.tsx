 ...
 * the backend `FLIGHT_SCHEMA` constant (Card > Column > [Title, Row, ...]).
 *
 ...
 * - Agent: `src/lib/factory/a2ui-fixed-schema-factory.ts` (emits an
 *   `a2ui_operations` container)
 *
 * Reference:
 * https://docs.copilotkit.ai/built-in-agent/generative-ui/a2ui/fixed-schema
 */
