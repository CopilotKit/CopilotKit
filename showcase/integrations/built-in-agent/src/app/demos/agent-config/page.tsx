 ...
 * config is passed to this in-process runtime through the provider's
 * `properties` prop. The runtime exposes it to the factory as
 * `input.forwardedProps` on every turn.
 */
