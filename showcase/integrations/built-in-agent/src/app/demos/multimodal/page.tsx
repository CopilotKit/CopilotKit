 ...
 *   ../api/copilotkit-multimodal/route.ts). The route registers a
 *   multimodal Built-in Agent alias under `multimodal-demo`.
 * - Images are forwarded to the model natively; PDFs include extracted
 *   fallback text in the sample path so the demo stays deterministic.
