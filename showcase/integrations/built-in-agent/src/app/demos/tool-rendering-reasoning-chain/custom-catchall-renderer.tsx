...
// Branded catch-all renderer for tools without a dedicated per-tool
// renderer. Self-contained so this cell doesn't import across cell
// boundaries — kept in sync with `tool-rendering-custom-catchall`.
