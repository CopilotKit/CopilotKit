...
// Modal dialog rendered at the APP level (portal'd to <body>) — not inside
// the chat bubble tree. The caller supplies `pending` (the message/context
// the agent wants approval for) and an `onResolve` completion callback.
