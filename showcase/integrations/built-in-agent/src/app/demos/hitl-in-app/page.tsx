...
// In-App HITL demo for built-in-agent.
//
// Pattern: agent calls a frontend tool (`request_user_approval`) whose
// async handler returns a Promise that is resolved by an app-level modal
// dialog rendered OUTSIDE the chat bubble tree. The user's Approve/Reject
// click resolves the pending Promise, which feeds the value back to the
