...
const createHeadlessCompleteMcpAgent = () =>
  createMcpAppsAgent({ toolProfile: "headless-complete" });
...
const runtime = new CopilotRuntime({
  agents: {
    ...createAgentAliases(["default", "mcp-apps"], createMcpAppsAgent),
    ...createAgentAliases(
      ["headless-complete"],
      createHeadlessCompleteMcpAgent,
    ),
  },
