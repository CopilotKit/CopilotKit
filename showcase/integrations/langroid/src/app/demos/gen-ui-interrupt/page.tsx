...
// Gen UI Interrupt demo (Langroid port).
//
// The LangGraph version of this demo uses `useInterrupt` with LangGraph's
// native `interrupt()` primitive. Langroid does NOT have an equivalent
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the Langroid
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the Langroid shim for LangGraph's
