 ...
 *
 * This card is wired up through `useFrontendTool` with an async handler:
 * when the agent calls `schedule_meeting`, the handler returns a Promise
 * that only resolves once the user picks a slot (or cancels).
 */
