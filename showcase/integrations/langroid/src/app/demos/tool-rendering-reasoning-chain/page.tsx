...
// Tool Rendering — REASONING CHAIN variant (Langroid).
//
...
//
// PARITY NOTE: Langroid does not yet emit native THINKING_* / reasoning
// AG-UI events from its tool-call loop. The reasoning slot is wired here
// for parity with the langgraph-python integration; on Langroid it
// renders only when reasoning content arrives over the wire (e.g.,
// when the underlying provider emits reasoning deltas). The
// tool-rendering portion of the cell works regardless of reasoning support.
