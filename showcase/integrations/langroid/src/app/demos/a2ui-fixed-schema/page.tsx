...
/**
 * Declarative Generative UI — A2UI Fixed Schema demo (Langroid port).
 *
 * In the fixed-schema flavor of A2UI, the component tree (schema) is
 * authored ahead of time and shipped with the backend; the agent only
 * streams *data* into the data model at runtime. The flight card is
 * ASSEMBLED from small sub-components in
