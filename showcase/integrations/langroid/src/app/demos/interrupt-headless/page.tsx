...
// Headless Interrupt demo (Langroid port).
//
...
// `interrupt()` event from the AG-UI stream. Langroid has no interrupt
...
function Layout() {
  ...
  useFrontendTool({
    ...
    // popup. This is the Langroid shim for the LangGraph headless interrupt
    // `resume` flow.
    handler: async ({
      topic,
      attendee,
