...
// Gen UI Interrupt demo (Mastra port).
//
...
// hook. Mastra does NOT have an equivalent interrupt primitive, so we adapt
...
function Chat() {
  ...
  // prop when the user clicks a slot or cancels. This is the Mastra
  ...
  useFrontendTool({
    ...
    // acts on the picker. This is the Mastra shim for LangGraph's
