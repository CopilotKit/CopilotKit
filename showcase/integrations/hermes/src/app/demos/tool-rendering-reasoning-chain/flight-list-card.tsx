...
// Rich per-tool renderer for the `search_flights` client-executed tool.
//
// Registered in page.tsx via `useFrontendTool({ name: "search_flights", ... })`,
// this card shows the search origin/destination and a short list of
// flight results. It only renders once the client handler returns; while
// the tool is still running it shows a compact loading state so the chat
// doesn't look frozen.
