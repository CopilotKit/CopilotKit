...
/**
 * Catch-all card rendered for any tool that doesn't have its own
 * dedicated per-tool renderer. Includes unknown MCP tool names. Wired up
 * via `useDefaultRenderTool` in `hooks/use-tool-renderers.tsx`.
 */
