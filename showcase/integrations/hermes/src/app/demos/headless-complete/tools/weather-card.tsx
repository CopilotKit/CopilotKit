...
/**
 * Visual card for the `get_weather` tool. Wired up via `useFrontendTool`
 * in `hooks/use-tool-renderers.tsx` (client-executed on Hermes — the
 * fixture emits the tool call, the client handler produces the data).
 */
