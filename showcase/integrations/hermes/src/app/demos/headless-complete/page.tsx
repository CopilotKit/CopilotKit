 ...
 *
 * Runtime: this cell points at `/api/copilotkit-mcp-apps` (shared with the
 * mcp-apps cell) because it also exercises MCP Apps activity rendering via
 * the hand-rolled `useRenderActivityMessage` in `chat/message-list.tsx`.
 */
