...
// NOTE (hermes divergence): `@copilotkit/shared` (v1.61.2 shipped with this
// integration) exports the tool-result message type as `ToolResult`
// (`agui.ToolMessage & { toolName? }`), not `ToolMessage` as newer versions
// used in langgraph-python do. `ToolResult` is a superset of the AG-UI
// tool message and carries `toolCallId`, so it satisfies `renderToolCall`'s
// `toolMessage` param.
