...
//
// Same SERVER-SIDE backend tools as `tool-rendering-default-catchall`
// (the `hermes-showcase` toolset — see integrations/hermes/showcase_tools.py),
...
//
// No client tool registration: the tools execute server-side and their
// results arrive via AG-UI's TOOL_CALL_RESULT; the wildcard renderer paints
// them all.
