...
// backend tools (get_weather, search_flights, get_stock_price, roll_d20)
// execute SERVER-SIDE in Hermes (the `hermes-showcase` toolset — see
// integrations/hermes/showcase_tools.py), 1:1 with langgraph-python. The
// frontend opts ONLY into CopilotKit's built-in default tool-call card — no
// per-tool renderers, no custom wildcard UI.
//
...
//
// No client tool registration: the agent calls the server-side tools and
// their results arrive via AG-UI's TOOL_CALL_RESULT; the built-in default
// catchall paints them.
