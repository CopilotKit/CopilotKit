# QA: Tool Rendering (Reasoning Chain) — Hermes
...
- [ ] Send a multi-tool prompt (e.g. "Compare AAPL and MSFT stocks for me.") and verify reasoning blocks interleave with sequential tool cards (`WeatherCard`, `FlightListCard`, or the custom catchall)
