          ...
          <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={stars ? `GitHub — ${stars.toLocaleString()} stars` : 'GitHub'}
              ...
              >
                ...
                {starsLabel && <span className="tabular-nums">{starsLabel}</span>}
              </a>
              <a
                href={DISCORD_URL}
                target="_blank"
