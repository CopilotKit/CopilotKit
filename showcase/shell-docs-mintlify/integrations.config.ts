...
export const integrations = [
  { slug: 'built-in', label: 'CopilotKit', color: '#16A34A', showcaseSlug: 'built-in-agent' },
  { slug: 'langgraph', label: 'LangChain', color: '#7C3AED', showcaseSlug: 'langgraph-typescript' },
  { slug: 'adk', label: 'Google ADK', color: '#0EA5E9', showcaseSlug: 'google-adk' },
  { slug: 'a2a', label: 'A2A (Agent-to-Agent)', color: '#4F46E5' },
  { slug: 'ag2', label: 'AG2 (AutoGen)', color: '#BE185D', showcaseSlug: 'ag2' },
  { slug: 'agent-spec', label: 'Agent Spec', color: '#64748B' },
  { slug: 'agno', label: 'Agno', color: '#14B8A6', showcaseSlug: 'agno' },
  { slug: 'aws-strands', label: 'AWS Strands', color: '#F59E0B', showcaseSlug: 'strands' },
  { slug: 'crewai-flows', label: 'CrewAI Flows', color: '#DC2626', showcaseSlug: 'crewai-crews' },
  { slug: 'llamaindex', label: 'LlamaIndex', color: '#0891B2', showcaseSlug: 'llamaindex' },
  { slug: 'mastra', label: 'Mastra', color: '#F97316', showcaseSlug: 'mastra' },
  { slug: 'microsoft-agent-framework', label: 'Microsoft Agent Framework', color: '#2563EB', showcaseSlug: 'ms-agent-dotnet' },
  { slug: 'pydantic-ai', label: 'Pydantic AI', color: '#84CC16', showcaseSlug: 'pydantic-ai' },
...
export const referencePages = [
  // Hooks
  { slug: 'reference/hooks/use-agent', title: 'useAgent', description: 'Subscribe to agent state, send messages, manage threads.', group: 'Hooks' },
  { slug: 'reference/hooks/use-agent-context', title: 'useAgentContext', description: 'Share app state with the agent.', group: 'Hooks' },
  { slug: 'reference/hooks/use-frontend-tool', title: 'useFrontendTool', description: 'Define a frontend tool the agent can invoke.', group: 'Hooks' },
  { slug: 'reference/hooks/use-human-in-the-loop', title: 'useHumanInTheLoop', description: 'Pause the agent and request UI input.', group: 'Hooks' },
  { slug: 'reference/hooks/use-render-tool', title: 'useRenderTool', description: 'Render a named tool call as a React component.', group: 'Hooks' },
  { slug: 'reference/hooks/use-default-render-tool', title: 'useDefaultRenderTool', description: 'Catch-all renderer for unknown tools.', group: 'Hooks' },
  { slug: 'reference/hooks/use-component', title: 'useComponent', description: 'Register a React component as a renderable tool.', group: 'Hooks' },
  { slug: 'reference/hooks/use-interrupt', title: 'useInterrupt', description: 'Handle interrupt events from the agent.', group: 'Hooks' },
  { slug: 'reference/hooks/use-threads', title: 'useThreads', description: 'List, create, rename, archive, delete threads.', group: 'Hooks' },
  { slug: 'reference/hooks/use-attachments', title: 'useAttachments', description: 'Manage file attachment state for chat input.', group: 'Hooks' },
  { slug: 'reference/hooks/use-suggestions', title: 'useSuggestions', description: 'Subscribe to AI-generated chat suggestions.', group: 'Hooks' },
  { slug: 'reference/hooks/use-configure-suggestions', title: 'useConfigureSuggestions', description: 'Configure chat suggestions (static or AI-driven).', group: 'Hooks' },
  // Components
  { slug: 'reference/components/copilot-kit-provider', title: 'CopilotKit', description: 'Root provider for the CopilotKit runtime client.', group: 'Components' },
  { slug: 'reference/components/copilot-chat', title: 'CopilotChat', description: 'Inline chat component.', group: 'Components' },
  { slug: 'reference/components/copilot-popup', title: 'CopilotPopup', description: 'Floating chat popup.', group: 'Components' },
  { slug: 'reference/components/copilot-sidebar', title: 'CopilotSidebar', description: 'Slide-in chat sidebar.', group: 'Components' },
  // Runtime
  { slug: 'reference/runtime/copilot-runtime', title: 'CopilotRuntime', description: 'Server-side runtime that orchestrates agent requests.', group: 'Runtime' },
  { slug: 'reference/runtime/define-tool', title: 'defineTool', description: 'Define a server-side tool the agent can invoke.', group: 'Runtime' },
  // Agents
  { slug: 'reference/agents/built-in-agent', title: 'BuiltInAgent', description: 'Direct LLM agent with tools and gen UI.', group: 'Agents' },
  { slug: 'reference/agents/http-agent', title: 'HttpAgent', description: 'Generic AG-UI HTTP agent for connecting external backends.', group: 'Agents' },
  // Handlers
  { slug: 'reference/handlers/create-copilot-hono-handler', title: 'createCopilotHonoHandler', description: 'Hono adapter for the runtime.', group: 'Handlers' },
  { slug: 'reference/handlers/create-copilot-express-handler', title: 'createCopilotExpressHandler', description: 'Express adapter for the runtime.', group: 'Handlers' },
  // Middleware
  { slug: 'reference/middleware/before-request-middleware', title: 'beforeRequestMiddleware', description: 'Pre-request hook for auth, modification, or short-circuit.', group: 'Middleware' },
  { slug: 'reference/middleware/after-request-middleware', title: 'afterRequestMiddleware', description: 'Post-request hook for logging and audit.', group: 'Middleware' },
  { slug: 'reference/middleware/open-generative-ui-middleware', title: 'OpenGenerativeUIMiddleware', description: 'Auto-rendered generative UI from LLM output.', group: 'Middleware' },
  { slug: 'reference/middleware/a2ui-middleware', title: 'A2UIMiddleware', description: 'Declarative UI streaming middleware.', group: 'Middleware' },
  { slug: 'reference/middleware/mcp-apps-middleware', title: 'MCPAppsMiddleware', description: 'UI-enabled MCP server middleware.', group: 'Middleware' },
] as const satisfies readonly PageDef[];
 ...
 */
export function getSupportedIntegrations(page: PageDef): readonly IntegrationSlug[] {
