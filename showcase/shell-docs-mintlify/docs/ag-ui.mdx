...
This indirection is what enables the runtime to provide authentication, middleware, agent routing, and ecosystem features like [threads](/threads) — without changing how you interact with agents on the frontend.
