...
The `a2ui` prop on `<CopilotKit>` is only needed if you want to override defaults.
...
[Get started with A2UI](/a2a/declarative-a2ui) and A2A with CopilotKit
...
- [AG-UI Protocol](/ag-ui) - Learn about the protocol that supports A2UI
