...
icon: "lucide/Code"
description: "Connect your AI coding assistant (Cursor, Claude Code, Windsurf, etc.) to CopilotKit's MCP server for in-IDE expert guidance."
---
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={["Using the Built-in Server Browser", "Manual Configuration"]}>
      ...
      <Tab value="Manual Configuration">
        ...
        <Tabs items={["HTTP Transport", "stdio Transport (Local)"]}>
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={["Remote Server Setup", "Configuration File Setup"]}>
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={["Workspace Configuration (Recommended)", "User Settings Configuration", "Command Palette"]}>
...
<Tabs items={["JSON Configuration File", "Application Settings"]}>
