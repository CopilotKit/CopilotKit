...
- Required gates with current passing evidence: **8 / 18** (A02/A04 passed in the current working tree; current full suite 27/27; post-commit scope 4/4).
...
- Live trials passed / attempted: **159 / 177**. Earlier failed attempts remain in the trial ledger. Manual browser trials are recorded separately.
...
| A09  | Bound approval, stale identity and replay rejection       | not run | —             | Target binding, single-use and expiry unit checks exist; live race/tamper matrix remains.                                                       |
