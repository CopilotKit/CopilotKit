...
- Live trials passed / attempted: **1 / 3** (T001 app failure; T002 product flow worked but harness failed; T003 test passed).
...
- Overall state: **A01 live connection proven on current uncommitted source; most required gates remain unrun**.
...
| ---- | ---------------------------------------------------------------------- | ------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A01  | Real packages, BuiltInAgent, model and Intelligence                    | passing | uncommitted on `8801f423e2` | Nx package/app builds; authenticated `/info` reports Intelligence, `logistics`, valid license and thread endpoints; T003 stored user→assistant tool call→browser result→assistant continuation and four messages after reload. Reconfirm on source commit. |
