...
- Live trials passed / attempted: **4 / 7** (T001 app failure; T002 and T006 product flow reached a tool but the harness failed; T003–T005 and T007 passed). Manual browser trials are recorded separately in iterations 004–005.
...
- Next experiment: **add bounded page reading and an approved declared action on the reusable execution seam**.
