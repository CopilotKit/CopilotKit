...
- Required gates with current passing evidence: **6 / 18**.
- Unresolved critical failures: **none observed in the tested path; takeover, recovery, filtering, and concurrency controls remain unimplemented**.
- Live trials passed / attempted: **106 / 124** (earlier failures T001/T002/T006/T011–T014/T016–T018/T023/T025/T028–T029, T054's duplicate-alert oracle, T076/T077's incomplete review, and T095's fixture ordering remain visible). Manual browser trials are recorded separately.
- Last known working checkpoint: **committed discovered order and user actions, including custom select, reviewed before input with SQL/UI agreement**.
- Current highest-risk unknown: **approval races, user takeover, budgets, recovery, Inspector, and package portability**. The earlier client-navigation stall remains unexplained.
- Next experiment: **close navigation and trust/recovery cases, then package portability**.
- Overall state: **A01/A03/A05/A06/A07/A08 proven on committed source `50d4223fd3`; the remaining 12 gates need more evidence**.
...
| ---- | ---------------------------------------------------------------------- | ------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A01  | Real packages, BuiltInAgent, model and Intelligence                    | passing | `50d4223fd3`  | Post-commit 20/20 browser suite; T122 live frontend tool call, continuation, durable thread.                                                                                                                                                                                                       |
...
| A03  | Manual SaaS and persistent SQL                                         | passing | `50d4223fd3`  | Post-commit manual order/user create/edit/cancel with SQL/replay/role checks, plus separate restart test in 20/20 browser suite.                                                                                                                                                                   |
...
| A05  | Create through discovered controls                                     | passing | `50d4223fd3`  | T049/T050/T059/T067 created one exact SQL row each; review decision preceded input events; T051/T060/T068 decline left form and SQL unchanged. T113/T114 committed approve/decline with browser/SQL checks; native and supported custom-select form controls are covered.                          |
| A06  | Edit details and status through discovered controls                    | passing | `50d4223fd3`  | Separate destination/status T052/T053/T061/T062/T069/T070 changed only intended fields and UI/SQL version 2; T055/T063 server rejected booked→delivered, date endpoint rejected malformed date. T115–T118 committed separate destination/status/custom-select/invalid cases with SQL/UI agreement. |
| A07  | Cancel through declared action, reused approval                        | passing | `50d4223fd3`  | T110 approved through one app confirmation, SQL booked v1→cancelled v2 and stored result; T111 declined; T112 dispatched order had no control/effect.                                                                                                                                              |
| A08  | User management and server-enforced roles                              | passing | `50d4223fd3`  | Manual create/edit/deactivate and viewer/operator 403; T121 live approved user role update; session invalidation and stale-write browser check passed.                                                                                                                                             |
