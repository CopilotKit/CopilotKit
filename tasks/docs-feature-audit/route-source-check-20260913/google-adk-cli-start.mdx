...
More detail: [Inspector](/google-adk/inspector).
        ...
        >
            ...
            <Step>
                ...
                The provider, chat component, and stylesheet below come from `@copilotkit/react-core/v2`, so this setup does not need `@copilotkit/react-ui`.
            </Step>
            <Step>
               ...
               ```
                ...
                <Callout type="warn" title="Use verified identity before production">
                  ...
                  [Thread authorization](/google-adk/auth#thread-authorization).
                </Callout>
                ...
                <Callout type="info" title="Running without the Intelligence Platform?">
                  ...
                  [Connect your runtime to Intelligence](/google-adk/intelligence/connect-your-runtime) for the
