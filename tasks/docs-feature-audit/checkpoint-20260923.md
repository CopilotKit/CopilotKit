...
| Docs guard (selected five)     | **179/179** runnable bindings (was 127/186 when first measured mid-repair); 8 printed, independently reviewed exclusions            | `c3de380c93`…`834f867d45`, `a15bedca88`                                                          | `guard-bindings-*-20260923*.log`                            |
