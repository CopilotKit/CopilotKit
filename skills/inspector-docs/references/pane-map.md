...
| Rich Threads       | Default web quickstart step, Rich Threads setup steps | `open-inspector-step.mdx`, `open-inspector-pane-threads.mdx` | Unlocked or Enable Intelligence both count. The threads snippet renders as the last setup step and names **Try from here**. |
| Playground         | Inspector overview                                    |                                                              | Dedicated section explains the isolated scratch session and **Try from here**.                                              |
| What's New         | Inspector overview                                    |                                                              | Dedicated section explains matching updates, the preview, and read state.                                                   |
| Try from here      | Rich Threads setup steps                              | `open-inspector-pane-threads.mdx`                            | Overlay action on a real stored thread detail header.                                                                       |
...
| Automatic Learning | Automatic Learning guide; overview links a card       | `open-inspector-pane-learning.mdx`                           | Primary nav; published Skills, supporting Insights, and Thread evidence                                                     |
| Capabilities       | no page yet                                           |                                                              | Client tool and catalog toggles. No dedicated docs page in this slice                                                       |
| Conversation       | no page yet                                           |                                                              | Thread detail tab. Covered by Threads Callout                                                                               |
