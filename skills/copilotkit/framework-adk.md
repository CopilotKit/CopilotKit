...
### AG-UI
- Route: `/adk/ag-ui`
- Source: `docs/content/docs/integrations/adk/ag-ui.mdx`
...
### Coding Agents
- Route: `/adk/coding-agents`
- Source: `docs/content/docs/integrations/adk/coding-agents.mdx`
...
### Slots
- Route: `/adk/custom-look-and-feel/slots`
- Source: `docs/content/docs/integrations/adk/custom-look-and-feel/slots.mdx`
- Description: Customize any part of the chat UI by overriding individual sub-components via slots for ADK.
...
### Display-only
- Route: `/adk/generative-ui/your-components/display-only`
- Source: `docs/content/docs/integrations/adk/generative-ui/your-components/display-only.mdx`
- Description: Register React components that your agent can render in the chat for ADK.
...
### Interactive
- Route: `/adk/generative-ui/your-components/interactive`
- Source: `docs/content/docs/integrations/adk/generative-ui/your-components/interactive.mdx`
...
### Inspector
- Route: `/adk/inspector`
- Source: `docs/content/docs/integrations/adk/inspector.mdx`
...
### Prebuilt Components
- Route: `/adk/prebuilt-components`
- Source: `docs/content/docs/integrations/adk/prebuilt-components.mdx`
...
- Route: `/adk/programmatic-control`
- Source: `docs/content/docs/integrations/adk/programmatic-control.mdx`
...
### Migrate to V2
- Route: `/adk/troubleshooting/migrate-to-v2`
- Source: `docs/content/docs/integrations/adk/troubleshooting/migrate-to-v2.mdx`
