...
- **Open a PR up front** — the moment a new branch has one commit, push it and open a PR. Don't wait until "ready" — unmerged-and-unpushed work is invisible. See [Git & PRs](.claude/docs/git.md#open-a-pr-up-front).
