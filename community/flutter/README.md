...
> **Status: work in progress.** Components are being added incrementally.

## Components

- `CopilotChatAssistantMessage` — a chat bubble that renders an assistant
  (AI) message.
...
catalog entry point is [`widgetbook/main.dart`](widgetbook/main.dart). Run it
locally with:
