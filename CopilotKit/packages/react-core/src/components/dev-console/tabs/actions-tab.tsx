...
import { ExclamationMarkTriangleIcon } from "../icons";

export function ActionsTab({ context }: { context: DisplayContext }) {
                ...
                <div style={{ marginTop: "12px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    {action.parameters.map((param: ActionParameter, pIndex: number) => (
                      ...
                      >
                        <span
                          style={{ fontFamily: "monospace", color: "#374151", fontWeight: "500" }}
                        >
                          {param.name}
                        </span>
                        {param.type && (
