...
export const REFERENCE_DOCS: ReferenceDocConfiguration[] = [
  ...
  },
  {
    ...
    destinationPath:
      "docs-new/content/docs/reference/classes/llm-adapters/LangChainAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath:
      "docs-new/content/docs/reference/classes/llm-adapters/OpenAIAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath:
      "docs-new/content/docs/reference/classes/llm-adapters/AnthropicAdapter.mdx",
