...
export const REFERENCE_DOCS: ReferenceDocConfiguration[] = [
  /* Runtime */
  {
    ...
    destinationPath:
      "apps/docs/content/docs/reference/classes/llm-adapters/GoogleGenerativeAIAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/llm-adapters/GroqAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/llm-adapters/LangChainAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/llm-adapters/OpenAIAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/llm-adapters/OpenAIAssistantAdapter.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/llm-adapters/AnthropicAdapter.mdx",
  ...
  /* Classes */
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/CopilotTask.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/classes/CopilotRuntime.mdx",
  ...
  /* Components */
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/components/chat/CopilotChat.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/components/CopilotKit.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/components/chat/CopilotPopup.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/components/chat/CopilotSidebar.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/components/CopilotTextarea.mdx",
  ...
  /* Hooks */
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/hooks/useCopilotChat.mdx",
    hook: "useCopilotChat",
  },
  {
    sourcePath: "packages/react-core/src/hooks/use-copilot-chat-headless_c.ts",
    destinationPath: "apps/docs/content/docs/reference/hooks/useCopilotChatHeadless_c.mdx",
    hook: "useCopilotChatHeadless_c",
  },
  {
    sourcePath: "packages/react-ui/src/hooks/use-copilot-chat-suggestions.tsx",
    destinationPath: "apps/docs/content/docs/reference/hooks/useCopilotChatSuggestions.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/hooks/useCopilotReadable.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/hooks/useCoAgentStateRender.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/hooks/useCoAgent.mdx",
    hook: "useCoAgent",
    description:
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/hooks/useCopilotAdditionalInstructions.mdx",
...

  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/python/LangGraph.mdx",
    title: "LangGraph SDK",
    description:
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/python/CrewAI.mdx",
    title: "CrewAI SDK",
    description:
  ...
  /* Agents */
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/python/LangGraphAgent.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/python/CrewAIAgent.mdx",
    title: "CrewAIAgent",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/python/RemoteEndpoints.mdx",
  ...
  },
  {
    ...
    destinationPath: "apps/docs/content/docs/reference/sdk/js/LangGraph.mdx",
    title: "LangGraph SDK",
    description:
