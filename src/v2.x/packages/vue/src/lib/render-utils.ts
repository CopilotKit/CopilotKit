...
export function normalizeVueRenderer<T>(
  render: ((props: VueToolCallRendererRenderProps<T>) => VNodeChild) | Component<VueToolCallRendererRenderProps<T>>,
  ...
  return (props: VueToolCallRendererRenderProps<T>) => h(render as Component, props);
}
