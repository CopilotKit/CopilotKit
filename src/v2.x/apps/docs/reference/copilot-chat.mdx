...
| `scrollView.scrollToBottomButton` | Button that appears when scrolled up |
| `scrollView.feather` | Gradient overlay at the bottom of scroll area |
| `input` | Text input with toolbar, transcription support, and disclaimer |
| `input.disclaimer` | Footer text below the input |
