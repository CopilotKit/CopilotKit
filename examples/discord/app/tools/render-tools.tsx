 ...
 * `thread.post`. The tool NAMES, descriptions and input schemas are
 * adapter-agnostic.
 */
...
export const issueCardTool = defineBotTool({
  name: "issue_card",
  description:
    "Render ONE Linear issue as a rich embed card with a status header, " +
...
export const issueListTool = defineBotTool({
  name: "issue_list",
  description:
    "Render a list of Linear issues as an embed card — a header plus one " +
...
export const pageListTool = defineBotTool({
  name: "page_list",
  description:
    "Render a list of Notion pages as an embed card — a header plus one " +
