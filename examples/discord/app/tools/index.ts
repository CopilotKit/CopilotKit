 ...
 * universal-Discord. Universal-Discord stuff (tagging, formatting,
 * conversation model) lives in the SDK and is auto-included by
 * `defaultDiscordTools` (spread in `app/index.ts`).
 *
 * Add new tools here and re-export them through `appTools`. Wire the
 * array into `createBot({tools: [...defaultDiscordTools, ...appTools]})`
 * in `app/index.ts`.
 */
