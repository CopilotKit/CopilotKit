 ...
 *
 * Authored with the `@copilotkit/bot-ui` JSX vocabulary; the Discord embed
 * shapes are produced by `renderDiscordMessage(renderToIR(<IssueCard .../>))`.
 */
import { z } from "zod";
import {
  Context,
...
/** Render ONE Linear issue as a rich embed card. */
