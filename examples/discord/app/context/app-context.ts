 ...
 * Universal-Discord knowledge (how to tag, how markdown works, the thread
 * model) ships in `defaultDiscordContext` and is spread in `app/index.ts`;
...
export const appContext: ReadonlyArray<ContextEntry> = [
  ...
  },
  {
    ...
    value: [
      ...
      "with the user before writing. Tag the relevant people with real Discord",
