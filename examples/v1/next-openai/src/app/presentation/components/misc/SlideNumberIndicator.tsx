...
export function SlideNumberIndicator({ currentSlideIndex, totalSlides }: SlideNumberIndicatorProps) {
  return (
...
const SLIDES_ICON = (
  <svg width="10px" height="10px" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
