...
export function VacationList() {
  ...
  const [visitedDestinations, setVisitedDestinations] = useState<Destination[]>(data.visitedDestinations);
  ...
  useCopilotAction({
    ...
    handler: async ({ name, country, image, description, activities }) => {
      setVisitedDestinations((prev) => [...prev, { name, country, image, description, activities }]);
    },
  });

  useCopilotChatSuggestions({
    instructions: "Exclude already visited destinations, and New Destinations and suggest new destinations",
    maxSuggestions: 5,
  });
  ...
  visitedDestinations: [
    {
      ...
      description: 'Known as "The Big Apple", famous for its high energy, arts scene, and iconic landmarks.',
    ...
    },
    {
      ...
      description: "England's capital known for its rich history, art, culture, and famous landmarks.",
  ...
  newDestinations: [
    {
      ...
      description: 'Known as the "City of Light", famous for its museums and architectural landmarks.',
    ...
    },
    {
      ...
      description: "A bustling city known for its modern architecture, nightlife, and hearty street food.",
    ...
    },
    {
      ...
      description: "The capital of Italy known for its ancient ruins, including the Forum and the Colosseum.",
    ...
    },
    {
      ...
      description: "A city straddling Europe and Asia across the Bosphorus Strait, known for its historic sites.",
    ...
    },
    {
      ...
      description: "A city marked by its imperial palaces and musical heritage, located on the Danube River.",
    ...
    },
    {
      ...
      image: "https://cloudfront-us-east-2.images.arcpublishing.com/reuters/TECHZMXJDZIZ3MSPVCWBOGTK6Y.jpg",
      description: "A city known for its modern architecture, luxury shopping, and a lively nightlife scene.",
    ...
    },
    {
      ...
      description: "The capital city of the Czech Republic, known for its Old Town Square and historic monuments.",
    ...
    },
    {
      name: "Kyoto",
      country: "Japan",
      image: "https://e5rxtr4t5ah.exactdn.com/wp-content/uploads/2018/05/kyoto-4-day-itinerary-header.jpg",
      description:
    ...
    },
    {
      name: "Buenos Aires",
      country: "Argentina",
      image: "https://lp-cms-production.imgix.net/2021-09/La%20Boca%2C%20Buenos%20Aires%2C%20Argentina.jpg",
      description:
