    ...
    testCases: [
      {
        ...
        environment: "staging",
        browser: "Chrome",
        testSteps: ["Enter valid email", "Enter valid password", "Click login button", "Verify successful login"],
      },
      {
        id: "TC001-2",
        ...
        environment: "staging",
        browser: "Firefox",
        testSteps: ["Enter invalid email", "Enter invalid password", "Click login button", "Verify error message"],
      },
      {
        id: "TC001-3",
    ...
    testCases: [
      {
        ...
        testSteps: ["Test valid card number", "Test invalid card number", "Test expired card", "Test invalid CVV"],
      ...
      },
      {
        ...
        environment: "development",
        testSteps: ["Test gateway connection", "Test API responses", "Test error handling", "Test timeout scenarios"],
  ...
  },
  {
    ...
    testCases: [
      ...
      },
      {
        ...
        environment: "staging",
        browser: "Firefox",
        testSteps: ["Test winter-themed icons", "Verify snow effects", "Check image assets", "Validate asset loading"],
      },
      {
        id: "TC007-3",
        ...
        environment: "staging",
        browser: "Safari",
        testSteps: ["Test all UI components", "Verify winter styles", "Check hover effects", "Validate animations"],
  ...
  },
  {
    ...
    testCases: [
      ...
      },
      {
        ...
        environment: "staging",
        testSteps: ["Test system uptime", "Verify data persistence", "Check error recovery", "Validate backup systems"],
      },
    ],
    totalTestCases: 3,
    passedTestCases: 1,
  ...
  },
  {
    ...
    testCases: [
      ...
      },
      {
        ...
        environment: "staging",
        browser: "Firefox",
        testSteps: ["Test data fetching", "Verify real-time updates", "Check data accuracy", "Validate data refresh"],
      },
      {
        id: "TC020-3",
