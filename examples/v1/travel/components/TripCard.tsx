...
export function TripCard({ className, map }: TripCardProps) {
  ...
  return (
    <Card
      className={cn(
        "z-50 bg-white/40 backdrop-blur-md border-none shadow-2xl flex flex-col h-[calc(100vh-8rem)]",
        className,
    ...
    >
      <CardHeader
        className={cn(
          "flex flex-row justify-between items-center bg-black text-white rounded-t-lg flex-shrink-0",
