...
export function ErrorBanner({ errors }: { errors: { server: string; error: string }[] }) {
  if (errors.length === 0) return null;
  return (
    <div className="space-y-1.5">
      {errors.map((e) => (
        <div key={e.server} className="rounded-xl border border-red-200 bg-red-50/70 p-2.5 text-xs text-red-800">
