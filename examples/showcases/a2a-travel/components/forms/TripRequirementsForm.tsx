  ...
  return (
    <div className="bg-[#BEC2FF]/30 backdrop-blur-md border-2 border-[#BEC2FF] rounded-lg p-4 my-3 shadow-elevation-md">
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-xs font-medium text-[#010507] mb-1.5">Destination City *</label>
          <input
            type="text"
            value={city}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-[#010507] mb-1.5">Days (1-7) *</label>
            ...
            {errors.numberOfDays && <p className="text-xs text-[#FFAC4D] mt-1">{errors.numberOfDays}</p>}
          </div>

          <div>
            <label className="block text-xs font-medium text-[#010507] mb-1.5">People (1-15) *</label>
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm border-2 border-[#DBDBE5] rounded-lg px-3 py-2.5">
              <div className="flex-1 px-1">
                <input
                  type="range"
            ...
            {errors.numberOfPeople && <p className="text-xs text-[#FFAC4D] mt-1">{errors.numberOfPeople}</p>}
          </div>
        </div>
