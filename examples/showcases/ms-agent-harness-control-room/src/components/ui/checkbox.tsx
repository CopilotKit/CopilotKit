  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current transition-none [&>svg]:size-3.5 [&>svg]:stroke-current"
      >
        <CheckIcon />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
