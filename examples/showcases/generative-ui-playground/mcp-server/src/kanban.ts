      ...
      cards: [
        {
          ...
          description: "Create ERD for user data",
          priority: "high",
          tags: ["database"],
          createdAt: now(),
        },
      ...
      cards: [
        {
          ...
          description: "Apply REST best practices",
          priority: "low",
          tags: ["refactor"],
          createdAt: now(),
        },
      ...
      cards: [
        {
          id: generateId("card"),
          title: "Project setup",
          description: "Init Next.js + TypeScript",
          priority: "high",
          tags: ["setup"],
          createdAt: now(),
        },
  ...
  marketing: () => [
      ...
      cards: [
        {
          ...
          description: "Reach out to tech influencers",
          priority: "medium",
          tags: ["social"],
          createdAt: now(),
        },
        {
          ...
          description: "Compile video testimonials",
          priority: "low",
          tags: ["content"],
          createdAt: now(),
        },
      ...
      cards: [
        {
          ...
          description: "Define goals and budget",
          priority: "high",
          tags: ["strategy"],
          dueDate: "2026-04-01",
          createdAt: now(),
    ...
    },
    {
      ...
      cards: [
        {
          id: generateId("card"),
          title: "Blog: Industry trends",
          description: "Write 2000 word article",
          priority: "medium",
          tags: ["blog"],
          dueDate: "2026-01-20",
          createdAt: now(),
      ...
      cards: [
        {
          ...
          description: "Plan January posts",
          priority: "high",
          tags: ["social"],
          createdAt: now(),
        },
      ...
      cards: [
        {
          ...
          description: "Vegetables, milk, bread",
          priority: "medium",
          tags: ["errands"],
          createdAt: now(),
        },
        ...
        },
        {
          ...
          description: "Finish remaining chapters",
          priority: "low",
          tags: ["reading"],
          createdAt: now(),
        },
      ...
      cards: [
        {
          id: generateId("card"),
          title: "Learn Spanish",
          description: "Duolingo lesson 15",
          priority: "medium",
          tags: ["learning"],
          createdAt: now(),
        },
...
export function addCard(
  ...
  return {
    success: true,
    message: `Added "${card.title}" to ${column.name}`,
    board,
    card: newCard,
  };
}
...
export function updateCard(
  ...
  for (const column of board.columns) {
    ...
    if (idx !== -1) {
      ...
      return {
        success: true,
        message: `Updated "${column.cards[idx].title}"`,
        board,
...
export function moveCard(
  ...
  return {
    success: true,
    message: `Moved "${card.title}" to ${targetColumn.name}`,
    board,
    card,
  };
}
