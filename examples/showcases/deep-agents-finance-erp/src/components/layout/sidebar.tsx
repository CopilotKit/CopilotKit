...
import { LayoutDashboard, LayoutGrid, FileText, Landmark, Package, Users, Settings, Bot } from "lucide-react";
        ...
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && <span className="absolute -left-[18px] h-5 w-1 rounded-r-full bg-primary" />}
            </Link>
          );
        })}
      </nav>
