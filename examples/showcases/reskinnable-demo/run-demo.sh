#!/usr/bin/env bash
# ============================================================================
# run-demo.sh — one-command cold start for the reskinnable demo (self-hosted mode).
#
#   cd examples/showcases/reskinnable-demo && ./run-demo.sh
#
# The memory stack this brings up backs the banking skin (routes under /banking;
...
cd "$DEMO_DIR"
LOG_DIR="${TMPDIR:-/tmp}/reskinnable-demo"; mkdir -p "$LOG_DIR"
