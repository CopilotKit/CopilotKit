 ...
 * | 4 memory          | same pill, Maya vs Guest, two different answers   | Something for me    | recommendBooks note slot + intelligence/seed-memories.ts |
 ...
 *  · Beat 4's contrast needs the shopper switcher in the sidebar. Switching
 *    changes `properties` but does NOT start a new thread, so start a new
 *    conversation from the chat header after switching or the old context muddies
 *    the answer.
