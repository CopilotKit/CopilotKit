...
import { z } from "zod";
import type { NewCardRequest } from "@/skins/banking/data/data";
import { CARD_COLORS, CardBrand } from "@/skins/banking/data/data";
import { CreditCardDetails } from "@/skins/banking/components/credit-card-details";
import { CardPicker } from "@/skins/banking/components/card-picker";
import type { PartialBy } from "@/skins/banking/data/type-helpers";
import {
...
import { AddCardDropdown } from "@/skins/banking/components/add-card-dropdown";
import { TransactionsList } from "@/skins/banking/components/transactions-list";
import { ChangePinDialog } from "@/skins/banking/components/change-pin-dialog";
import { useSearchParams } from "next/navigation";
import { CardsPageOperations } from "@/skins/banking/tools";
...
import { useReportToCopilot } from "@/skins/banking/components/wow/use-ask-copilot";
...
export default function Page() {
  ...
  // NOTE: addNoteToTransaction moved to the banking Tools component
  // (skins/banking/tools.tsx) — see the note on the other action tools. It is
  // the closing step of the saved suspicious-charge procedure, so it must exist
  // on every route.
  ...
  // NOTE: `setCardPin` used to live here. It now lives in the banking Tools
  // component (skins/banking/tools.tsx) so it is registered GLOBALLY (this
  // page-scoped registration meant the suggestion pill only worked on the cards
  // route) and so the PIN is typed into an interactive card in the chat rather
  // than dictated to the agent.

  // NOTE: sendSpendAlert / requestCardReplacement / flagForReview moved to the
  // banking Tools component (skins/banking/tools.tsx) so they exist on EVERY route. Registered here they only
