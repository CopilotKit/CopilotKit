...
import { GradientCreditCard } from "@/skins/banking/components/card-visual";
...
export default function HomePage() {
  ...
  // the banking Tools component (skins/banking/tools.tsx); this adds the
  // *visible* view + derived KPIs.
  useAgentContext({
    description:
