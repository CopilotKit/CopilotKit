...
import type { MemberDialogProps } from "@/skins/banking/components/add-or-edit-member-dialog";
import { defaultDialogState } from "@/skins/banking/components/add-or-edit-member-dialog";
...
export function RemoveMemberConfirmationDialog({
  ...
  return (
    <Dialog
      open={dialogState.dialogOpen && dialogState.action === "remove"}
      onOpenChange={(open) =>
