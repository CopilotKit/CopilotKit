...
export default function Page() {
  ...
  useCopilotAction({
    ...
    parameters: [
      {
        ...
        type: "string",
        description:
          "The query for query result. MUST BE A VALID SQL QUERY. The full query (all lines) should be sent in one go",
        required: true,
      },
    ],
    followUp: false,
    render: ({ args }) => {
      ...
      return <CodeSnippet code={query!} language="SQL" onExecute={onExecute} />;
    },
  });
