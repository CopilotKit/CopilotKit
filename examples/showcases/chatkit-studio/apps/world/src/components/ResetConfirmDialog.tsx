...
export default function ResetConfirmDialog({ isOpen, onCancel, onConfirm }: ResetConfirmDialogProps) {
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-3xl shadow-xl max-w-sm w-full mx-4 p-6">
        ...
        <div className="mt-8 mb-6 text-center">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Reset Progress?</h3>
