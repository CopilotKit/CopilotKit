...
const SYSTEM_PROMPT = [
  ...
  "exactly one tool.",
  "",
  "Small talk and trivial input: if the latest message is a greeting, a bare",
  '"test", a thanks, or anything that does not ask for or imply structured',
  "output, reply with one short sentence and call NO tool. Never invent content",
  "(a chart, diagram, or card) just to exercise a tool — render only what the",
  "user actually asked for, or the data they gave you.",
  "",
