...
function Haiku() {
  ...
  useFrontendTool({
    name: "generate_haiku",
    description: "Generate a haiku with Japanese and English text and images",
    parameters: z.object({
      japanese: z.array(z.string()).describe("Japanese text lines"),
      english: z.array(z.string()).describe("English text lines"),
