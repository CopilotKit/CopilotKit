            ...
            return (
              <div key={m.id ?? `metric-${i}`} className="flex items-center gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdateData((prev) =>
                      chartSetField1Value(prev as ChartData, i, e.target.value === "" ? "" : Number(e.target.value)),
                    )
                  }
                  placeholder="0"
                />
            ...
            {(d.field4 ?? []).map((c, i) => (
              <div key={c.id} className="flex items-center gap-3">
                ...
                <input
                  ...
                  checked={!!c.done}
                  onChange={(e) =>
                    onUpdateData((prev) => projectSetField4ItemDone(prev as ProjectData, c.id, e.target.checked))
                  }
                  className="h-4 w-4"
                />
                <input
                  ...
                  onChange={(e) =>
                    onUpdateData((prev) => projectSetField4ItemText(prev as ProjectData, c.id, e.target.value))
                  }
