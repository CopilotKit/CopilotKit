...
import { createA2UICatalog, type A2UIComponentMap } from "@copilotkit/a2ui-renderer";

// ─── Component Definitions ──────────────────────────────────────────────

export const components: A2UIComponentMap = {
  Title: {
    props: z.object({
      text: z.string(),
...
// ─── Create Catalog (no basic catalog — app-level only) ─────────────────

export const appCatalog = createA2UICatalog(components, {
