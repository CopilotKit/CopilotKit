  ...
  useConfigureSuggestions({
    suggestions: [
      ...
      },
      {
        ...
        message:
          "Please create a simple network diagram of a router and two switches using Excalidraw.",
      },
      {
      ...
      },
      {
        ...
        message:
          "Please enable app mode and then add some todos about learning about CopilotKit.",
      },
      {
        title: "A2UI ( Declarative UI )",
        message: "Please generate a simple form.",
      },
    ],
