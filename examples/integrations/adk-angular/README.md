...
- Node.js 22.22.3+ on the 22.x line, 24.15.0+ on the 24.x line, or 26+ (required by Angular 22)
- Python 3.12+
...
>
> - The Node.js versions in the prerequisites also support managed Intelligence.
