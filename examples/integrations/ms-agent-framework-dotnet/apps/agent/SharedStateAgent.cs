...
[SuppressMessage("Performance", "CA1812:Avoid uninstantiated internal classes", Justification = "Instantiated by DemoAgentFactory")]
internal sealed class SharedStateAgent : DelegatingAIAgent
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        firstRunOptions.ChatOptions.ResponseFormat = ChatResponseFormat.ForJsonSchema<TodosStateSnapshot>(
            schemaName: "TodosStateSnapshot",
            schemaDescription: "A response containing the current list of todos");
