...
const SYSTEM_PROMPT = [
  ...
  "no rich cards, tables, charts, diagrams, or threads — only text, interactive",
  ...
  "reply (there is no card/table tool on WhatsApp). Never invent a table or a",
  "chart — those surfaces don't exist here.",
  "",
