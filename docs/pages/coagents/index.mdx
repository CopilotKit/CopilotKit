...
<div className="flex gap-2 w-full my-2">
  <div className="flex-1 border bg-white rounded-lg shadow-md p-4">
    ...
    <div className="italic py-4">
      <img src="/images/coagents/text-feedback.png" className="rounded-md border" />
    </div>
  </div>
  <div className="flex-1 border bg-white rounded-lg shadow-md p-4">
    <div className="flex items-center justify-center gap-2 font-semibold">
    ...
    <div className="italic py-4">
      <img src="/images/coagents/json-feedback.png" className="rounded-md border" />
    </div>
  </div>
</div>
