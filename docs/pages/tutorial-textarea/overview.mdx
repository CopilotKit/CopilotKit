...
<Link href="https://github.com/CopilotKit/example-textarea?ref=docs-tutorial" target="_blank">
...
<div className="flex flex-col shadow-lg rounded-lg my-4">
  ...
  <iframe
    ...
    src="https://example-textarea.vercel.app?publicApiKey=ck_pub_68042cff5088605d9c8ee8ead7b09c69"
    width="100%"
