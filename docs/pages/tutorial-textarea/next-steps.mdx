...
- Add a chat element to your Copilot using the [`<CopilotPopup />`](/reference/components/CopilotPopup) component.
- Add actions to your Copilot using the [`useCopilotAction`](/reference/hooks/useCopilotAction) hook.
- Follow the [Todos App Copilot tutorial](/tutorial-ai-todo-list-copilot/overview) to learn more about CopilotKit.
