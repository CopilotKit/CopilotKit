...
- Add suggestions to your Copilot, using the [`useCopilotChatSuggestions`](/reference/hooks/useCopilotChat-suggestions) hook.
- Add an initial assistatnt message to your chat window (for more info, check the documentation for [`<CopilotPopup />`](/reference/components/CopilotPopup)).
...
- Follow the [Textarea Autocomplete tutorial](/tutorial-textarea/overview) to learn more about CopilotKit.
