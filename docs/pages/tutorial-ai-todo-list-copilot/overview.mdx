import { CopilotCloudBanner } from "../../components/copilot-cloud-banner";
...
{/* <iframe
  ...
  width="660"
  height="370"
  src="https://www.youtube.com/embed/Y2H3DXDeS3Q?si=lfjs8PRrzoZN_PiT"
...
<Link href="https://github.com/CopilotKit/example-todos-app?ref=docs-tutorial" target="_blank">
...
<div className="flex flex-col shadow-lg rounded-lg my-4">
  ...
  <iframe
    ...
    src="https://example-todos-app-final-git-final-copilot-kit.vercel.app/"
    width="100%"
    height="700"
    referrerPolicy="strict-origin-when-cross-origin"
