...
To connect a FastAPI server to Copilot Platform, we leverage a concept called "Remote Endpoints"
which allow CopilotKit runtime to connect to various backends.

To get started, <LinkToCopilotCloud asButton={false}>navigate to Copilot Platform</LinkToCopilotCloud>. 
