    ...
    >
      ...
      <Step>
        ...
        **Verify locally first:**
        ...
        Navigate to `localhost:3000` and confirm the chat connects to your AgentCore agent.

        **Then deploy your frontend** to [AWS Amplify](https://docs.amplify.aws/nextjs/start/quickstart/). Point `runtimeUrl` to your deployed API route URL.

        <Callout type="info" title="Deployment and tear down">
          Since you're bringing your own agent and infrastructure, deployment and tear down depend on your setup. The CopilotKit Runtime Lambda can be deployed as part of your existing CDK or Terraform stack — it's a standard Node.js Lambda behind API Gateway.
        </Callout>
      </Step>
    </TailoredContentOption>
  </TailoredContent>
