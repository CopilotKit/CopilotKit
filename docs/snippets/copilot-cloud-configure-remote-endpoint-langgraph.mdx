...
<Accordion title="Using LangGraph Studio">
    ...
    ```bash
    npx @copilotkit/cli tunnel <port_number> # [!code highlight]
    ✔ Tunnel created successfully!

    Tunnel Information:
    Local: localhost:<port_number>
    Public URL: https://light-pandas-argue.loca.lt # this will be your deployment URL! # [!code highlight]
