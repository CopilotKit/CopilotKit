...
<Tabs items={[
  ...
  <Tabs.Tab>
    ...
    Your Copilot Runtime handler should be available at `http://localhost:{port}/api/copilotkit`.
  </Tabs.Tab>
  <Tabs.Tab>
    Create a new route to handle the `/api/copilotkit` endpoint:
  ...
  <Tabs.Tab>
    ...
    Your Copilot Runtime handler should be available at `http://localhost:4000/copilotkit`.
  </Tabs.Tab>
  <Tabs.Tab>
  ...
  Your Copilot Runtime handler should be available at `http://localhost:{port}/copilotkit`.
  </Tabs.Tab>
</Tabs>
