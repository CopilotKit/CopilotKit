...
<<<<<<< HEAD:docs/snippets/shared-guides/troubleshooting/error-handling.mdx
- **High-volume logging:**
...
>>>>>>> e3041f4db (wip):docs/snippets/shared/troubleshooting/error-debugging-observability.mdx
