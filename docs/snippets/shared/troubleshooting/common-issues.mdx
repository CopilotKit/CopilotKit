...
<Accordions>
    ...
    <Accordion title="Test your endpoint">
        ...
        * Connection #0 to host localhost left intact
        {"version":"0.1.32","agents":{"my_agent":{"name":"my_agent","description":"A helpful agent.","className":"LangGraphAGUIAgent"}},"audioFileTranscriptionEnabled":false,"mode":"sse","a2uiEnabled":false}%
        ```
