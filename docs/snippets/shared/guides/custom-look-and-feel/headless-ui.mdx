...
>
  Fully headless UI is starting as a premium-only feature. As it matures, it will become available to all CopilotKit users for free.

  - Get started with your public license key from [Copilot Cloud](https://cloud.copilotkit.ai) 
  - Or read more about [premium features](/premium).
</Callout>
