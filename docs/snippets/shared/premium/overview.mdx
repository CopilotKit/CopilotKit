...
- A commercial license for premium extensions to the open source CopilotKit framework.
- Access to the CopilotKit Cloud hosted service. 
...
A public API key is a key that you can use to access Copilot Cloud features. Public license keys are used to access premium features
