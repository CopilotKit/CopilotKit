...
<Step>
  ### Set up your CopilotKit provider You will need to provide your public
  license key to the `CopilotKit` provider component. Get yours on [Copilot
  Cloud](https://cloud.copilotkit.ai) or read more about [premium
  features](/premium). ```tsx title="src/app/layout.tsx"
