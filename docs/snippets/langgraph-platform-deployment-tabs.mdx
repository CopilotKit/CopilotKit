...
<Tabs groupId="lg-deployment-type" items={['LangGraph Platform (Local / Dev)', 'FastAPI (Self-Hosted)', 'LangGraph Platform (Cloud / Self-Hosted)']}>
  ...
  <Tab value="LangGraph Platform (Cloud / Self-Hosted)">
    For production, you can deploy to LangGraph Platform (Cloud / Self-Hosted) by following the official [LangGraph Platform deployment guide](https://langchain-ai.github.io/langgraph/cloud/deployment/cloud/).
