<Tabs groupId="lg-deployment-type" items={['Local Development', 'Self hosted (CLI)', 'Self hosted (FastAPI)', 'LangGraph Platform (cloud)']}>
  ...
  <Tab value="Self hosted (CLI)">
    LangGraph has a variety of deployment options for self hosted graphs. Take a look at their [deployment guide](https://langchain-ai.github.io/langgraph/concepts/deployment_options)
    for more information.

    Come back here with a deployment URL before proceeding.
  </Tab>
