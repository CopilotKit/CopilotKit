...
description: "Learn how open-source anonymous telemetry works in CopilotKit."
---
...
<AccordionGroup>
  <Accordion title="GDPR Compliance">
    ### Data Controller
    The data controller is CopilotKit (Tawkit Inc.).

    ### Data Processor
    The data processor is PostHog (https://posthog.com) and all data is stored in the EU.
  </Accordion>
</AccordionGroup>
