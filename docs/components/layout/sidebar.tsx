...
const Sidebar = () => {
  return (
    <aside
      id="nd-sidebar"
      className="ml-2 mt-16 lg:mt-20 w-full max-w-[260px] h-[calc(100vh-64px-8px)] lg:h-[calc(100vh-80px-8px)] fixed top-0 left-0 border border-r-0 border-white/10 bg-white/5 rounded-l-2xl py-6 px-3"
    >
