...
const Sidebar = () => {
  return (
    <aside
      id="nd-sidebar"
      className="ml-2 w-full max-w-[260px] h-[calc(100vh-64px-8px)] lg:h-[calc(100vh-80px-8px)] border backdrop-blur-lg border-r-0 border-border bg-glass-background rounded-l-2xl py-6 px-3"
    >
