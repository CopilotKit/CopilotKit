  ...
  const bannerContent = [
    {
      ...
      mobileText: "A2UI Launch: Zero day Google partnership!",
      desktopText: "A2UI Launch: CopilotKit has partnered with Google to deliver zero day support in both CopilotKit and AG-UI.",
