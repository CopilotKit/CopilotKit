export function IntegrationsSelectorLightMobile({ className }: { className?: string }) {
  return (
    <svg className={className} width='116' height='342' viewBox='0 0 116 342' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <path
        d='M58.6001 89.6826L58.6001 317.683C58.6001 330.385 68.8976 340.683 81.6001 340.683'
      ...
      <defs>
        ...
        <linearGradient
          ...
          y2='102.972'
          gradientUnits='userSpaceOnUse'>
          <stop stop-color='#BEC2FF' stop-opacity='0.6' />
          <stop offset='0.178093' stop-color='#BEC2FF' />
        ...
        <linearGradient
          ...
          y2='279.992'
          gradientUnits='userSpaceOnUse'>
          <stop stop-color='#BEC2FF' stop-opacity='0.2' />
          <stop offset='0.423077' stop-color='#BEC2FF' />
          <stop offset='1' stop-color='#BEC2FF' stop-opacity='0.3' />
        </linearGradient>
        <linearGradient
