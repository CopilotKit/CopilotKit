export function IntegrationsSelectorLightMobile({ className, rows = 7, rowHeight = 60 }: { className?: string; rows?: number; rowHeight?: number }) {
  ...
  return (
    <svg
      ...
      <rect x='25.5996' y='25.6826' width='64' height='64' rx='32' fill='white' />
      <path
