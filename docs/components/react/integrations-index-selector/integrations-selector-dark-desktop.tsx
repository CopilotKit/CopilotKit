export function IntegrationsSelectorDarkDesktop({ className }: { className?: string }) {
  return (
    <svg className={className} width='202' height='144' viewBox='0 0 202 144' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <rect x='32' y='32.1035' width='80' height='80' rx='40' fill='white' fillOpacity='0.05' />
      <path
        ...
        fill='url(#paint0_linear_6481_46066)'
      />
      <path
        ...
        fill='url(#paint1_linear_6481_46066)'
      />
      <path
        ...
        fill='url(#paint2_linear_6481_46066)'
      />
      ...
      <path
        ...
        fill='url(#paint3_linear_6481_46066)'
      />
      <path
        opacity='0.5'
        d='M16.5 72C16.5 41.3482 41.3482 16.5 72 16.5C102.652 16.5 127.5 41.3482 127.5 72C127.5 102.652 102.652 127.5 72 127.5C41.3482 127.5 16.5 102.652 16.5 72Z'
        stroke='url(#paint4_radial_6481_46066)'
      />
      <circle opacity='0.3' cx='72' cy='72' r='71.5' stroke='url(#paint5_radial_6481_46066)' />
      <path d='M119 72H202' stroke='url(#paint6_linear_6481_46066)' strokeWidth='2' />
      <path
        d='M119 71.5L127.436 71.5C141.87 71.5 155.058 63.3217 161.475 50.3916L175.999 21.1238C180.9 11.247 190.974 4.99995 202 4.99995'
        stroke='url(#paint7_linear_6481_46066)'
        strokeWidth='2'
      />
      <path
        d='M119 71.9998H140.296C158.207 71.9998 173.687 84.5072 177.449 102.019L182.035 123.368C184.056 132.778 192.375 139.5 202 139.5'
        stroke='url(#paint8_linear_6481_46066)'
        strokeWidth='2'
      />
      <defs>
        <linearGradient
          id='paint0_linear_6481_46066'
          x1='75.6344'
          y1='54.7899'
          x2='69.6618'
          y2='71.2135'
        ...
        <linearGradient
          ...
          <stop offset='0.397198' stopColor='#7076D5' />
          <stop offset='1' stopColor='#7076D5' />
        </linearGradient>
        <linearGradient
          id='paint7_linear_6481_46066'
          x1='120.5'
          y1='73.1037'
          x2='202'
          y2='5.10375'
          gradientUnits='userSpaceOnUse'>
          <stop offset='0.0910802' stopColor='#7076D5' stopOpacity='0' />
          <stop offset='0.550682' stopColor='#7076D5' />
          <stop offset='1' stopColor='#7076D5' stopOpacity='0' />
        </linearGradient>
        <linearGradient
          id='paint8_linear_6481_46066'
          x1='121'
          y1='72.1034'
          x2='202'
          y2='139.103'
          gradientUnits='userSpaceOnUse'>
          <stop stopColor='#7076D5' stopOpacity='0' />
          <stop offset='0.457132' stopColor='#7076D5' />
          <stop offset='1' stopColor='#7076D5' stopOpacity='0' />
        </linearGradient>
      </defs>
    </svg>
