export function KiteIconLight({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id='kite-light-paint0' x1='75.6343' y1='54.7899' x2='69.6618' y2='71.2135' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#6430AB' />
          <stop offset='1' stopColor='#AA89D8' />
        </linearGradient>
        <linearGradient id='kite-light-paint1' x1='71.0059' y1='64.0467' x2='63.3177' y2='78.9026' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#005DBB' />
          <stop offset='1' stopColor='#3D92E8' />
        </linearGradient>
        <linearGradient id='kite-light-paint2' x1='74.4388' y1='54.7898' x2='72.1238' y2='62.0312' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#1B70C4' />
          <stop offset='1' stopColor='#54A4F2' />
        </linearGradient>
        <linearGradient id='kite-light-paint3' x1='57.1845' y1='87.9918' x2='81.6104' y2='87.9918' gradientUnits='userSpaceOnUse'>
        ...
        <radialGradient id='kite-light-paint4' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(50 140) rotate(-45.8275) scale(111.974 93.3487)'>
          <stop stopColor='#BEC2FF' />
          <stop offset='1' stopColor='#BEC2FF' stopOpacity='0.3' />
        </radialGradient>
        <radialGradient id='kite-light-paint5' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(20 35) rotate(31.8516) scale(141.946 118.336)'>
          <stop stopColor='#BEC2FF' />
          <stop offset='1' stopColor='#BEC2FF' stopOpacity='0.3' />
        </radialGradient>
      </defs>
...
export function KiteIconDark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id='kite-dark-paint0' x1='75.6343' y1='54.7899' x2='69.6618' y2='71.2135' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#6430AB' />
          <stop offset='1' stopColor='#AA89D8' />
        </linearGradient>
        <linearGradient id='kite-dark-paint1' x1='71.0059' y1='64.0467' x2='63.3177' y2='78.9026' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#005DBB' />
          <stop offset='1' stopColor='#3D92E8' />
        </linearGradient>
        <linearGradient id='kite-dark-paint2' x1='74.4388' y1='54.7898' x2='72.1238' y2='62.0312' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#1B70C4' />
          <stop offset='1' stopColor='#54A4F2' />
        </linearGradient>
        <linearGradient id='kite-dark-paint3' x1='57.1845' y1='87.9918' x2='81.6104' y2='87.9918' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#4497EA' />
          <stop offset='0.254755' stopColor='#1463B2' />
          <stop offset='0.498725' stopColor='#0A437D' />
          <stop offset='0.666667' stopColor='#2476C8' />
        ...
        <radialGradient id='kite-dark-paint4' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(50 140) rotate(-45.8275) scale(111.974 93.3487)'>
          <stop stopColor='#7076D5' />
          <stop offset='1' stopColor='#7076D5' stopOpacity='0.3' />
        </radialGradient>
        <radialGradient id='kite-dark-paint5' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(20 35) rotate(31.8516) scale(141.946 118.336)'>
          <stop stopColor='#7076D5' />
          <stop offset='1' stopColor='#7076D5' stopOpacity='0.3' />
        </radialGradient>
      </defs>
