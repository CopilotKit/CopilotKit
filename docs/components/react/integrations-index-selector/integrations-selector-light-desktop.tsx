export function IntegrationsSelectorLightDesktop({ className }: { className?: string }) {
  return (
    <svg className={className} width='202' height='144' viewBox='0 0 202 144' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <rect x='32' y='32.1035' width='80' height='80' rx='40' fill='white' />
      <path
        ...
        fill='url(#paint0_linear_6481_42424)'
      />
      <path
        ...
        fill='url(#paint1_linear_6481_42424)'
      />
      <path
      ...
      <path
        ...
        fill='url(#paint3_linear_6481_42424)'
      />
      <path
        opacity='0.5'
