    ...
    <Link href={href} className='w-full no-underline h-9 md:h-[60px] hover:opacity-100'>
      <div
        ...
        <div className='flex gap-2 justify-start items-center w-full'>
          <div
            className={`w-9 md:w-[52px] h-9 md:h-[52px] flex flex-shrink-0 items-center justify-center bg-[#0105070D] dark:bg-white/5 rounded-full group-hover:bg-[#BEC2FF] dark:group-hover:bg-[#7076D5] transition-all duration-200`}>
