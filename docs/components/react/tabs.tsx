        ...
        <TabsPrimitive.List className="px-4 py-2.5 flex">
          {normalizedItems.map((item) => (
            <TabsPrimitive.Trigger
              key={item.value}
              value={item.value}
              className="relative px-4 mr-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 
                whitespace-nowrap flex gap-2 items-center
                bg-indigo-200/30
                dark:bg-indigo-900/30
                data-[state=active]:bg-indigo-200/80 dark:data-[state=active]:bg-indigo-800/50
                data-[state=active]:text-primary border border-transparent
