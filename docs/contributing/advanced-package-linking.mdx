...
<Steps>
  <Step title="In the CopilotKit Monorepo">
    Assuming you followed all steps in the [How To Contribute](/contributing/how-to-contribute) guide, you should have everything set up properly and ready to go.
