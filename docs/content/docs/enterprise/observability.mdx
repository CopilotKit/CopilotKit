...
description: "Monitor your CopilotKit application with comprehensive observability hooks. Track user interactions, chat events, and system errors."
...
Track user interactions and chat behavior with comprehensive observability hooks (requires `publicApiKey`):
...
- Explore the [CopilotModal reference](/reference/components/chat/CopilotModal) for observability hooks
