...
description: Agentic copilots provide you with advanced control and orchestration over your LlamaIndex agents.
icon: lucide/Bot
---
...
import { AG2Icon, LlamaIndexIcon } from "@/lib/icons/custom-icons";


Before we dive into what agentic copilots are, help us help you by telling us your level of experience with LlamaIndex. We'll explain things in a way that best suits your experience level.

<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption 
        id="new"
        title="I'm new to LlamaIndex" 
        description="Help me understand what agentic copilots are, where LlamaIndex fits in, and how to get started." 
    ...
    >
        ...
        frameworks like LlamaIndex become essential.

        ### What is LlamaIndex?
        LlamaIndex is a framework that gives you precise control over AI agents. LlamaIndex agents allow developers to combine and coordinate coding tasks efficiently,
        providing a robust framework for building sophisticated AI automations.

        ### What are Agentic Copilots?
        Agentic copilots are how CopilotKit brings LlamaIndex agents into your application. If you're familiar with CopilotKit, you know that copilots are AI assistants that
        ...
        for quick implementation, Agentic copilots give you LlamaIndex's full orchestration capabilities when you need more control over your agent's behavior.
        ...
        You should use CoAgents when you require tight control over the Agentic runloop, as facilitated by an Agentic Orchestration framework like [LlamaIndex](https://llamaindex.ai/).
        ...
        up to 100% of the Copilot's tasks (see [agent-lock mode](/llamaindex/multi-agent-flows) for the 100% case).
        ...
        <Cards>
            <Card
                ...
                href="/llamaindex/quickstart/llamaindex"
                icon={<RocketIcon />}
            />
            <Card
                ...
                href="/llamaindex/concepts/terminology"
    ...
    <TailoredContentOption
        id="intermediate"
        title="I'm already using LlamaIndex"
        description="Help me understand what agentic copilots are, what Copilotkit does to integrate with LlamaIndex, and how to get started."
        icon={<LlamaIndexIcon />}
    >

        LlamaIndex is a framework for building deeply customizable AI agents.
        ...
        Any LlamaIndex-based agent can be transformed into an Agentic Copilot with a minimal amount
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your LlamaIndex agent with CopilotKit in a few minutes."
                href="/llamaindex/quickstart/llamaindex"
                icon={<RocketIcon />}
            />
            <Card
