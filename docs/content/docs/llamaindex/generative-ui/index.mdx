...
---
import { ServerIcon, SquareMousePointerIcon } from "lucide-react";
...
To get started, you first need to decide what is going to be backing your generative UI. There are two main variants of Generative UI with CopilotKit for LlamaIndex.
