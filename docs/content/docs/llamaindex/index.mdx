...
<div className="p-4 mb-6 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
  <div className="flex items-center gap-2 mb-2">
    ...
    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300">LlamaIndex Overview</h3>
  </div>
  <p className="text-gray-700 dark:text-gray-300">
    Visit the <a href="https://v0-llamaindex-land.vercel.app/" target="_blank" rel="noopener noreferrer" className="font-medium underline underline-offset-4 decoration-gray-400 dark:decoration-gray-500 hover:text-gray-900 dark:hover:text-gray-100">LlamaIndex Overview Page</a> to learn more about LlamaIndex's capabilities and features.
  </p>
</div>
...
<Cards className="gap-6">
  ...
  <Card
    ...
    description="Try the key features of CoAgents powered by LlamaIndex Agents."
    href="https://copilotkit-llamaindex-feature-viewer.vercel.app/"
    target="_blank"
  />
</Cards>
