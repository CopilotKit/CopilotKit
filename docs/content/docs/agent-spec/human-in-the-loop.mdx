...
<IframeSwitcher
  ...
  exampleUrl={({ integration }) => `https://feature-viewer.copilotkit.ai/agent-spec-${integration}/feature/human_in_the_loop?sidebar=false&chatDefaultOpen=false`}
  codeUrl={({ integration }) => `https://feature-viewer.copilotkit.ai/agent-spec-${integration}/feature/human_in_the_loop?view=code&sidebar=false&codeLayout=tabs`}
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
