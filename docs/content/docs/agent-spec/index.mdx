...
<FrameworkOverview
  ...
  featuresLink="https://feature-viewer.copilotkit.ai/agent-spec/feature/agentic_chat"
  supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.copilotkit.ai/agent-spec/feature/tool_based_generative_ui",
