...
If you prefer a generated starter instead of cloning the repo, use the CopilotKit bootstrap template and select **AG2** during setup. This wires up an AG2 `/chat` backend over AG-UI and a ready-to-run frontend.
...
<Steps>
    ...
    <Step>
        ...
        <Callout type="info">
            Prefer a <code>.env</code> file? Install <code>python-dotenv</code> and load it at the top of <code>simple_workflow.py</code>:
            <br />
            <br />
