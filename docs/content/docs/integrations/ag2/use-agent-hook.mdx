...
The `useAgent` hook provides direct access to your AG2 agent from any React component. It gives you real-time access to the agent's state, messages, execution status, and allows you to subscribe to custom events.
...
This page covers everything you need to know about using `useAgent` with AG2. Select where you'd like to get started below.
