...
<Steps>
    ...
    <Step>
        ...
        <Callout type="info" title="Using Next.js is optional">
            If you'd rather skip the Next.js API proxy and connect your frontend directly to the agent,
            expose a CopilotKit-compatible HTTP endpoint from your LangGraph deployment instead.
            See the [Vite + Direct Connection](#alternative-vite--direct-connection) alternative below,
            or the [LangChain CopilotKit guide](https://docs.langchain.com/oss/python/langchain/frontend/integrations/copilotkit)
