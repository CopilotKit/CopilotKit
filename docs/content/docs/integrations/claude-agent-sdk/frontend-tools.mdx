...
icon: "lucide/Wrench"
description: Create frontend tools and use them within your Claude Agent SDK agent.
---
...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk-typescript/feature/agentic_chat?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk-typescript/feature/agentic_chat?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
This can be utilized for to let [your agent control the UI](/claude-agent-sdk/frontend-tools), [generative UI](/claude-agent-sdk/frontend-tools), or for Human-in-the-loop interactions.
