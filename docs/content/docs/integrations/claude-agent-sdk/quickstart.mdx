        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate CopilotKit into your existing Claude Agent SDK agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx copilotkit@latest create -f claude-agent-sdk
                ```
            </Step>
            <Step>
            ...
            <Step>
                ...
                Create a `.env` file in your agent directory and add your Anthropic API key:

                ```plaintext title="agent/.env"
                ANTHROPIC_API_KEY=your_anthropic_api_key
                ```

                <Callout type="info" title="Claude models">
                  The starter template uses Claude by default. The Claude Agent SDK supports all Claude model variants.
                </Callout>
            </Step>
            <Step>
        ...
        >
            <Step>
                ...
                If you don't already have a Node.js project set up, create one:
            ...
            <Step>
                ...
                Add the Claude Agent SDK AG-UI adapter and dependencies to your project:
                    ...
                    <Tab value="TypeScript">
                        ...
                        const server = http.createServer(async (req, res) => {
                          if (req.method === "POST") {
                            ...
                            const input: RunAgentInput = JSON.parse(body);
