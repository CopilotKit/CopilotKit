...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk/feature/shared_state?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk/feature/shared_state?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Callout type="info">
  This example demonstrates reading from shared state in the [CopilotKit Feature Viewer](https://feature-viewer.copilotkit.ai/claude-agent-sdk/feature/shared_state).
</Callout>
