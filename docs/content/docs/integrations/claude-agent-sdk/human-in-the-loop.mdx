...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk/feature/human_in_the_loop?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.copilotkit.ai/claude-agent-sdk/feature/human_in_the_loop?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
