...
<Callout>
    This example shows our [Research Canvas](/microsoft-agent-framework/videos/research-canvas) making use of Generative UI!
</Callout>
...
<Cards>
  <Card
    ...
    href="/microsoft-agent-framework/generative-ui/backend-tools"
  />
  <Card
    ...
    href="/microsoft-agent-framework/generative-ui/frontend-tools"
  />
  <Card
    ...
    href="/microsoft-agent-framework/generative-ui/agentic"
  />
</Cards>
