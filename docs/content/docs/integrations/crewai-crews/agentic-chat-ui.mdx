...
CopilotKit provides a _"llm-in-the-middle"_ chat that will communicate with your user to determine which Crew to kick off and gather the necessary input data
