...
This can be utilized to let [your agent control the UI](/aws-strands/frontend-tools), [generative UI](/aws-strands/frontend-tools), or for Human-in-the-loop interactions.
...
<Callout>
Check out the [Frontend Tools overview](/aws-strands/frontend-tools) to understand what they are and when to use them.
</Callout>
