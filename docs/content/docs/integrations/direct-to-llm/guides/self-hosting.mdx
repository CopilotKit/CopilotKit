...
The Copilot Runtime is the back-end component of CopilotKit, handling the communication with your LLM, message history, state and more.
...
- [Bring Your Own LLM](/direct-to-llm/guides/bring-your-own-llm) - Learn how to use different LLM providers
- [Migrating from Adapters](/direct-to-llm/guides/migrate-from-adapters) - If you're upgrading from the old adapter-based approach
````
