...
<Steps>
  ...
  <Step>
    ...
    LangGraph agents are [stateful](https://docs.langchain.com/oss/python/langgraph/use-graph-api#define-state). As you progress through nodes, a state object is passed between them. CopilotKit
