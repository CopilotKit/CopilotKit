...
Enable A2UI in your CopilotRuntime by adding the `a2ui` config:
...
<Callout type="warn">
Without `a2ui: { injectA2UITool: true }` in your CopilotRuntime config, A2UI surfaces will not render — tool results will appear as plain text.
</Callout>
