---
title: "Advanced"
description: "Custom progress rendering, theming, and advanced A2UI configuration."
---
...
## Theming A2UI Surfaces

A2UI surfaces are rendered using web components from `@a2ui/lit`. You can customize their appearance with CSS custom properties:

```css title="src/a2ui/theme.css"
:root {
  --a2ui-primary: #1a1a1a;
  --a2ui-card-bg: #ffffff;
  --a2ui-card-border: #e5e5e5;
  --a2ui-card-radius: 12px;
  --a2ui-foreground: #1a1a1a;
  --a2ui-input-border: #d4d4d4;
  --a2ui-background: #fafafa;
}
```
