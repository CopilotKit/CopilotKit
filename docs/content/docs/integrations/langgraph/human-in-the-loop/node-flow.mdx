...
<Callout type="error">
  The usage of node based interrupt is [now
  discouraged](https://docs.langchain.com/oss/python/langgraph/interrupts) by
  both LangGraph and CopilotKit. As of LangGraph 0.2.57, the recommended way to
  set breakpoints is using [the interrupt
  function](https://docs.copilotkit.ai/coagents/human-in-the-loop/interrupt-flow)
...
<Callout type="info">
  ...
  starter](https://github.com/copilotkit/copilotkit/tree/main/examples/coagents-starter)
  with the implementation below applied!
</Callout>

## What is this?

[Node based flows](https://docs.langchain.com/oss/python/langgraph/interrupts#debugging-with-interrupts) are predicated on LangGraph concept
