...
<Callout>
  This video shows an example of our [AI Travel
  App](/langgraph/tutorials/ai-travel-app) using HITL to get user feedback.
</Callout>
...
<Callout type="info">
  Learn more about HITL in [LangGraph's concept
  guide](https://docs.langchain.com/oss/python/langgraph/interrupts).
</Callout>
...
<Callout>
  Unsure which approach to use? We recommend starting with the
  [Interrupt](/langgraph/human-in-the-loop/interrupt-flow) flow.
</Callout>
