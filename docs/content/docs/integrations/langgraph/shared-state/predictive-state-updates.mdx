    ...
    <Steps>
      ...
      <Step>
        ...
        <Tabs groupId="language_langgraph_agent" items={["Python", "TypeScript"]} persist>
          <Tab value="Python">
            ```python title="agent.py"
            from ag_ui_langgraph import StateStreamingMiddleware, StateItem  # [!code highlight]
          ...
          <Tab value="TypeScript">
            ...
            import { stateStreamingMiddleware, stateItem } from "@ag-ui/langgraph/middleware";  // [!code highlight]
