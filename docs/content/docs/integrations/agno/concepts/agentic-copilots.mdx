...
<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption 
        id="new"
        title="I'm new to Agno" 
        description="Help me understand what agentic copilots are, where Agno fits in, and how to get started." 
    ...
    >
        ...
        up to 100% of the Copilot's tasks (see [agent-lock mode](/agno/multi-agent-flows) for the 100% case).
        ...
        <Cards>
            ...
            <Card
                ...
                href="/agno/concepts/terminology"
    ...
    >
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your Agno agent with CopilotKit in a few minutes."
                href="/agno/quickstart/agno"
                icon={<RocketIcon />}
            />
            <Card
                ...
                description="Follow a step-by-step tutorial to build a travel app supercharged with CoAgents."
                href="/agno/tutorials/ai-travel-app/overview"
                icon={<GraduationCapIcon />}
            />
            <Card
                title="Reference"
