...
<Callout>
    This video shows the [coagents starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-flows) repo with various Copilot UI components applied to it!
</Callout>
