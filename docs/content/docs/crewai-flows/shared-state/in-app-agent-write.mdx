...
<Callout>
  This video shows the [coagents starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-flows) repo with the previous steps applied to it!
</Callout>
...
By default, the CrewAI Flow agent state will only update *between* CrewAI Flow node transitions --
