...
<Steps>
    ...
    <Step>
        ### Start your CrewAI Flow

        1. Next, use CopilotKit's FastAPI integration to serve your CrewAI flow agent.
        ...
        from path.to.your.flow import YourFlow # [!code highlight]
        ...
        sdk = CopilotKitRemoteEndpoint(
            agents=[
                CrewAIAgent(
                    ...
                    flow=YourFlow(), # The flow object from your CrewAI import
                )
            ],
        )

        # Use CopilotKit's FastAPI integration to add a new endpoint for your CrewAI Flows # [!code highlight:2]
