...
<Frame>
    <img src="https://cdn.copilotkit.ai/docs/copilotkit/images/microsoft-agent-framework/agents-state-diagram.png" alt="Agentic Copilot State Diagram" />
</Frame>

Agents can expose UI-facing state that your application can read and update during a session.
