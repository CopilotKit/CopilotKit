...
// TODO: We should remove or rework this sample
...
var agent = new AzureOpenAIClient(new Uri(endpoint), new DefaultAzureCredential())
    ...
    .CreateAIAgent(new ChatClientAgentOptions
    {
        ...
        ChatMessageStoreFactory = ctx =>
            ctx.SerializedState.ValueKind != JsonValueKind.Undefined
                ? new DatabaseChatMessageStore(ctx.SerializedState, ctx.JsonSerializerOptions)
                : new DatabaseChatMessageStore(dbConnectionString)
    });
