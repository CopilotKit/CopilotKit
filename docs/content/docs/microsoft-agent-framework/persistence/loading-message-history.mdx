...
Microsoft Agent Framework supports threads, a way to group messages together and maintain a continuous chat history via `AgentThread`. CopilotKit provides a few different ways to interact with this concept.
