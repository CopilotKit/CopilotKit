...
CopilotKit contains a ready made script for starting a development environment based on one of the agent examples. It lets you work on CopilotKit internals in the core Typescript and Python code while seeing your changes applied to the chosen example.
