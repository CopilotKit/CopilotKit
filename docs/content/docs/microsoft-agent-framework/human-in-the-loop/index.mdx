...
<Frame className="my-0">
    {/* TODO: Remove/replace this image with one for Microsoft Agent Framework HITL from docs/public/images/microsoft-agent-framework/agents-hitl-infographic.png. */}
