...
## What is this?
Frontend tools enable you to define client-side functions that your agent framework agent can invoke, with execution happening entirely in the user's browser. When your agent calls a frontend tool,
the logic runs on the client side, giving you direct access to the frontend environment.

This can be utilized for to let [your agent control the UI](/agent framework/frontend-actions), [generative UI](/agent framework/generative-ui/frontend-tools), or for Human-in-the-loop interactions.
...
<Steps>
    ...
    <Step>
        ...
        <Tabs groupId="language" items={['Python', 'TypeScript']} default="Python">
            ...
            <Tab value="TypeScript">
                ...
                import { CopilotKitStateAnnotation } from "@copilotkit/sdk-js/agent framework"; // [!code highlight]
    ...
    <Step>
        ...
        These tools are automatically populated by CopilotKit and are compatible with agent's tool call definitions, making it straightforward to integrate them into your agent's workflow.
    </Step>
    <Step>
        ### Give it a try!
