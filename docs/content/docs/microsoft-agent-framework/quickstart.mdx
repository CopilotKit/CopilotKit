    ...
    >
        ...
        >
            ...
            <Step>
                ...
                The starter includes a `postinstall` script that automatically installs both your npm and .NET dependencies.

                ```package-install
                ```

                <Callout type="info" title="Manual .NET setup">
        ...
        >
            <Step>
                ...
                Make sure your .NET agent is running and exposing an AGUI endpoint. Here's a minimal example:
                ...
                Build a minimal agent and serve it via AGUI:
