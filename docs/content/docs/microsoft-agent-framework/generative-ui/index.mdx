...
<Frame>
  <img
    src="https://cdn.copilotkit.ai/docs/copilotkit/images/microsoft-agent-framework/AgenticGenerativeUI.gif"
    className="my-0"
...
<Cards>
  <Card
    ...
    href="./generative-ui/backend-tools"
  />
  <Card
    ...
    href="./generative-ui/frontend-tools"
  />
  <Card
