...
<IframeSwitcher
  ...
  codeUrl="https://feature-viewer.copilotkit.ai/microsoft-agent-framework/feature/agentic_chat?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Steps>
    ...
    <Step>
        ...
        app.MapAGUIAgent("/", (RunAgentInput agentInput, HttpContext httpContext) => {
          // agentInput.Tools contains the frontend tool definitions
