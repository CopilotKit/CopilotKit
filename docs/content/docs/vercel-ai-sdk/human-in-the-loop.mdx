...
description: Learn how to implement Human-in-the-Loop (HITL) using Vercel AI SDK Agents.
icon: lucide/Pause
---
...
<Steps>
  ...
  <Step>
    ### Setup the Vercel AI SDK Agent
    On the agent side, we are already done! Vercel AI SDK natively supports the AG-UI protocol and will automatically
