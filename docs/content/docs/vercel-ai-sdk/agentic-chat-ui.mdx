...
Agentic chat UIs are ways for your users to interact with your Vercel AI SDK agent. CopilotKit provides a variety of different components to choose from, each
with their own unique use cases.

If you've gone through the [getting started guide](/vercel-ai-sdk/quickstart) **you already have a agentic chat UI setup**! Nothing else is needed
to get started.
