...
import { VercelIcon } from "@/lib/icons/custom-icons";


Before we dive into what agentic copilots are, help us help you by telling us your level of experience with Vercel AI SDK. We'll explain things in a way that best suits your experience level.

<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption 
        id="new"
        title="I'm new to Vercel AI SDK" 
        description="Help me understand what agentic copilots are, where Vercel AI SDK fits in, and how to get started." 
    ...
    >
        ...
        frameworks like Vercel AI SDK become essential.

        ### What is Vercel AI SDK?
        Vercel AI SDK is a framework that gives you powerful tools to build AI applications with React. Vercel AI SDK provides developers
        with streaming, tool calling, and multi-model support for building sophisticated AI applications.

        ### What are Agentic Copilots?
        Agentic copilots are how CopilotKit brings Vercel AI SDK agents into your application. If you're familiar with CopilotKit, you know that copilots are AI assistants that
        ...
        for quick implementation, Agentic copilots give you Vercel AI SDK's full capabilities when you need more control over your agent's behavior.
        ...
        You should use CoAgents when you require tight control over the Agentic runloop, as facilitated by an Agentic framework like [Vercel AI SDK](https://sdk.vercel.ai/).
        ...
        <Cards>
            ...
            <Card
                ...
                href="/vercel-ai-sdk/concepts/terminology"
    ...
    <TailoredContentOption
        id="intermediate"
        title="I'm already using Vercel AI SDK"
        description="Help me understand what agentic copilots are, what Copilotkit does to integrate with Vercel AI SDK, and how to get started."
        icon={<VercelIcon />}
    >

        Vercel AI SDK is a framework for building AI-powered applications with React.
        ...
        Any Vercel AI SDK-based agent can be transformed into an Agentic Copilot with a minimal amount
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your Vercel AI SDK agent with CopilotKit in a few minutes."
                href="/vercel-ai-sdk/quickstart"
                icon={<RocketIcon />}
            />
            <Card
