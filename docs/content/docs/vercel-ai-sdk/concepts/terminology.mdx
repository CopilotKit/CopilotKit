...
| [Vercel AI SDK](https://sdk.vercel.ai) | The AI framework integrated with CopilotKit that provides the streaming, tool calling, and multi-model support for CoAgents, enabling sophisticated multi-step reasoning and state management.                               |
