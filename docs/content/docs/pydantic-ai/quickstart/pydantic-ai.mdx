---
title: Quickstart Pydantic AI Agents
...
<Steps>
        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You will need a Pydantic AI Agent to get started!
                </p>
                <p className="text-base">
    ...
    >
        <TailoredContentOption
            id="bring-your-own"
            title="Bring your own Pydantic AI Agent"
            description="I already have a Pydantic AI Agent and want to use it with CopilotKit."
            icon={<img src="https://cdn.copilotkit.ai/docs/copilotkit/images/pydantic-ai-logo.svg" alt="Pydantic AI Logo" width={20} height={20} />}
        />
        <TailoredContentOption
            id="coagents-starter"
            title="Use the CoAgents Starter repo"
            description="I don't have a Pydantic AI Agent yet, but want to get started quickly."
            ...
            <Step>
                ...
                <Tabs groupId="language" items={["Python"]}>
                    <Tab value="Python">
                        ...
                        cd CopilotKit/examples/coagents-starter-pydantic-ai/agent-py
                        ```
                    </Tab>
                </Tabs>
            </Step>
    ...
    <Step>
        ...
        Start your local Pydantic AI Agent:

        ```bash
        python -m uvicorn agent:app --host 0.0.0.0 --port 8000
        ```
    ...
    <TailoredContent
        ...
        header={
            <div>
                ...
                <p className="text-base">
                    Now you need to connect your Pydantic AI Agent to CopilotKit.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ### Add a remote endpoint for your Pydantic AI Agent
                Using Copilot Cloud, you need to connect a remote endpoint that will connect to your Pydantic AI Agent.
                <Tabs groupId="lg-deployment-type" items={['Self hosted (FastAPI)', 'Pydantic AI Enterprise']}>
                    ...
                    <Tab value="Pydantic AI Enterprise">
                        Coming soon!
                    </Tab>
                </Tabs>
            </Step>
            <Step>
                ...
                <Callout type="info">
                    Looking for a way to run multiple Pydantic AI Agents? Check out our [Multi-Agent](/pydantic-ai/multi-agent-flows) guide.
                </Callout>
            </Step>
        </TailoredContentOption>
        <TailoredContentOption
        ...
        >
            <Step>
                ...
                Copilot Runtime is a production-ready proxy for your Pydantic AI Agents. In your frontend, go ahead and install it.
            ...
            <Step>
                ### Add your Pydantic AI Agent deployment to Copilot Runtime
                Now we need to add your Pydantic AI Agent deployment to Copilot Runtime. This will make it
                so your frontend can find your Pydantic AI Agents correctly.
                ```ts
                import {
                CopilotRuntime,
                // ...
