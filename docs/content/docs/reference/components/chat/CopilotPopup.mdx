...
<PropertyReference name="canCopyAssistantMessage" type="AssistantMessageProps['canCopy']"  > 
Whether the assistant message can be copied.
</PropertyReference>

<PropertyReference name="disableFirstAssistantMessageControls" type="AssistantMessageProps['disableFirstMessageControls']"  > 
