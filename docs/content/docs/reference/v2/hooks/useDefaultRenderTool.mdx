...
This is part of the v2 tool rendering hook set with [`useComponent`](/reference/v2/hooks/useComponent), [`useRenderTool`](/reference/v2/hooks/useRenderTool), and [`useToolRenderingResolver`](/reference/v2/hooks/useToolRenderingResolver).
