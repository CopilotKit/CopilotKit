...
function useAgent(options?: UseAgentProps): { agent: AbstractAgent; streamingStatus: StreamingStatus }
```
...
<PropertyReference name="object" type="{ agent: AbstractAgent; streamingStatus: StreamingStatus }">
  ...
  <PropertyReference name="streamingStatus" type="StreamingStatus">
    ...
    <PropertyReference name="toolCallId" type="string | null">
      ID of the active tool call, or `null`.
    </PropertyReference>
  </PropertyReference>
...
function StatusBadge() {
  ...
  return (
    <span>
      ...
      {streamingStatus.phase === "tool_calling" && `Calling ${streamingStatus.toolName}...`}
