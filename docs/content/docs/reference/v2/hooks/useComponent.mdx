...
This is part of the v2 tool rendering hook set with [`useRenderTool`](/reference/v2/hooks/useRenderTool), [`useDefaultRenderTool`](/reference/v2/hooks/useDefaultRenderTool), and [`useToolRenderingResolver`](/reference/v2/hooks/useToolRenderingResolver).
