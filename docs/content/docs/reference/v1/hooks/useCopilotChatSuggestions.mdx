...
<Callout type="warning">
  `useCopilotChatSuggestions` is still supported, but we recommend migrating to [`useConfigureSuggestions`](/reference/v2/hooks/useConfigureSuggestions) and [`useSuggestions`](/reference/v2/hooks/useSuggestions) from the v2 API.
</Callout>
