...
<Callout type="warning">
  `useCoAgent` is still supported, but we recommend migrating to [`useAgent`](/reference/v2/hooks/useAgent) from the v2 API.
</Callout>

<Callout type="info">
  Usage of this hook assumes some additional setup in your application, for more information
  on that see the CoAgents <span className="text-blue-500">[getting started guide](/langgraph/quickstart)</span>.
</Callout>
