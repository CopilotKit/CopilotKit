...
<Callout type="warning">
  `useCoAgentStateRender` is still supported in v1. For v2 custom rendering, use the v2 tool rendering APIs such as [`useRenderTool`](/reference/v2/hooks/useRenderTool).
</Callout>
