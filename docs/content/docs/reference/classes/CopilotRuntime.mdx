...
<PropertyReference name="onTrace" type="CopilotTraceHandler"  > 
...
<PropertyReference name="traceGraphQLError" type="error: { message: string; code: string; type: string }, context: {
      operation: string;
