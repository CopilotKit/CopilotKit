...
<PropertyReference name="onError" type="ErrorHandler"  > 
...
<PropertyReference name="handleError" type="error: unknown, context: {
      threadId?: string;
      runId?: string;
      url?: string;
      agentName?: string;
...
// Public method to handle errors - allows external code to tap into structured error handling
  ...
  <PropertyReference name="error" type="unknown" required>
