...
<PropertyReference name="instructions" type="string" required>
  The instructions to be added to the Copilot. Will be added to the instructions
  like so: ```txt You are a helpful assistant. Additionally, follow these
  instructions: - Do not answer questions about the weather. - Do not answer
