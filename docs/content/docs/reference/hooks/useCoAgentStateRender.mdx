...
You can play around with it below or learn how to build it with its demo.
...
<iframe
  src="https://examples-coagents-ai-researcher-ui.vercel.app/"
  className="w-full rounded-lg border h-[700px] my-4"
/>
...
<PropertyReference
  name="handler"
  type="(props: CoAgentStateRenderHandlerArguments<T>) => void | Promise<void>"
>
...
<PropertyReference
  name="render"
  type="| ((props: CoAgentStateRenderProps<T>) => string | React.ReactElement | undefined | null) | string"
>
