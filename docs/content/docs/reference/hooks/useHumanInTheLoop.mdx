...
Array of parameter definitions that will be passed to the render function. Each parameter should specify name, type, description, and whether it's required.
</PropertyReference>
