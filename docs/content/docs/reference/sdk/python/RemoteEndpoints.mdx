...
<PropertyReference name="actions" type="Optional[Union[List[Action], Callable[[CopilotKitSDKContext], List[Action]]]]" > 
The actions to make available to the Copilot.
</PropertyReference>

<PropertyReference name="agents" type="Optional[Union[List[Agent], Callable[[CopilotKitSDKContext], List[Agent]]]]" > 
