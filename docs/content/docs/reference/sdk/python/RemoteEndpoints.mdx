...
<PropertyReference name="actions" type="Optional[Union[List[Action], Callable[[CopilotKitRemoteEndpointContext], List[Action]]]]" > 
The actions to make available to the Copilot.
</PropertyReference>

<PropertyReference name="agents" type="Optional[Union[List[Agent], Callable[[CopilotKitRemoteEndpointContext], List[Agent]]]]" > 
The agents to make available to the Copilot.
</PropertyReference>

## CopilotKitRemoteEndpointContext
