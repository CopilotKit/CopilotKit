...
<Steps>
    ...
    <TailoredContent
        ...
        header={
            <div>
                <p className="text-xl font-semibold">Do you already have a Agno Agent?</p>
                <p className="text-base">
                    You will need a Agno Agent to get started!
                </p>
                <p className="text-base">
    ...
    >
        <TailoredContentOption
            id="bring-your-own"
            title="Bring your own Agno Agent"
            description="I already have a Agno Agent and want to use it with CopilotKit."
            icon={<img src="/images/agno-logo.svg" alt="Your Framework Logo" width={20} height={20} />}
        />
        <TailoredContentOption
            id="coagents-starter"
            title="Use the CoAgents Starter repo"
            description="I don't have a Agno Agent yet, but want to get started quickly."
    ...
    <TailoredContent
        ...
        header={
            <div>
                ...
                <p className="text-base">
                    Now you need to connect your Agno Agent to CopilotKit.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ### Add a remote endpoint for your Agno Agent
                Using Copilot Cloud, you need to connect a remote endpoint that will connect to your Agno Agent.
                <Tabs groupId="lg-deployment-type" items={['Self hosted (FastAPI)']}>
            ...
            <Step>
                ...
                <Callout type="info">
                    Looking for a way to run multiple Agno Agents? Check out our [Multi-Agent](/agno/multi-agent-flows) guide.
                </Callout>
            </Step>
        </TailoredContentOption>
        <TailoredContentOption
        ...
        >
            <Step>
                ...
                Copilot Runtime is a production-ready proxy for your Agno Agents. In your frontend, go ahead and install it.

                ```package-install
                @copilotkit/runtime @ag-ui/agno
                ```
            </Step>
            <Step>
            ...
            <Step>
                ### Add your Agno Agent deployment to Copilot Runtime
                Now we need to add your Agno Agent deployment to Copilot Runtime. This will make it
                so your frontend can find your Agno Agents correctly.
                ```ts
                import {
                CopilotRuntime,
                // ...
                ...
                const runtime = new CopilotRuntime({
                    agents: {
                        ...
                        "agno_agent": new AgnoAgent({url: "http://localhost:8000/copilotkit"}),
                    }                
                });
                // ...
                ```
    ...
    <Step>
        ...
        <Callout type="info">
            Looking for other chat component options? Check out our [Agentic Chat UI](/agno/agentic-chat-ui) guide.
        </Callout>
    </Step>
    <Step>
        ### 🎉 Talk to your agent!

        Congrats! You've successfully integrated a Agno Agent chatbot to your application. To start, try asking a few questions to your agent.
...
To learn more about Agno, check out the [Agno documentation](https://docs.agno.com/applications/ag-ui/introduction).

## What's next?

You've now got a Agno Agent running in CopilotKit! Now you can start exploring the various ways that CopilotKit
