---
title: Agno Agents
description: Learn how to implement Human-in-the-Loop (HITL) using Agno Agents.
icon: lucide/Share2
---
...
<Steps>
    <Step>
        ...
        If you don't already have an agent, you can use the [coagent starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-agno) as a starting point
    ...
    Now we'll setup the Agno agent. The flow is hard to understand without a complete example, so below
