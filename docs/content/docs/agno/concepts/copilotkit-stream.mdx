...
If you just call the LiteLLM `completion` function from your Agno agent, messages will not be streamed by default.
...
For more information on how tool calls are utilized check out our [frontend actions](/agno/frontend-actions)
documentation. 