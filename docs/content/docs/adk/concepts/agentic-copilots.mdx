...
Before we dive into what agentic copilots are, help us help you by telling us your level of experience with ADK. We'll explain things in a way that best suits your experience level.

<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption
        id="new"
        title="I'm new to ADK"
description="Help me understand what agentic copilots are, where ADK fits in, and how to get started."
    ...
    >
        ...
        frameworks like ADK become essential.

        ### What is ADK?
        ADK is a framework that gives you precise control over AI agents. ADK agents allow developers to combine and coordinate coding tasks efficiently,
        providing a robust framework for building sophisticated AI automations.

        ### What are Agentic Copilots?
        Agentic copilots are how CopilotKit brings ADK agents into your application. If you're familiar with CopilotKit, you know that copilots are AI assistants that
        ...
        for quick implementation, Agentic copilots give you ADK's full orchestration capabilities when you need more control over your agent's behavior.
        ...
        You should use CoAgents when you require tight control over the Agentic runloop, as facilitated by an Agentic Orchestration framework like [ADK](https://google.github.io/adk-docs/).
        ...
        up to 100% of the Copilot's tasks (see [agent-lock mode](/adk/multi-agent-flows) for the 100% case).
        ...
        <Cards>
            ...
            <Card
                ...
                href="/adk/videos/research-canvas"
                icon={<VideoIcon />}
            />
        </Cards>
    </TailoredContentOption>
    <TailoredContentOption
        id="intermediate"
        title="I'm already using ADK"
description="Help me understand what agentic copilots are, what Copilotkit does to integrate with ADK, and how to get started."
        icon={<SiLangchain />}
    >
        ...
        ADK is a framework for building deeply customizable AI agents.
        ...
        Any ADK-based agent can be transformed into an Agentic Copilot with a minimal amount
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your ADK agent with CopilotKit in a few minutes."
href="/adk/quickstart/adk"
                icon={<RocketIcon />}
            />
            <Card
                ...
                description="Follow a step-by-step tutorial to build a travel app supercharged with CoAgents."
                href="/adk/tutorials/ai-travel-app/overview"
                icon={<GraduationCapIcon />}
            />
            <Card
                title="Reference"
