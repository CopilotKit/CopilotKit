...
<Callout>
  This example demonstrates the [implementation](#implementation) section applied in the <a href="https://feature-viewer.copilotkit.ai/adk-middleware/feature/agentic_chat" target="_blank">CopilotKit feature viewer</a>.
</Callout>
