...
(See [Message Persistence](/crewai-crews/persistence/message-persistence) for more details.)
...
- [Reading agent state](/crewai-crews/shared-state/in-app-agent-read)
- [Writing agent state](/crewai-crews/shared-state/in-app-agent-write)
- [Loading Message History](/crewai-crews/persistence/loading-message-history)
