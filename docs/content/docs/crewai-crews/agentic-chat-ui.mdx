...
## How does this work?
CopilotKit provides a *"llm-in-the-middle"* chat that will communicate with your user to determine what Crew to kick-off as well as the what gather input data
