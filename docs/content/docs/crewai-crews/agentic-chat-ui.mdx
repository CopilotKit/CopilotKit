...
<Callout>
    This video shows the [coagents starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-crews) repo with various Copilot UI components applied to it!
</Callout>
...
If you've gone through the [getting started guide](/crewai-crews/quickstart/crewai) **you already have a agentic chat UI setup**! Nothing else is needed
to get started.
