...
> - [CopilotKit Platform](https://cloud.copilotkit.ai/) to handle UI workflows and communication
...
<Steps>
  ...
  <Step>
    ...
    > Reminder: To make this work end-to-end, you must run your crew on [CrewAI](https://www.crewai.com/) and connect it to [CopilotKit Platform](https://cloud.copilotkit.ai/). These hosted solutions take care of message passing, HITL state syncing, and UI orchestration.
  </Step>
