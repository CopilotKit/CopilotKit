...
<Steps>
    ...
    <Tabs groupId="language" items={["Python"]}>
      <Tab value="Python">
        ...
        class EmailAgentFlow(AgentState):
            ...
            async def chat():
                ...
                response = await copilotkit_stream(
                    completion(
                        ...
                        # 2.3 Use CopilotKit's actions as tools
                ...
                # Now control is returned to the frontend to get user feedback
                # It will be either:
                # 1. A text message from the AI, to which the user can respond by chatting
                # 2. A tool call to writeEssay, in which case CopilotKit will call the frontend
                #    action `writeEssay`
