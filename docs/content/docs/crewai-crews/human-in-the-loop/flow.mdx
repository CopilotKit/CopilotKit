...
<Steps>
  <Step>
    ...
    You can also use our [coagent starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-crews), which this guide builds upon.
  </Step>
  ...
  <Step>
    ...
    You’ll need to configure your CrewAI flow to pause and wait for human input before continuing.
