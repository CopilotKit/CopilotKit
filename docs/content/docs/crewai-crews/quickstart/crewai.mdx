...
import CrewAgentRunRenderer from "@/snippets/crew-agent-run-renderer.mdx";
import CrewStateRenderer from "@/snippets/crew-state-renderer.mdx";
import CrewHumanInputRenderer from "@/snippets/crew-human-input-renderer.mdx";
...
<Steps>
    ...
    >
        ...
        >
            ...
            <Step>
               <CrewAgentRunRenderer components={props.components} />
            </Step>
            <Step>
                <CrewStateRenderer components={props.components} />
            </Step>
            <Step>
                <CrewHumanInputRenderer components={props.components} />
            </Step>
            <Step>
                ### 🎉 Talk to your agent!
...
<Callout type="info">
  Need more customization options? CopilotKit provides specialized UI components
  like `DefaultStateRenderer` and `DefaultResponseRenderer` that make it easy to
  display agent states and collect user feedback. Check out our [UI
  Components](/crewai-crews/components) guide to learn more.
</Callout>
