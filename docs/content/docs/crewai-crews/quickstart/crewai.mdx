    ...
    >
        ...
        >
            ...
            <Step>
                ...
                import CrewQuickstart from "./crew-quickstart";
                ...
                export default function YOUR_MAIN_ENTRY_COMPONENT() {
                  const { setState } = useCoAgent({
                    ...
                    initialState: {
                      result: "",
                      /**
                       *  Make sure you capture right input as per your Crew Inputs Requirements
                       */
                      inputs: {},
                    },
                  });
                  ...
                  useEffect(() => {
                    setState(prev => ({
                      ...prev,
                      result: prev?.result || "",
                      // This is a placeholder input for demonstration purposes only. Replace it with actual input values required by your Crew.
                      inputs: {
                  ...
                  return <CrewQuickstart crewName={MY_CREW_NAME} />;
                }
                ```
