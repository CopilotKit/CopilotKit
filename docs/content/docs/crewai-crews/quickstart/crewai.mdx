...
import CrewSetup from "@/snippets/crew-setup.mdx";
    ...
    >
        ...
        >
            ...
            <Step>
                ...
                Place the following snippet in your **main page** (e.g. `page.tsx` in Next.js) or wherever you want to use CopilotKit. It simply imports the `QuickstartCrew` component from our **crew-setup.tsx** file and renders it.

                ```tsx title="page.tsx"
                import React from "react";
                import QuickstartCrew from "./crew-quickstart";
                // ^ Adjust path as needed based on where you saved crew-quickstart.tsx

                const MY_CREW_NAME = "REPLACE_WITH_YOUR_CREW_NAME";
                /**
                 * Entry component for displaying the QuickstartCrew on the page.
                 */
                export default function YOUR_MAIN_ENTRY_COMPONENT() {
                  return (
                    <div style={{ margin: "24px" }}>
                    <h1>My Application with Crew</h1>
                    <QuickstartCrew crewName ={MY_CREW_NAME} />
                    </div>
                  );
                }
                ```
               <CrewSetup components={props.components} />
            </Step>
            <Step>
                ### 🎉 Talk to your agent!
