...
<Callout>
    This video shows the [coagents starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-crews) repo with the [implementation](#implementation) section applied to it!
</Callout>
