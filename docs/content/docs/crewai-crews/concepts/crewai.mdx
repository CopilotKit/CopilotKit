...
CopilotKit provides a set of React UI components specifically designed for CrewAI applications:

- [State Renderer](/crewai-crews/components/state-renderer) - Display agent state and progress
- [Response Renderer](/crewai-crews/components/response-renderer) - Collect user feedback on agent responses
- [Component Types](/crewai-crews/components/types) - TypeScript interfaces for components

These components help you build beautiful, interactive CrewAI applications with minimal effort. See the [UI Components](/crewai-crews/components) section for detailed documentation.
