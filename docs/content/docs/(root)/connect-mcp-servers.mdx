...
<Image 
  src="/images/cpk-with-agentic-protocols-light.svg" 
  alt="CopilotKit with Agentic Protocols" 
  width={4096} 
  height={2304}
  className="block dark:hidden w-3/5 mx-auto"
/>
<Image 
  src="/images/cpk-with-agentic-protocols-dark.svg" 
  alt="CopilotKit with Agentic Protocols" 
  width={4096} 
  height={2304}
  className="hidden dark:block w-3/5 mx-auto"
/>
