...
[car sales example](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine) which you already saw a demo of in the [overview](#overview).
...
Click here for the [source code](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine/src/lib/stages/use-stage-get-contact-info.tsx)
...
Click here for the [source code](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine/src/lib/stages/use-stage-sell-financing.tsx)
...
Click here for the [source code](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine/src/lib/stages/use-stage-build-car.tsx)
...
Click here for the [source code](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine/src/components/car-sales-chat.tsx)
...
Click here for the [source code](https://github.com/CopilotKit/CopilotKit/tree/main/CopilotKit/examples/state-machine/src/lib/stages/use-stage-get-payment-info.tsx)
