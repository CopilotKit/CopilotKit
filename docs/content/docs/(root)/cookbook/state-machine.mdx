...
<video src="/images/cookbook/state-machine/demo.mp4" controls autoPlay loop muted playsInline className="rounded-xl shadow-lg" />

<Callout>
This recipe assumes you have completed the [quickstart guide](/docs/quickstart) and have a basic CopilotKit application running.
</Callout>
...
[car sales example](https://github.com/CopilotKit/CopilotKit/tree/main/examples/state-machine/src) which you already saw a demo of in the [overview](#overview).
...
<video src="/images/cookbook/state-machine/gen-ui.mp4" controls autoPlay loop muted playsInline className="rounded-xl shadow-lg" />
