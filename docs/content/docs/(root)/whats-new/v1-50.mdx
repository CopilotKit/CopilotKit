...
CopilotKit v1.50 is now in pre-release and will be generally available very soon.

# Getting Started

Make sure to set your CopilotKit version to ^1.50.0-beta.2

PNPM Install:
`pnpm add @copilotkit/react-core@beta @copilotkit/react-ui@beta @copilotkit/runtime@beta`

Note that we are still working on docs, and examples and some of the fit and finish on the release.  We appreciate your patience and determination.  Please do not hesitate to [share feedback or ask for help](https://www.notion.so/CopilotKit-v1-50-Pre-Release-Packet-Staged-2b63aa381852812bb4f3fdabc89a6d94?pvs=21)!
...
---
## Coming Soon
v1.50 is in pre-release now, with useAgent fully ready.  The other features (listed below) will be added as they come out in the near future.  <V150SignupLink>Sign up here</V150SignupLink> for access, if you haven't already.
