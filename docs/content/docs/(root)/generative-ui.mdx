...
<div className="flex flex-col items-center gap-6 pt-4">
  <Badge className="mb-4">Design Patterns</Badge>

  <h1 className="text-4xl md:text-6xl font-semibold text-center mb-4">
    Generative UI
  </h1>

  <p className="text-lg md:text-xl font-semibold text-center max-w-4xl mb-6">
    The different types of Generative UI, and how AG-UI and CopilotKit work with them all.
  </p>
