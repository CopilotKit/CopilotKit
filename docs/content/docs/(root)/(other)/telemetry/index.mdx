...
The inspector never sends message content, agent state, prompts, completions, or any payload you inspect. The opt-out covers all anonymous interaction telemetry, including any future signup attribution.
