...
<Accordions>
  ...
  <Accordion title="What are the main features of CopilotKit?">
    ...
    | [**Frontend Tools**](/reference/hooks/useFrontendTool) | Copilots can execute tools in the application |
    ...
    | [**Copilot Tasks**](/reference/classes/CopilotTask) | Let your copilots execute tools proactively based on application state |

    ### Rich agentic experiences
    Integrate your LangGraph agents into your product with ease.
    | |  |
    |---------|-------------|
    | [**Deep support for LangGraph**](/langgraph/quickstart/langgraph) | Bring your LangGraph agents directly into your product |
  ...
  <Accordion title="Can I use any LLM with CopilotKit?">
    ...
    For more information, checkout our documentation on [bringing your own LLM](/direct-to-llm/guides/bring-your-own-llm).
  </Accordion>
</Accordions> 