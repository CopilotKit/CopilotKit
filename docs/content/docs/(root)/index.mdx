...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
  ...
  <div className="border border-border rounded-lg p-6">
    <img src="https://cdn.copilotkit.ai/docs/copilotkit/images/copilot-action-example.gif" alt="Frontend Tools Example" className="rounded-lg mb-4 w-full" />
    <h3 className="text-xl font-bold mb-3">Frontend Tools</h3>
    <p className="text-muted-foreground mb-4">
      Let LLMs guide your users through your application, make updates across the application, and more.
    </p>
    <div className="flex gap-2">
      <a href="/direct-to-llm/guides/frontend-actions" className="text-sm text-primary hover:underline">Documentation →</a>
      <a href="https://feature-viewer.copilotkit.ai/direct-to-llm/feature/mcp" className="text-sm text-primary hover:underline">Demo →</a>
    </div>
  </div>
</div>
