...
<div className="grid grid-cols-1 xl:grid-cols-10 gap-6 mb-12">
  <div className="xl:col-span-3 border-2 border-border px-6 pt-1 pb-4 rounded-xl text-center transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
  ...
  <div className="xl:col-span-4 border-2 border-border px-6 pt-1 pb-4 rounded-xl text-center transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
