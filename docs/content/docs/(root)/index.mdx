    ...
    <div className="grid lg:grid-cols-5 gap-12 items-start">
      <div className="lg:col-span-2">
        ...
        <div className="space-y-3">
          <a href="/direct-to-llm/guides/generative-ui" className="block text-primary hover:text-primary font-medium no-underline">
            Learn more →
          </a>
  ...
  <div className="border-b border-border pb-24">
    <div className="grid lg:grid-cols-5 gap-12 items-start">
      <div className="lg:col-span-2">
        ...
        <div className="space-y-3">
          <a href="/direct-to-llm/guides/generative-ui?gen-ui-type=renderAndWaitForResponse+%28HITL%29" className="block text-primary hover:text-primary font-medium no-underline">
            Learn more →
          </a>
  ...
  <div>
    <div className="grid lg:grid-cols-5 gap-12 items-start">
      <div className="lg:col-span-2">
        ...
        <div className="space-y-3">
          <a href="/coagents/shared-state" className="block text-primary hover:text-primary font-medium no-underline">
            Learn more →
          </a>
