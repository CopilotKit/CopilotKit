...
<h2 className="text-2xl font-bold mt-12 mb-6">Get Started Now</h2>
<div className="grid grid-cols-1 md:grid-cols-10 gap-6 mb-12">
  <div className="md:col-span-3 bg-muted/50 border border-border px-6 pt-1 pb-4 rounded-xl text-center hover:bg-muted/70 transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
  ...
  <div className="md:col-span-4 bg-muted/50 border border-border px-6 pt-1 pb-4 rounded-xl text-center hover:bg-muted/70 transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
...
```
  ...
  <div className="md:col-span-3 bg-muted/50 border border-border px-6 pt-1 pb-4 rounded-xl text-center hover:bg-muted/70 transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-4">Start with an LLM<br /> or Agent Framework</p>
    </div>
    <div className="h-12 flex items-center justify-center">
      <QuickstartDropdown />
    </div>
