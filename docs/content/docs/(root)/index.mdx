...
<h2 className="text-2xl font-bold mt-12 mb-4">Get Started Now</h2>
<div className="flex flex-row gap-8 mb-12">
  <div className="w-1/3 bg-muted p-6 rounded-lg text-center">
    <h3 className="text-lg font-semibold mb-2">CLI</h3>
Bootstrap your NextJS application 
with CopilotKit.
