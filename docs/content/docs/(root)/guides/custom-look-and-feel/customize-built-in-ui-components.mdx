...
|-------------|-------------|
| `--copilot-kit-primary-color` | Main accent color used throughout the UI |
| `--copilot-kit-contrast-color` | Text color that contrasts with the primary color |
| `--copilot-kit-secondary-color` | Secondary accent color for less prominent elements |
| `--copilot-kit-secondary-contrast-color` | Text color that contrasts with the secondary color |
| `--copilot-kit-background-color` | Background color of the chat interface |
| `--copilot-kit-muted-color` | Color used for less prominent or disabled text |
| `--copilot-kit-text-light-color` | Color used for light text throughout the UI |
| `--copilot-kit-text-dark-color` | Color used for dark text throughout the UI |
| `--copilot-kit-separator-color` | Color used for borders and dividing lines |
| `--copilot-kit-scrollbar-color` | Color of the scrollbar |
| `--copilot-kit-header-color` | Color of the header |
| `--copilot-kit-response-button-color` | Text color for response buttons |
| `--copilot-kit-response-button-background-color` | Background color for response buttons |
...
| `.copilotKitResponseButton` | Button for regenerating AI responses with states |
...
```tsx
<CopilotChat icons={{
  openIcon: <Icon name="lucide/MessageSquare" />,
  closeIcon: <Icon name="lucide/MessageSquare" />,
}} />
```
