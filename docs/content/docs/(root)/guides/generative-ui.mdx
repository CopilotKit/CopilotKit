...
<Tabs items={['Render a component', 'Fetch data & render', 'renderAndWaitForResponse (HITL)', 'Render strings']}>
  ...
  <Tab value="Catch all renders">
    ...
    In this case, the render method will receive an additional `name` parameter.
