...
description: Migrate an agent to stream through AG-UI protocol
...
<TailoredContent
        ...
        header={
            <div>
                <p className="text-xl font-semibold">Choose your agent is served</p>
            </div>
        }
    >
    <TailoredContentOption
    ...
    >
        ...
        To
        ```typescript
        import { langGraphPlatformEndpoint, LangGraphAgent } from "@copilotkit/runtime";
