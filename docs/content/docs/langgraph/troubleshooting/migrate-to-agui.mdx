...
description: Migration guide for an AG-UI FastAPI-based agent
icon: "lucide/RefreshCw"
---
import { Accordions, Accordion } from "fumadocs-ui/components/accordion";

### Migrate a FastAPI-based agent to the AG-UI FastAPI agent

AG-UI is the new agent-to-UI protocol used in CopilotKit.
It already integrates with FastAPI-based LangGraph agents.
