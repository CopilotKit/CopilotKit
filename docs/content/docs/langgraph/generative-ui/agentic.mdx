...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.copilotkit.ai/langgraph/feature/agentic_generative_ui?sidebar=false"
  codeUrl="https://feature-viewer.copilotkit.ai/langgraph/feature/agentic_generative_ui?view=code&sidebar=false"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
