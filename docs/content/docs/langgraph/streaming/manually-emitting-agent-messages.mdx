---
title: "Manually emitting agent messages"
description: You can manually emit agent messages while a node is executing to allow the agent to communicate with the user.
icon: "lucide/Radio"
---
import InstallSDKSnippet from "@/snippets/install-sdk.mdx"
import RunAndConnectSnippet from "@/snippets/coagents/run-and-connect-agent.mdx"

> You can manually emit agent messages while a node is executing to allow the agent to communicate with the user.
