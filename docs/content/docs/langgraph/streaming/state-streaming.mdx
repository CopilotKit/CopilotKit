...
icon: "lucide/Podcast"
description: Stream in-progress LangGraph state updates to the frontend.
---
import {
  TailoredContent,
...
CopilotKit enables this through its concept of **state streaming** (formerly known as predictive state updates).
...
<Steps>
    ...
    <Step>
        ...
        >
            ...
            <TailoredContentOption
                id="tool-emission"
                title="Tool-based state streaming"
