    ...
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx copilotkit@latest create -f langgraph
                ```
            </Step>
            <Step>
            ...
            <Step>
                ...
                Create a `.env` file in your agent directory and add your API keys:
    ...
    <Step>
        ...
        <Accordions className="mb-4">
            <Accordion title="Troubleshooting">
                ...
                - Check that your LangSmith and OpenAI API keys are correctly set in the `.env` file
