...
CopilotKit Platform enables secure propagation of authentication state within AI conversations, allowing your copilot to interact with authenticated backend services and tools on behalf of the user.

This feature is only available with [CopilotKit Platform](https://cloud.copilotkit.ai/).
...
3. CopilotKit Platform Runtime maintains this auth context throughout the conversation
