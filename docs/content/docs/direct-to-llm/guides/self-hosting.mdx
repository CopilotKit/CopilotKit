...
You may choose to self-host the Copilot Runtime, or [use Copilot Platform](https://cloud.copilotkit.ai) (recommended).
...
<Step>
  ### Step 2: Get Your Copilot Platform API Key (Optional but Recommended)

  <Callout type="info">
    While self-hosting, you can still leverage CopilotKit Platform's enhanced features for production-ready deployments.
  </Callout>

  1. Go to [Copilot Platform](https://cloud.copilotkit.ai) and sign up for free
