...
<Step>
### Get a Copilot Platform Public API Key
Navigate to [Copilot Platform](https://cloud.copilotkit.ai) and follow the instructions to get a public API key - it's free!
</Step>
<Step>
