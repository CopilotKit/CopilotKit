...
<Steps>
    ...
    <TailoredContent id="hosting">
        <TailoredContentOption
            ...
            description="I'm already using or want to use Copilot Platform."
            icon={<FaCloud />}
        >
            If you followed the [Copilot Platform Quickstart](/docs/quickstart) and opted to use CopilotCloud,
            ...
            <Accordions className="my-4">
                <Accordion title="Haven't setup Copilot Platform yet? Click here!" >
                    Copilot Platform hooks into your CopilotKit provider, so you'll need to set it up first if you haven't already.
