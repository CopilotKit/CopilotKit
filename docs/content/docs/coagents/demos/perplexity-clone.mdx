...
Combining these technologies enables **Agentic Copilots**, which allow for the creation of human in the loop AI agents.
Instead of relying entirely on AI, Agentic Copilots let users step in to guide or adjust the search as needed.

In this demo, the Agentic Copilot will come up with a list of topics to research, and combine the results
