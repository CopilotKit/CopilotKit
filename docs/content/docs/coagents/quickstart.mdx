...
import { FaPython, FaJs, FaCloud, DiServer } from "react-icons/fa";
    ...
    <InsecurePasswordProtected>
      ...
      <TailoredContent>
        <TailoredContentOption
          ...
          description="I want to write my LangGraph agent in Python or JavaScript."
          icon={<FaCloud />}
        >
          <Accordions>
      ...
      ##  Optionally lock Copilot to the `basic_agent` agent.
