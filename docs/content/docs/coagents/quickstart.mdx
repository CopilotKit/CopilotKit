        ...
        >
            ...
            >
                <TailoredContentOption
                    ...
                    description="I want to host my Copilot on Copilot Platform"
                    icon={<FaCloud />}
                >
                    <Step>
                        ### Add a remote endpoint for your LangGraph agent
                        Using Copilot Platform, you need to connect a remote endpoint that will connect to your LangGraph agent.
                        <Tabs groupId="lg-deployment-type" items={['Local (LangGraph Studio)', 'Self hosted (FastAPI)', 'LangGraph Platform']}>
                            <Tab value="Local (LangGraph Studio)">
                                When running your LangGraph agent locally, you can open a tunnel to it so Copilot Platform can connect to it.
                                First, make sure you're logged in to [Copilot Platform](https://cloud.copilotkit.ai), and then authenticate the CLI by running:
                                ```bash
                            ...
                            <Tab value="Self hosted (FastAPI)">
                                **Running your FastAPI server locally**
                                ...
                                If you're running your FastAPI server locally, you can open a tunnel to it so Copilot Platform can connect to it.
                                First, make sure you're logged in to [Copilot Platform](https://cloud.copilotkit.ai), and then authenticate the CLI by running:
                                ```bash
                                npx copilotkit@latest login
                                ```
                                ...
                                **Running your FastAPI server in production**
                                ...
                                Head over to [Copilot Platform](https://cloud.copilotkit.ai) sign up and setup a remote endpoint with the following information:
                                - OpenAI API key
                                - LangSmith API key
                            ...
                            <Tab value="LangGraph Platform">
                                Head over to [Copilot Platform](https://cloud.copilotkit.ai) sign up and setup a remote endpoint to LangGraph Platform with the following information:
                                - OpenAI API key
                                - LangSmith API key
                                ...
                                <Accordions className="mb-4">
                                    <Accordion title="Show me how">
                                        <Frame>
                                            <img src="https://cdn.copilotkit.ai/docs/copilotkit/images/copilotkit-platform/cpk-cloud-lgp-endpoint.gif" alt="Copilot Platform Remote Endpoint" />
                                        </Frame>
                                    </Accordion>
                                </Accordions>
                            </Tab>
                    ...
                    <Step>
                        ...
                        Since we're using Copilot CLoud, we need to grab our public API key from the [Copilot Platform dashboard](https://cloud.copilotkit.ai).
