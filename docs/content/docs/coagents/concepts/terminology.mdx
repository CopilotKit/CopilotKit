...
| Term | Definition |
|------|------------|
| CoAgent | An AI agent designed to collaborate with users in Agent-Native applications, rather than operate autonomously. CoAgents integrate with CopilotKit to provide interactive experiences. |
