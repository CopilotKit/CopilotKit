...
Here are the key terms and concepts used throughout Agentic Copilots:

| Term | Definition |
|------|------------|
| Agentic Copilot | An AI agent designed to collaborate with users in Agent-Native applications, rather than operate autonomously. Agentic Copilots integrate with CopilotKit to provide interactive experiences. |
...
| Ground Truth | In Agentic Copilots, CopilotKit serves as the "ground truth" for the full chat session, maintaining the persistent chat history and ensuring conversational continuity across different agents. |
...
| [LangGraph](https://langchain-ai.github.io/langgraph/) | The agent framework integrated with CopilotKit that provides the orchestration layer for Agentic Copilots, enabling sophisticated multi-step reasoning and state management. |
...
These terms are referenced throughout the documentation and are essential for understanding how Agentic Copilots work and how to implement them effectively in your applications.
