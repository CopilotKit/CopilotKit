...
<TailoredContent defaultOptionIndex={0}>
    ...
    >
        ...
        up to 100% of the Copilot's tasks (see [agent-lock mode](/coagents/advanced/router-mode-agent-lock#agent-lock-mode) for the 100% case).

        ### Examples
        An excellent example of the type of experiences you can accomplish with CoAgents applications can be found in our [Research Canvas](/examples/coagents-research-canvas).
