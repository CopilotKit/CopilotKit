...
If you'd like to change how LangGraph agents behave as Agentic Copilots you can utilize our Copilotkit SDK which provides a collection
...
change how LangGraph and Copilotkit interact with each other. For example you can change:
