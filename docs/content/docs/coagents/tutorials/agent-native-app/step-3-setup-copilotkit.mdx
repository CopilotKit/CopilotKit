...
<Steps>
<Step>
### Set up Copilot Platform
Create a [Copilot Platform account](https://cloud.copilotkit.ai/sign-in) to get started. This provides a production-ready proxy to your LLMs.

<Callout>
Copilot Platform includes free LLM credits for development.
</Callout>
...
you'll need to create an OpenAI API key and provide it to Copilot Platform.
