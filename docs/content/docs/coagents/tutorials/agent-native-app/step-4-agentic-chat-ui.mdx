...
Since we're using Copilot Platform, this is as simple as running the following command for local development.
...
This allows Copilot Platform to know where to send requests to when the agent is called.
