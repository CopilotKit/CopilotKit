...
With our agentic copilots, the LangGraph agent's state is only emitted when node change occurs (i.e, an edge is traversed). This means
...
# ...
from copilotkit.langchain import copilotkit_emit_state, copilotkit_customize_config # [!code ++]
