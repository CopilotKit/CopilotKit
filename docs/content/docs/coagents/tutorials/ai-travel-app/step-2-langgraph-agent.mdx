...
- Google Maps API key: This can be retrieved from the Google Platform Console [here](https://developers.google.com/maps/documentation/places/web-service/get-api-key#creating-api-keys).
