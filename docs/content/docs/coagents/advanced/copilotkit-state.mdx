...
---
import { ReferenceChips } from "@/components/react/references.tsx";

<ReferenceChips header="Related Concepts" references={[
    { title: "CoAgents", link: "/concepts/coagents/coagents" },
    { title: "Shared State", link: "/concepts/coagents/shared-state" },
    { title: "LangGraph", link: "/concepts/coagents/langgraph" },
]} />
