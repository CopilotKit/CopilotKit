...
<video src="/images/coagents/write-agent-state.mp4" className="rounded-lg shadow-xl" loop inline controls autoPlay muted />
<Callout>
  This video shows the [coagents starter](https://github.com/copilotkit/coagents-starter) repo with the previous steps applied to it!
</Callout>
