...
<Steps>
    ...
    >
        ...
        >
            <Step>
                ...
                ```bash
                git clone https://github.com/copilotkit/coagents-starter
                cd agent
                ```
            </Step>
            <Step>
    ...
    <Step>
        ...
        CopilotKit operates multi-agent workflows through an [intelligent router](/coagents/advanced/router-mode-agent-lock) that is enabled by default. 
