...
<Steps>
    ...
    >
        ...
        >
            <Step>
                ...
                ```
                <Callout type="info">
                    If you want to use LangGraph JS, you can use the included `agent-js` folder instead.
                </Callout>
            </Step>
            <Step>
                ### Create a `.env` file
    ...
    <Step>
        ...
        <Callout type="info">
            Looking for other chat component options? Check out our [Agentic Chat UI](/coagents/agentic-chat-ui) guide.
        </Callout>
    </Step>
    <Step>
        ### 🎉 Talk to your agent!
