...
All Mastra Agents are stateful. This means that as your agent progresses through nodes, a state object is passed between them perserving
...
<Steps>
  <Step>
    ### Run and Connect your Mastra Agent to CopilotKit
    First, you'll need to make sure you have a running Mastra Agent. If you haven't already done this, you can follow the [getting started guide](/mastra/quickstart/your-framework)

    This guide uses the [CoAgents starter repo](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-Mastra) as its starting point.

  </Step>
  <Step>
    ### Define your agent state
    If you're not familiar with Mastra, your flows are stateful. As you progress through function, a state object is updated between them. CopilotKit
