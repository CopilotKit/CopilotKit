...
How do CoAgents extend Mastra? Let's read about the concept of Flows to understand.
...
- **Tool calling**: Tool calling is a fundamental building block for agentic workflows. They allow for greater control over what
  ...
  tool calls in the UI so your users know what's happening. Read more about streaming tool calls [here](/mastra/shared-state/predictive-state-updates).

## Building with Python

You can build Mastra applications using Python. Check out the [Mastra docs](https://docs.mastra.ai/introduction) for more information.
...
Mastra enterprise is a platform for deploying and monitoring Mastra applications. Read more about it on the
[Mastra website](https://www.mastra.ai/enterprise).

If you want to take the next step to deploy your Mastra application as an CoAgent, check out our [quickstart guide](/mastra/quickstart/your-framework). 