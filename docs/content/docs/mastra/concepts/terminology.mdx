...
| Agent State                  | The current data and context maintained by a Mastra agent during its execution, including both internal state and data that can be synchronized with the frontend UI.                              |
