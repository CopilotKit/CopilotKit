...
[Flow based agents](https://docs.mastra.ai/workflows) are stateful agents that can be interrupted and resumed
...
<Steps>
    <Step>
        ...
        you can follow the instructions in the [Getting Started](/mastra/quickstart/your-framework) guide.
    ...
    Now we'll setup the Mastra agent. The flow is hard to understand without a complete example, so below
