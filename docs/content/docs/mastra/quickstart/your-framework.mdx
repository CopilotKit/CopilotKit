            ...
            <Step>
                ...
                <Tabs groupId="language" items={["Python"]}>
                    <Tab value="Python">
                        ...
                        cd CopilotKit/examples/coagents-starter-mastra/agent-py
                        ```
                    </Tab>
                </Tabs>
            </Step>
    ...
    <TailoredContent
        ...
        header={
            <div>
                ...
                <p className="text-base">
                    Now you need to connect your Mastra Agent to CopilotKit.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ### Add a remote endpoint for your Mastra Agent
                Using Copilot Cloud, you need to connect a remote endpoint that will connect to your Mastra Agent.
                <Tabs groupId="lg-deployment-type" items={['Self hosted (FastAPI)', 'Mastra Enterprise']}>
