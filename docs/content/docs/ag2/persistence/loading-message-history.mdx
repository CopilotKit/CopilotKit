---
title: Threads
description: Learn how to maintain persistent conversations across sessions with AG2 Agents.
icon: "lucide/MessagesSquare"
---

# Understanding Thread Persistence

AG2 Agents supports threads, a way to group messages together and maintain a continuous chat history across sessions. CopilotKit provides mechanisms to ensure conversation state is properly persisted between the frontend and backend.
...
See the [sample agent implementation](https://github.com/CopilotKit/CopilotKit/blob/main/examples/coagents-starter-ag2/agent-py/sample_agent/agent.py#L291)
