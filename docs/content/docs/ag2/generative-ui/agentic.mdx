...
<Callout>
  ...
  project](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-AG2).
</Callout>

## What is this?

All AG2 Agents are stateful. This means that as your agent progresses through nodes, a state object is passed between them perserving
...
<Steps>
  <Step>
    ### Run and Connect your AG2 Agent to CopilotKit
    First, you'll need to make sure you have a running AG2 Agent. If you haven't already done this, you can follow the [getting started guide](/ag2/quickstart/your-framework)

    This guide uses the [CoAgents starter repo](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-AG2) as its starting point.

  </Step>
  <Step>
    ### Define your agent state
    If you're not familiar with AG2, your flows are stateful. As you progress through function, a state object is updated between them. CopilotKit
