...
<Callout type="info">
The illustration above is from the [Coagent Starter](https://github.com/copilotkit/copilotkit/tree/main/examples/coagent-starter), included here for demonstration purposes.
</Callout>
...
Let's start by importing the necessary libraries and setting up the basic structure:
...
INITIAL_MESSAGE = """
I'm your AI Travel Agent. I can help create a personalized travel itinerary just for you!
Let's start by getting to know you a bit better. Could you please provide your membership ID?
"""
```
...
The complete code for this example is available in the [AG2-CopilotKit starter](https://github.com/ag2ai/ag2-copilotkit-starter/blob/main/agent-py/hitl_workflow.py) repository.
