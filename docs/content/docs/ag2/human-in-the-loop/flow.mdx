...
[Flow based agents](https://docs.ag2.ai/concepts/flows) are stateful agents that can be interrupted and resumed
...
<Steps>
    <Step>
        ...
        you can follow the instructions in the [Getting Started](/ag2/quickstart/your-framework) guide.

        If you don't already have an agent, you can use the [coagent starter](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-AG2) as a starting point
    ...
    <Step>
    ### Setup the AG2 Agent
    Now we'll setup the AG2 agent. The flow is hard to understand without a complete example, so below
