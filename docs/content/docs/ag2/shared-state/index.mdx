...
<Callout>
  ...
  Canvas](/ag2/examples/research-canvas) utilizing shared state.
</Callout>
...
The foundation of this system is built on AG2's stateful architecture.

## When should I use this?

State streaming is perfect when you want to facilitate collaboration between your agent and the user. Any state that your AG2 Agent
