...
<Steps>
    ...
    <Step>
        ###  Modify your agent
        Now, we'll need to modify the agent to access these frontend tools. Open up for your agent's folder and continue from there!
    </Step>
    <Step>
        ...
        <Tabs groupId="language-ag2-agent" items={['Python']} default="Python" persist>
            <Tab value="Python">
