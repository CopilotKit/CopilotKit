...
Before we dive into what agentic copilots are, help us help you by telling us your level of experience with AG2. We'll explain things in a way that best suits your experience level.

<TailoredContent id="experience" defaultOptionIndex={0}>
    <TailoredContentOption 
        id="new"
        title="I'm new to AG2" 
        description="Help me understand what agentic copilots are, where AG2 fits in, and how to get started." 
    ...
    >
        ...
        <Cards>
            <Card
                ...
                href="/ag2/quickstart/your-framework"
                icon={<RocketIcon />}
            />
            <Card
            ...
            <Card
                ...
                href="/ag2/videos/research-canvas"
                icon={<VideoIcon />}
            />
        </Cards>
    </TailoredContentOption>
    <TailoredContentOption
        id="intermediate"
        title="I'm already using AG2"
        description="Help me understand what agentic copilots are, what Copilotkit does to integrate with AG2, and how to get started."
        icon={<SiLangchain />}
    >
        ...
        AG2 is a framework for building deeply customizable AI agents.
        ...
        Any AG2-based agent can be transformed into an Agentic Copilot with a minimal amount
        ...
        <Cards>
            <Card
                title="Quickstart"
                description="Integrate your AG2 agent with CopilotKit in a few minutes."
                href="/ag2/quickstart/your-framework"
                icon={<RocketIcon />}
            />
            <Card
                ...
                description="Follow a step-by-step tutorial to build a travel app supercharged with CoAgents."
                href="/ag2/tutorials/ai-travel-app/overview"
                icon={<GraduationCapIcon />}
            />
            <Card
                title="Reference"
