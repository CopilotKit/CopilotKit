...
If you'd like to stream messages from your AG2 agents you can utilize our Copilotkit SDK which provides a collection
...
If you just call the LiteLLM `completion` function from your AG2 agent, messages will not be streamed by default.
...
For more information on how tool calls are utilized check out our [frontend actions](/ag2/frontend-actions)
documentation. 