---
title: "useAgent Hook"
description: "Access and interact with your AutoGen2 agent directly from React components"
icon: "lucide/Cpu"
---
...
The `useAgent` hook provides direct access to your AutoGen2 agent from any React component. It gives you real-time access to the agent's state, messages, execution status, and allows you to subscribe to custom events.
...
This page covers everything you need to know about using `useAgent` with AutoGen2. Select where you'd like to get started below.
