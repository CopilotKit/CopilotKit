export const pilotMappings = [
  ...
  },
  {
    ...
    docs: "https://docs.copilotkit.ai/reference/v2/hooks/useRenderTool",
    v1Reference:
      "showcase/shell-docs/src/content/reference/v1/hooks/useRenderToolCall.mdx",
    ...
    deprecationUsage: "useRenderTool({",
    baselineHash:
      "470c524bbe576cc8ef4c855f8965bf83bfe1e81d219b496386e5760b729343ce",
    notes: [
      "Use useRenderTool to register a renderer for an existing backend tool in v2.",
      "The v2 hook named useRenderToolCall is a different, low-level consumer API.",
    ],
  },
  {
