...
const DefaultOpenIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <MessageCircle className={cn("cpk:h-6 cpk:w-6", className)} strokeWidth={1.75} fill="currentColor" {...props} />
);

const DefaultCloseIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <X className={cn("cpk:h-6 cpk:w-6", className)} strokeWidth={1.75} {...props} />
);

DefaultOpenIcon.displayName = "CopilotChatToggleButton.OpenIcon";
DefaultCloseIcon.displayName = "CopilotChatToggleButton.CloseIcon";

export interface CopilotChatToggleButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "children"> {
...
export const CopilotChatToggleButton = React.forwardRef<HTMLButtonElement, CopilotChatToggleButtonProps>(
...
export { DefaultOpenIcon as CopilotChatToggleButtonOpenIcon, DefaultCloseIcon as CopilotChatToggleButtonCloseIcon };
