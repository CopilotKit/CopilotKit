...
export const CopilotChatAudioRecorder = forwardRef<AudioRecorderRef, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
    ...
    return (
      <div className={twMerge("cpk:w-full cpk:py-3 cpk:px-5", className)} {...divProps}>
