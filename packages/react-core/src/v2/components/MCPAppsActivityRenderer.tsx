...
class MCPAppsRequestQueue {
   ...
   */
  async enqueue(agent: AbstractAgent, request: () => Promise<RunAgentResult>): Promise<RunAgentResult> {
 ...
 */
export const MCPAppsActivityRenderer: React.FC<MCPAppsActivityRendererProps> = function MCPAppsActivityRenderer({
  content,
  agent,
}) {
            ...
            switch (msg.method) {
              ...
              case "ui/message": {
                ...
                try {
                  ...
                  const role = (params.role as "user" | "assistant") || "user";
                  ...
                  if (shouldFollowUp && textContent) {
                    ...
                    mcpAppsRequestQueue
                      .enqueue(currentAgent, () => copilotkit.runAgent({ agent: currentAgent }))
  ...
  return (
    ...
    >
      {isLoading && <div style={{ padding: "1rem", color: "#666" }}>Loading...</div>}
