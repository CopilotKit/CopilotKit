...
const LOGO = `
${chalk.bold.cyan("  ╔═══════════════════════════╗")}
${chalk.bold.cyan("  ║")}  ${chalk.bold.white("CopilotKit CLI")}        ${chalk.bold.cyan("║")}
${chalk.bold.cyan("  ╚═══════════════════════════╝")}
`;
...
function printHelp() {
  ...
  console.log(
    `    ${chalk.yellow("typegen")} ${chalk.dim("<url1,url2,...>")}   Generate type-safe agent IDs from your runtime\n`,
  );
