...
| ------------------------------------------------------ | ----------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CopilotKitProvider.test.tsx`                          | `CopilotKitProvider.test.ts`                          | matched | Core provider behavior, including the browser-only Inspector default, `enableInspector` precedence, legacy `showDevConsole` compatibility, client-only loading, and exact core binding.                                                                                                                                                                                                                                                                              |
