...
| `CopilotChatSubagents.e2e.test.tsx`                                                                | `CopilotChatSubagents.e2e.test.ts`                | matched | Strict counterpart with React-matching case names: parallel subagent groups under their tool calls, collapse on done, open on error and suspended, user toggle, nesting, unannounced ids, a subagent-attributed tool result pairing with the parent card, the `#subagent` slot, and an unattributed run with no groups.                                                                                                                                                                                                                                                                                                                               |
