...
| `CopilotChatActivityRendering.e2e.test.tsx`      | `CopilotChatActivityRendering.e2e.test.ts`        | matched | Suite/case titles and approach now match React, and the strict activity-rendering assertions pass in Vue.                                                                                                                                                     |
