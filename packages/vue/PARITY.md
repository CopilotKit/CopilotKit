...
| ------------------------------------------------------ | ----------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CopilotKitProvider.test.tsx`                          | `CopilotKitProvider.test.ts`                          | matched | Core provider behavior, including the development-only Inspector default, production and SSR guards, legacy `showDevConsole` isolation, client-only loading, and pre-connection core binding.                                                                                                                                                                                                                                                                        |
