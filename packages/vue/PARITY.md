...
| `CopilotKitInspector.notificationContext.test.tsx`     | `CopilotKitInspector.notificationContext.test.ts`     | matched | Both pass the framework and SDK version to the development-only Inspector.                                                                                                                                                                                                                                                                                                                                                                                           |
