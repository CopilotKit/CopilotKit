...
import { buildCapabilityRows } from "./lib/capabilities.js";
import type {
...
import {
  AGENT_EVENT_TYPES,
  THREADS_EXAMPLE_AGENT_ID,
  THREADS_EXAMPLE_DETAILS,
...
import { CpkMemoryList } from "./components/memory-list.js";
import {
  CpkThreadInspector,
  ɵCpkThreadDetails,
} from "./components/thread-inspector.js";
import { CpkThreadList } from "./components/thread-list.js";
import {
  LAUNCHER_MAX_SIZE,
  LAUNCHER_MIN_SIZE,
  webInspectorStyles,
} from "./components/web-inspector-styles.js";
import {
  ERROR_GESTURE_MS,
...
${argsString}</pre
  ...
  static styles = webInspectorStyles;
