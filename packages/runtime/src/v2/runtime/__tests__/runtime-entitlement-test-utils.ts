...
export const READY_RUNTIME_ENTITLEMENTS = {
  ...
  entitlement: {
    ...
    limits: { "threads.retention_hours": 120, "threads.max_count": 5_000 },
    planCode: "pro",
...
export const SELF_HOSTED_READY_RUNTIME_ENTITLEMENTS = {
  ...
  entitlement: {
    ...
    limits: { "threads.retention_hours": 336, "threads.max_count": 25_000 },
  ...
  return {
    ...
    response: {
      ...
      entitlement: {
        ...
        features: { msteams: true },
        limits: {
          "threads.retention_hours": 120,
          "threads.max_count": 5_000,
        },
        ...optionalMetadata,
      },
    },
