...
export interface CopilotKitProviderProps {
  ...
  /**
   * Functions that are made available inside sandboxed UI iframes generated by
   * OpenGenerativeUI. Each function is described to the LLM via agent context
   * and exposed in the iframe via websandbox's `localApi`.
   *
...
export const CopilotKitProvider: React.FC<CopilotKitProviderProps> = ({
  ...
  const sandboxFunctionsList = useStableArrayProp<SandboxFunction>(
    sandboxFunctions,
    "sandboxFunctions must be a stable array.",
  );
