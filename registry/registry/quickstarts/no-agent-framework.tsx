...
function YourMainContent({ themeColor }: { themeColor: string }) {
  ...
  useCopilotChatSuggestions({
    ...
    minSuggestions: 3,
    instructions:
      "Give the user 3 options: 'Change theme color' (choose a random hexadecimal color), 'Write a proverb about {topic}' (choose a random topic) or 'Generate a gradient card between {color1} and {color2}' (choose random hexadecimal colors)",
  });
  ...
  useFrontendTool({
    ...
    description:
      "Generate a card with a card with a background gradient between two colors.",
    parameters: [
