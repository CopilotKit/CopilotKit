...
export interface BaseLambdaStackProps extends cdk.NestedStackProps {
  /**
...
export class PreviewBaseLambdaStack extends cdk.NestedStack {
  fnUrl: string;
  ...
  constructor(scope: Construct, id: string, props: BaseLambdaStackProps) {
    ...
    const logGroup = new logs.LogGroup(this, "FunctionLogGroup", {
      logGroupName: `/aws/lambda/dojo-e2e/${processedId}-Fn`,
